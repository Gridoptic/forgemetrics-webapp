(function () {
    ...
    function renderShowcase() {
        ...
        var rows = [
            [SG('Ниша и точка старта.'), 'Есть канал — стратег оценит его по реальным данным и скажет, что усилить. Нет канала — подберёт 3 ниши на пересечении твоего интереса, спроса рекламодателей и невысокой конкуренции'],
            [SG('Контент-план на весь месяц.'), 'Рубрики по дням и частота записываются в контент-план; все недели месяца собираются по сетке стратегии. Стратег каждую неделю правит сетку по факту'],
            [SG('Креативы под ленты рекомендаций.'), 'Из каждого поста — вертикальный ролик 9:16 под площадку: VK Клипы, Дзен Ролики, YouTube Shorts, TikTok, Instagram Reels. Сценарий с хуком, стоковые кадры, голос диктора, музыка, текст на экране, финал с каналом — готовый файл через 5 минут плюс описание со ссылкой отслеживания — под каждый пост месяца. Для Дзена — ещё посты и статьи под ленту; ссылка на канал в профиле, публикации самодостаточные, без «продолжение в Telegram». Съёмка и монтаж не нужны'],
            [SG('Трафик под твой регион.'), 'Площадки ранжируются по отдаче в твоей стране: где публикация без ограничений, где через VPN или обходы — с пометкой, но без запретов. Платный перелив с расчётом «бюджет → подписчики» по CPM ниши, доноры из Радара, ссылка отслеживания на каждый источник: видно, что дало приток, а что нет'],
            [SG('Все модели заработка.'), 'Реклама в канале, перелив трафика, партнёрки, свой продукт. По каждой: с какого размера канала включать, сколько это даёт в месяц в твоей нише и что подготовить заранее'],
            [SG('Месяц ведения за руку.'), 'Каждую неделю стратег сам сверяет план с фактом по данным твоего канала: что сработало, где отстаёшь, что делать дальше. Плюс чат — задавай вопросы в любой момент'],
        ];
    ...
    var TR_DAYS = [SG('Пн'), 'Вт', 'Ср', 'Чт', 'Пт', 'Сб', 'Вс'];
