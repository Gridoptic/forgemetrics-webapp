(function () {
    ...
    var SEGMENT_NOTES = {
        ...
        match: 'Площадки, чья аудитория ближе всего к твоей. Чем выше совпадение, тем выше шанс, что реклама будет интересна их подписчикам.',
        ...
        clean: 'Только площадки, прошедшие фрод-контроль: зелёный светофор по нашим проверкам. Это не гарантия — публичные данные не позволяют исключить накрутку полностью.'
    };
