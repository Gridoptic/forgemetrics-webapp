...
const CAB_BENEFITS = {
    pro: [
        ...
        'Выбор AI-модели поста, 10 каналов · 30 источников стиля',
            ...
            <div class="cs-toggle-row" data-toggle="paused">
                ...
                <div class="cs-toggle-info">
                    ...
                    <div class="cs-info-popup" id="cs-info-paused" style="display:none;">
                        Когда канал на паузе, остановлены автопубликации: автопостинг и контент-план ничего не выкладывают. Бот остаётся подключённым, настройки и стиль сохраняются.
                    </div>
                </div>
