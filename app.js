    ...
    return `
        <div class="cs-section">
            ...
            <div class="cs-toggle-row" data-toggle="creative_brand">
                ...
                <div class="cs-toggle-info">
                    <div class="cs-toggle-title-row">
                        <span class="cs-toggle-title">${TR('Подпись канала в роликах из постов')}</span>
