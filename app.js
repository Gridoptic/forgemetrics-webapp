...
const CAB_BENEFITS = {
    pro: [
        'Контент-план: сюжет недели → 7 постов → автовыкладка',
        '8 премиум-постов в день + 30 стандартных · до 5 каналов',
        '6 разборов, 2 анализа конкурентов и 5 подборов площадок в месяц',
    ],
    pro_plus: [
        'Живой MP4-постер оффера и приоритетная очередь',
        '15 премиум-постов в день + 50 стандартных · до 10 каналов',
        '15 разборов, 4 анализа конкурентов и 8 подборов площадок в месяц',
    ],
    agency: [
        'Режим сетки: пакетные операции с офферами и ценами',
        '24 премиум-поста в день + 75 стандартных · до 25 каналов',
        '20 разборов, 5 анализов конкурентов и 10 подборов площадок в месяц',
    ],
    network: [
        'Приоритетная обработка всех задач сетки',
        '40 премиум-постов в день + 100 стандартных · до 50 каналов',
        '30 разборов, 10 анализов конкурентов и 20 подборов площадок в месяц',
    ],
};
