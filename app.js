            ...
            <div class="cs-toggle-row" data-toggle="research">
                ...
                <div class="cs-toggle-info">
                    ...
                    <div class="cs-info-popup" id="cs-info-research" style="display:none;">
                        Подходит каналам, где посты опираются на проверяемые факты: наука и научпоп, медицина, биохакинг, психология, космос, биология и животные, IT, инженерия, авто (масла, топливо, узлы), строительство и материалы. Система живым поиском находит 1-3 первоисточника (рецензируемые журналы, PubMed, стандарты SAE/ASTM/ISO, NASA, WHO), проверяет каждую ссылку и оформляет в манере канала; если подтверждённых работ не нашлось — разница в цене возвращается. Юмору, влогам и анонсам не подойдёт: научных утверждений там нет.
                    </div>
                </div>
