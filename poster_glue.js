(function () {
  ...
  function _psProofLine() {
    ...
    d.textContent = (Pk.trust || 'Метрики подтверждены ForgeMetrics · актуальная карточка канала — по QR-коду') + ' · ' + dt;
  }
