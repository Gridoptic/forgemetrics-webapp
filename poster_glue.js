(function () {
  ...
  var POSTER_L = {
    ru: {"wk": "/нед", "kk": " К", "subs": "Подписчики", "reach": "Средний охват", "post_i": "· пост", "er": "Вовлечённость", "cpm": "Цена 1000 показов", "err": "Охват к подписчикам", "grow": "Прирост · 30 дней", "freq": "Частота постов", "age": "Канал создан", "chart": "Просмотры · 30 дней", "prsub": "минимальный формат размещения", "cta": "Забронировать", "prpref": "Реклама от", "prneg": "Цена по договорённости", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Здесь рекламу дочитывают: живая аудитория и реальные охваты.", "hook_n": "Твой пост увидят ~%N человек — живая аудитория и реальные охваты.", "trust": "Метрики подтверждены @ForgeMetricsBot · актуальная карточка канала — по QR-коду", "callout": "Реклама в канале"},
    en: {"wk": "/wk", "kk": "K", "subs": "Subscribers", "reach": "Average reach", "post_i": "· post", "er": "Engagement", "cpm": "Price per 1000 impressions", "err": "Reach per subscriber", "grow": "Growth · 30 days", "freq": "Posting frequency", "age": "Channel created", "chart": "Views · 30 days", "prsub": "minimum placement format", "cta": "Reserve", "prpref": "Ads from", "prneg": "Price on request", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Ads get read here: a live audience and real reach.", "hook_n": "Your post will reach ~%N people — a live audience and real reach.", "trust": "Metrics verified by @ForgeMetricsBot · up-to-date channel card via QR code", "callout": "Advertise here"},
    es: {"wk": "/sem", "kk": " K", "subs": "Suscriptores", "reach": "Alcance medio", "post_i": "· post", "er": "Interacción", "cpm": "Precio de 1000 impresiones", "err": "Alcance por suscriptor", "grow": "Crecimiento · 30 días", "freq": "Frecuencia de publicaciones", "age": "Canal creado", "chart": "Vistas · 30 días", "prsub": "formato mínimo de publicación", "cta": "Reservar", "prpref": "Publicidad desde", "prneg": "Precio a convenir", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Aquí la publicidad sí se lee: audiencia viva y alcance real.", "hook_n": "Tu publicación llegará a ~%N personas: audiencia viva y alcance real.", "trust": "Métricas verificadas por @ForgeMetricsBot · tarjeta actualizada del canal por código QR", "callout": "Anúnciate aquí"},
    de: {"wk": "/Wo", "kk": " K", "subs": "Abonnenten", "reach": "Durchschnittliche Reichweite", "post_i": "· Beitrag", "er": "Engagement", "cpm": "Preis pro 1000 Impressionen", "err": "Reichweite pro Abonnent", "grow": "Zuwachs · 30 Tage", "freq": "Beitragsfrequenz", "age": "Kanal erstellt", "chart": "Aufrufe · 30 Tage", "prsub": "Mindestformat der Platzierung", "cta": "Reservieren", "prpref": "Werbung ab", "prneg": "Preis auf Anfrage", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Hier wird Werbung gelesen: echtes Publikum, echte Reichweite.", "hook_n": "Dein Beitrag erreicht ~%N Menschen — echtes Publikum, echte Reichweite.", "trust": "Metriken von @ForgeMetricsBot bestätigt · aktuelle Kanalkarte per QR-Code", "callout": "Hier werben"},
    kk: {"wk": "/апта", "kk": " мың", "subs": "Жазылушылар", "reach": "Орташа қамту", "post_i": "· жазба", "er": "Тартылым", "cpm": "1000 көрсетілім бағасы", "err": "Жазылушыға қамту", "grow": "Өсім · 30 күн", "freq": "Постар жиілігі", "age": "Арна құрылған", "chart": "Қаралымдар · 30 күн", "prsub": "орналастырудың ең аз форматы", "cta": "Брондау", "prpref": "Жарнама, бастап", "prneg": "Баға келісім бойынша", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Мұнда жарнаманы шынымен оқиды: тірі аудитория және нақты қамту.", "hook_n": "Постыңды ~%N адам көреді — тірі аудитория және нақты қамту.", "trust": "Метрикаларды @ForgeMetricsBot растаған · арнаның өзекті карточкасы — QR арқылы", "callout": "Арнадағы жарнама"},
    uz: {"wk": "/hafta", "kk": " ming", "subs": "Obunachilar", "reach": "Oʻrtacha qamrov", "post_i": "· post", "er": "Jalb etilganlik", "cpm": "1000 ta koʻrsatish narxi", "err": "Obunachiga qamrov", "grow": "Oʻsish · 30 kun", "freq": "Postlar chastotasi", "age": "Kanal yaratilgan", "chart": "Ko'rishlar · 30 kun", "prsub": "joylashtirishning minimal formati", "cta": "Band qilish", "prpref": "Reklama —", "prneg": "Narx kelishuv asosida", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Bu yerda reklama chindan o‘qiladi: jonli auditoriya va haqiqiy qamrov.", "hook_n": "Postingni ~%N kishi ko‘radi — jonli auditoriya va haqiqiy qamrov.", "trust": "Metrikalar @ForgeMetricsBot tomonidan tasdiqlangan · kanalning dolzarb kartochkasi QR orqali", "callout": "Kanalda reklama"},
    be: {"wk": "/тыд", "kk": " тыс", "subs": "Падпісчыкі", "reach": "Сярэдні ахоп", "post_i": "· допіс", "er": "Уцягнутасць", "cpm": "Цана 1000 паказаў", "err": "Ахоп да падпісчыкаў", "grow": "Прырост · 30 дзён", "freq": "Частата пастоў", "age": "Канал створаны", "chart": "Прагляды · 30 дзён", "prsub": "мінімальны фармат размяшчэння", "cta": "Забраніраваць", "prpref": "Рэклама ад", "prneg": "Цана па дамоўленасці", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Тут рэкламу дачытваюць: жывая аўдыторыя і рэальныя ахопы.", "hook_n": "Твой допіс убачаць ~%N чалавек — жывая аўдыторыя і рэальныя ахопы.", "trust": "Метрыкі пацверджаны @ForgeMetricsBot · актуальная картка канала — па QR-кодзе", "callout": "Рэклама ў канале"},
    az: {"wk": "/həftə", "kk": " min", "subs": "Abunəçilər", "reach": "Orta əhatə", "post_i": "· post", "er": "Cəlbolunma", "cpm": "1000 göstərişin qiyməti", "err": "Abunəçiyə əhatə", "grow": "Artım · 30 gün", "freq": "Post tezliyi", "age": "Kanal yaradılıb", "chart": "Baxışlar · 30 gün", "prsub": "minimum yerləşdirmə formatı", "cta": "Rezerv et", "prpref": "Reklam", "prneg": "Qiymət razılaşma ilə", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Burada reklam həqiqətən oxunur: canlı auditoriya, real əhatə.", "hook_n": "Postunu ~%N nəfər görəcək — canlı auditoriya, real əhatə.", "trust": "Metrikalar @ForgeMetricsBot tərəfindən təsdiqlənib · kanalın aktual kartı QR kodu ilə", "callout": "Kanalda reklam"},
    ar: {"wk": "/أسبوع", "kk": " ألف", "subs": "المشتركون", "reach": "متوسط الوصول", "post_i": "· منشور", "er": "التفاعل", "cpm": "سعر 1000 ظهور", "err": "الوصول لكل مشترك", "grow": "النمو · 30 يومًا", "freq": "تكرار النشر", "age": "تم إنشاء القناة", "chart": "المشاهدات · 30 يومًا", "prsub": "الحد الأدنى لصيغة الإعلان", "cta": "احجز الآن", "prpref": "الإعلان من", "prneg": "السعر حسب الاتفاق", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "هنا تُقرأ الإعلانات فعلًا: جمهور حقيقي ووصول حقيقي.", "hook_n": "سيصل منشورك إلى ~%N شخصًا — جمهور حقيقي ووصول حقيقي.", "trust": "المقاييس موثّقة من @ForgeMetricsBot · بطاقة القناة المحدّثة عبر رمز QR", "callout": "مساحة إعلانية"},
    fa: {"wk": "/هفته", "kk": " هزار", "subs": "دنبال‌کنندگان", "reach": "میانگین بازدید", "post_i": "· پست", "er": "نرخ تعامل", "cpm": "قیمت ۱۰۰۰ نمایش", "err": "بازدید به دنبال‌کننده", "grow": "رشد · ۳۰ روز", "freq": "تناوب پست‌ها", "age": "کانال ایجاد شد", "chart": "بازدید · ۳۰ روز", "prsub": "حداقل فرمت درج آگهی", "cta": "رزرو", "prpref": "تبلیغ از", "prneg": "قیمت توافقی", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "اینجا تبلیغ واقعاً خوانده می‌شود: مخاطب واقعی و دسترسی واقعی.", "hook_n": "پست تو را ~%N نفر می‌بینند — مخاطب واقعی و دسترسی واقعی.", "trust": "متریک‌ها با تأیید @ForgeMetricsBot · کارت به‌روز کانال از طریق کد QR", "callout": "تبلیغ در کانال"},
    tr: {"wk": "/hf", "kk": " B", "subs": "Aboneler", "reach": "Ortalama erişim", "post_i": "· gönderi", "er": "Etkileşim", "cpm": "1000 gösterim fiyatı", "err": "Erişim / abone", "grow": "Artış · 30 gün", "freq": "Gönderi sıklığı", "age": "Kanal kuruldu", "chart": "Görüntülenme · 30 gün", "prsub": "minimum yerleşim formatı", "cta": "Rezerve et", "prpref": "Reklam min.", "prneg": "Fiyat görüşülür", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Burada reklam gerçekten okunur: canlı kitle, gerçek erişim.", "hook_n": "Gönderini ~%N kişi görecek — canlı kitle, gerçek erişim.", "trust": "Metrikler @ForgeMetricsBot tarafından doğrulandı · kanalın güncel kartı QR kodla", "callout": "Kanalda reklam"},
    hi: {"wk": "/सप्ताह", "kk": " हज़ार", "subs": "सब्सक्राइबर", "reach": "औसत रीच", "post_i": "· पोस्ट", "er": "एंगेजमेंट", "cpm": "1000 इंप्रेशन की कीमत", "err": "प्रति सब्सक्राइबर रीच", "grow": "ग्रोथ · 30 दिन", "freq": "पोस्ट फ्रीक्वेंसी", "age": "चैनल निर्मित", "chart": "व्यूज़ · 30 दिन", "prsub": "न्यूनतम प्लेसमेंट फॉर्मेट", "cta": "बुक करें", "prpref": "विज्ञापन से", "prneg": "कीमत अनुरोध पर", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "यहाँ विज्ञापन सच में पढ़े जाते हैं: असली ऑडियंस, असली रीच।", "hook_n": "आपकी पोस्ट ~%N लोग देखेंगे — असली ऑडियंस, असली रीच।", "trust": "मेट्रिक्स @ForgeMetricsBot द्वारा सत्यापित · चैनल का अद्यतित कार्ड QR कोड से", "callout": "चैनल में विज्ञापन"},
    bn: {"wk": "/সপ্তাহ", "kk": " হাজার", "subs": "সাবস্ক্রাইবার", "reach": "গড় রিচ", "post_i": "· পোস্ট", "er": "এনগেজমেন্ট", "cpm": "১০০০ ভিউয়ের দাম", "err": "প্রতি সাবস্ক্রাইবারে রিচ", "grow": "বৃদ্ধি · ৩০ দিন", "freq": "পোস্টের হার", "age": "চ্যানেল তৈরি", "chart": "ভিউ · ৩০ দিন", "prsub": "ন্যূনতম প্লেসমেন্ট ফরম্যাট", "cta": "বুক করুন", "prpref": "বিজ্ঞাপন শুরু", "prneg": "দাম আলোচনাসাপেক্ষ", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "এখানে বিজ্ঞাপন সত্যিই পড়া হয়: আসল অডিয়েন্স, আসল রিচ।", "hook_n": "আপনার পোস্ট ~%N জন দেখবে — আসল অডিয়েন্স, আসল রিচ।", "trust": "মেট্রিক্স @ForgeMetricsBot দ্বারা যাচাইকৃত · চ্যানেলের হালনাগাদ কার্ড QR কোডে", "callout": "চ্যানেলে বিজ্ঞাপন"},
    id: {"wk": "/mgg", "kk": " rb", "subs": "Subscriber", "reach": "Jangkauan rata-rata", "post_i": "· post", "er": "Engagement", "cpm": "Harga per 1000 tayangan", "err": "Jangkauan per subscriber", "grow": "Pertumbuhan · 30 hari", "freq": "Frekuensi posting", "age": "Channel dibuat", "chart": "Tayangan · 30 hari", "prsub": "format penempatan minimum", "cta": "Booking", "prpref": "Iklan mulai", "prneg": "Harga nego", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Iklan di sini benar-benar dibaca: audiens aktif, jangkauan nyata.", "hook_n": "Postinganmu akan dilihat ~%N orang — audiens aktif, jangkauan nyata.", "trust": "Metrik terverifikasi @ForgeMetricsBot · kartu channel terbaru via kode QR", "callout": "Iklan di channel"},
    vi: {"wk": "/tuần", "kk": " K", "subs": "Người theo dõi", "reach": "Reach trung bình", "post_i": "· bài", "er": "Tương tác", "cpm": "Giá 1000 lượt xem", "err": "Reach / người theo dõi", "grow": "Tăng trưởng · 30 ngày", "freq": "Tần suất đăng", "age": "Kênh tạo năm", "chart": "Lượt xem · 30 ngày", "prsub": "định dạng đặt tối thiểu", "cta": "Đặt chỗ", "prpref": "Quảng cáo từ", "prneg": "Giá thỏa thuận", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Quảng cáo ở đây được đọc thật sự: khán giả thật, độ phủ thật.", "hook_n": "Bài đăng của bạn sẽ tiếp cận ~%N người — khán giả thật, độ phủ thật.", "trust": "Số liệu do @ForgeMetricsBot xác thực · thẻ kênh cập nhật qua mã QR", "callout": "Nhận quảng cáo"},
    pt: {"wk": "/sem", "kk": " mil", "subs": "Inscritos", "reach": "Alcance médio", "post_i": "· post", "er": "Engajamento", "cpm": "Preço por 1000 views", "err": "Alcance por inscrito", "grow": "Crescimento · 30 dias", "freq": "Frequência de posts", "age": "Canal criado", "chart": "Views · 30 dias", "prsub": "formato mínimo de anúncio", "cta": "Reservar", "prpref": "Anúncios a partir de", "prneg": "Preço sob consulta", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Aqui a publicidade é lida de verdade: audiência viva e alcance real.", "hook_n": "Seu post alcançará ~%N pessoas — audiência viva e alcance real.", "trust": "Métricas verificadas pela @ForgeMetricsBot · cartão atualizado do canal via código QR", "callout": "Anuncie aqui"},
    fr: {"wk": "/sem", "kk": " k", "subs": "Abonnés", "reach": "Portée moyenne", "post_i": "· post", "er": "Engagement", "cpm": "Prix pour 1000 vues", "err": "Portée par abonné", "grow": "Croissance · 30 j", "freq": "Fréquence de posts", "age": "Chaîne créée", "chart": "Vues · 30 jours", "prsub": "format de placement minimal", "cta": "Réserver", "prpref": "Pub dès", "prneg": "Prix sur demande", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Ici, la pub est vraiment lue : audience vivante, portée réelle.", "hook_n": "Ton post touchera ~%N personnes — audience vivante, portée réelle.", "trust": "Métriques vérifiées par @ForgeMetricsBot · fiche à jour de la chaîne via QR code", "callout": "Espace publicitaire"},
    it: {"wk": "/sett", "kk": " K", "subs": "Iscritti", "reach": "Copertura media", "post_i": "· post", "er": "Engagement", "cpm": "Prezzo per 1000 impression", "err": "Copertura per iscritto", "grow": "Crescita · 30 giorni", "freq": "Frequenza post", "age": "Canale creato", "chart": "Visualizzazioni · 30 giorni", "prsub": "formato minimo di inserzione", "cta": "Prenota", "prpref": "Ads da", "prneg": "Prezzo su richiesta", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Qui la pubblicità si legge davvero: pubblico vivo e copertura reale.", "hook_n": "Il tuo post raggiungerà ~%N persone — pubblico vivo e copertura reale.", "trust": "Metriche verificate da @ForgeMetricsBot · scheda aggiornata del canale via codice QR", "callout": "Spazio pubblicitario"},
    am: {"wk": "/ሳምንት", "kk": " ሺ", "subs": "ተከታዮች", "reach": "አማካይ ተደራሽነት", "post_i": "· ፖስት", "er": "ተሳትፎ", "cpm": "ዋጋ ለ1000 እይታ", "err": "ተደራሽነት በተከታይ", "grow": "እድገት · 30 ቀን", "freq": "የፖስት ድግግሞሽ", "age": "ቻናል ተፈጥሯል", "chart": "እይታዎች · 30 ቀን", "prsub": "አነስተኛ የማስታወቂያ ቅርጸት", "cta": "አስይዝ", "prpref": "ማስታወቂያ ከ", "prneg": "ዋጋ በስምምነት", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "እዚህ ማስታወቂያ በእውነት ይነበባል፦ ቀጥታ ታዳሚ እና እውነተኛ ተደራሽነት።", "hook_n": "ፖስትህን ~%N ሰዎች ያዩታል — ቀጥታ ታዳሚ እና እውነተኛ ተደራሽነት።", "trust": "መለኪያዎች በ@ForgeMetricsBot ተረጋግጠዋል · ወቅታዊ የቻናል ካርድ በQR ኮድ", "callout": "የቻናል ማስታወቂያ"},
    sw: {"wk": "/wiki", "kk": " elfu", "subs": "Wasajili", "reach": "Ufikiaji wastani", "post_i": "· chapisho", "er": "Ushirikiano", "cpm": "Bei ya maonyesho 1000", "err": "Ufikiaji kwa msajili", "grow": "Ukuaji · siku 30", "freq": "Kasi ya machapisho", "age": "Kituo kimeundwa", "chart": "Mionekano · siku 30", "prsub": "kifurushi cha chini cha tangazo", "cta": "Weka nafasi", "prpref": "Matangazo kuanzia", "prneg": "Bei kwa makubaliano", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Hapa matangazo yanasomwa kweli: hadhira hai na ufikiaji halisi.", "hook_n": "Chapisho lako litaonekana na watu ~%N — hadhira hai na ufikiaji halisi.", "trust": "Vipimo vimethibitishwa na @ForgeMetricsBot · kadi ya kisasa ya kituo kwa msimbo wa QR", "callout": "Tangaza hapa"}
  };
  var _psLang = 'ru';
  ...
  function _psProofLine() {
    ...
    if (d.scrollWidth > d.clientWidth + 1) d.textContent = trust.split(' · ')[0] + ' · ' + dt;
  }
  ...
  function _psApplyLabels() {
    ...
    if (_hookDef) window.DEFAULT_HOOK = _hookDef;
    _psApplyNiche();
    _psApplyCallout();
    _psProofLine();
    _psLocalizePrice();
  ...
  window.__fmxPosterInit = function (data, api) {
    ...
    window.__psAvVal = (data.avg_views && isFinite(data.avg_views)) ? data.avg_views : null;
    if (!el('fmx-mkt2')) {
      ...
      ms.textContent = '#poster .price{transform:translateY(-8px);}' +
        ...
        '#poster .pr{padding:17px 26px;}' +
        '#poster .prv{font-size:27px;}' +
        '#poster .prsub{font-size:12px;}';
      document.head.appendChild(ms);
    }
    if (!el('fmx-qr-fix')) {
      var qs = document.createElement('style'); qs.id = 'fmx-qr-fix';
      qs.textContent = '#qrs .qrt{width:108px !important;box-sizing:border-box !important;}' +
        '#qrs .qrt span{max-width:100px !important;font-size:7.5px !important;letter-spacing:0.1px !important;}';
  ...
  function _loadLottie() {
    ...
    _lot = Promise.all([
      ...
      (typeof lottie !== 'undefined') ? Promise.resolve() : _loadScript('https://cdnjs.cloudflare.com/ajax/libs/lottie-web/5.12.2/lottie_light.min.js')
    ]);
    return _lot;
  }
  ...
  window.__fmxPosterPanelScale = function (k) {
    ...
    st.textContent =
      ...
      '#fmx-ed-pack .chip{width:' + px(52) + ' !important;height:' + px(52) + ' !important;padding:' + px(4) + ' !important;' +
        'border-radius:' + px(14) + ' !important;overflow:hidden !important;position:relative;}' +
      ...
      '.fmx-sec{position:relative;background:rgba(255,255,255,0.025);border:1px solid rgba(255,255,255,0.08);' +
        'border-radius:' + px(14) + ';padding:' + px(12) + ' ' + px(13) + ';margin:' + px(9) + ' 0;overflow:hidden;}' +
      '.fmx-sec .lbl{margin-top:0 !important;}' +
      '.lbl{position:relative;display:flex !important;align-items:center;gap:' + px(11) + ';}' +
      '.fmx-sec > .lbl:first-child{text-transform:none !important;font-size:' + px(13) + ' !important;' +
        'font-weight:600 !important;letter-spacing:-0.2px !important;color:#e8e8ed !important;}' +
      '.fmx-sec .lbl::before{content:attr(data-ico);width:' + px(30) + ';height:' + px(30) + ';' +
        'border-radius:' + px(9) + ';display:flex;align-items:center;justify-content:center;flex-shrink:0;' +
        'font-size:' + px(15) + ';letter-spacing:0;color:#818cf8;' +
      ...
      'input[type=text],input[type=number]{background:rgba(255,255,255,0.045) !important;' +
