(function () {
  ...
  var POSTER_L = {
    ru: {"wk": "/нед", "kk": " К", "subs": "Подписчики", "reach": "Средний охват", "post_i": "· пост", "er": "Вовлечённость", "cpm": "Цена 1000 показов", "err": "Охват к подписчикам", "grow": "Прирост · 30 дней", "freq": "Частота постов", "mv": "Просмотры · месяц", "chart": "Просмотры · 30 дней", "prsub": "минимальный формат размещения", "cta": "Забронировать", "prpref": "Реклама от", "prneg": "Цена по договорённости", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Здесь рекламу дочитывают: живая аудитория и реальные охваты.", "trust": "Метрики подтверждены @ForgeMetricsBot · актуальная карточка канала — по QR-коду", "callout": "Реклама в канале"},
    en: {"wk": "/wk", "kk": "K", "subs": "Subscribers", "reach": "Average reach", "post_i": "· post", "er": "Engagement", "cpm": "Price per 1000 impressions", "err": "Reach per subscriber", "grow": "Growth · 30 days", "freq": "Posting frequency", "mv": "Views · month", "chart": "Views · 30 days", "prsub": "minimum placement format", "cta": "Reserve", "prpref": "Ads from", "prneg": "Price on request", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Ads get read here: a live audience and real reach.", "trust": "Metrics verified by @ForgeMetricsBot · up-to-date channel card via QR code", "callout": "Advertise here"},
    ...
    uz: {"wk": "/hafta", "kk": " ming", "subs": "Obunachilar", "reach": "Oʻrtacha qamrov", "post_i": "· post", "er": "Jalb etilganlik", "cpm": "1000 ta koʻrsatish narxi", "err": "Obunachiga qamrov", "grow": "Oʻsish · 30 kun", "freq": "Postlar chastotasi", "mv": "Koʻrishlar · oy", "chart": "Ko'rishlar · 30 kun", "prsub": "joylashtirishning minimal formati", "cta": "Band qilish", "prpref": "Reklama —", "prneg": "Narx kelishuv asosida", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Bu yerda reklama chindan o‘qiladi: jonli auditoriya va haqiqiy qamrov.", "trust": "Metrikalar @ForgeMetricsBot tomonidan tasdiqlangan · kanalning dolzarb kartochkasi QR orqali", "callout": "Kanalda reklama"},
    be: {"wk": "/тыд", "kk": " тыс", "subs": "Падпісчыкі", "reach": "Сярэдні ахоп", "post_i": "· допіс", "er": "Уцягнутасць", "cpm": "Цана 1000 паказаў", "err": "Ахоп да падпісчыкаў", "grow": "Прырост · 30 дзён", "freq": "Частата пастоў", "mv": "Прагляды · месяц", "chart": "Прагляды · 30 дзён", "prsub": "мінімальны фармат размяшчэння", "cta": "Забраніраваць", "prpref": "Рэклама ад", "prneg": "Цана па дамоўленасці", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Тут рэкламу дачытваюць: жывая аўдыторыя і рэальныя ахопы.", "trust": "Метрыкі пацверджаны @ForgeMetricsBot · актуальная картка канала — па QR-кодзе", "callout": "Рэклама ў канале"},
    az: {"wk": "/həftə", "kk": " min", "subs": "Abunəçilər", "reach": "Orta əhatə", "post_i": "· post", "er": "Cəlbolunma", "cpm": "1000 göstərişin qiyməti", "err": "Abunəçiyə əhatə", "grow": "Artım · 30 gün", "freq": "Post tezliyi", "mv": "Baxışlar · ay", "chart": "Baxışlar · 30 gün", "prsub": "minimum yerləşdirmə formatı", "cta": "Rezerv et", "prpref": "Reklam", "prneg": "Qiymət razılaşma ilə", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "Burada reklam həqiqətən oxunur: canlı auditoriya, real əhatə.", "trust": "Metrikalar @ForgeMetricsBot tərəfindən təsdiqlənib · kanalın aktual kartı QR kodu ilə", "callout": "Kanalda reklam"},
    ar: {"wk": "/أسبوع", "kk": " ألف", "subs": "المشتركون", "reach": "متوسط الوصول", "post_i": "· منشور", "er": "التفاعل", "cpm": "سعر 1000 ظهور", "err": "الوصول لكل مشترك", "grow": "النمو · 30 يومًا", "freq": "تكرار النشر", "mv": "المشاهدات · شهر", "chart": "المشاهدات · 30 يومًا", "prsub": "الحد الأدنى لصيغة الإعلان", "cta": "احجز الآن", "prpref": "الإعلان من", "prneg": "السعر حسب الاتفاق", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "هنا تُقرأ الإعلانات فعلًا: جمهور حقيقي ووصول حقيقي.", "trust": "المقاييس موثّقة من @ForgeMetricsBot · بطاقة القناة المحدّثة عبر رمز QR", "callout": "مساحة إعلانية"},
    fa: {"wk": "/هفته", "kk": " هزار", "subs": "دنبال‌کنندگان", "reach": "میانگین بازدید", "post_i": "· پست", "er": "نرخ تعامل", "cpm": "قیمت ۱۰۰۰ نمایش", "err": "بازدید به دنبال‌کننده", "grow": "رشد · ۳۰ روز", "freq": "تناوب پست‌ها", "mv": "بازدید · ماه", "chart": "بازدید · ۳۰ روز", "prsub": "حداقل فرمت درج آگهی", "cta": "رزرو", "prpref": "تبلیغ از", "prneg": "قیمت توافقی", "er_i": "· ER", "cpm_i": "· CPM", "err_i": "· ERR", "hook": "اینجا تبلیغ واقعاً خوانده می‌شود: مخاطب واقعی و دسترسی واقعی.", "trust": "متریک‌ها با تأیید @ForgeMetricsBot · کارت به‌روز کانال از طریق کد QR", "callout": "تبلیغ در کانال"},
  ...
  function metricValue(key, d) {
    ...
    if (key === 'mv') return (d.mv != null && isFinite(d.mv)) ? (d.mv >= 1000 ? fmt(d.mv / 1000) + (_psU().kk || ' К') : fmt(d.mv)) : null;
    return null;
  }
