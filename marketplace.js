(function () {
    ...
    var TERMS = [
        ...
        ['Переходы по ссылке', 'Сколько человек перешло из рекламного поста по ссылке отслеживания. Считаются люди, а не открытия: повторные клики и боты отсеиваются. База для расчёта CTR и CPC.'],
        ['Конверсия в подписку', 'Доля перешедших, которые подписались: подписки ÷ переходы × 100%. Показывает качество связки «источник — канал»: при хорошем CTR и низкой конверсии слабое звено — оформление и первые посты канала.'],
