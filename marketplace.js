(function () {
    ...
    function injectStyles() {
        ...
        s.textContent = [
            ...
            '.fmx-card.fmx-prem{border:1px solid transparent;background:linear-gradient(#131725,#131725) padding-box,linear-gradient(150deg,rgba(255,241,196,0.95),rgba(245,191,79,0.5) 22%,rgba(150,102,30,0.5) 48%,rgba(245,191,79,0.45) 72%,rgba(255,236,178,0.85)) border-box;box-shadow:0 4px 16px rgba(0,0,0,0.45),0 0 12px -4px rgba(245,191,79,0.42),0 6px 20px -14px rgba(245,191,79,0.38);}',
            ...
            '.fmx-li.prem>.fmx-lrow{position:relative;border-color:transparent;box-shadow:0 4px 16px rgba(0,0,0,0.45),0 0 12px -4px rgba(245,191,79,0.42),0 6px 20px -14px rgba(245,191,79,0.38);}',
