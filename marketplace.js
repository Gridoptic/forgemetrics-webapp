(function () {
    ...
    var NICHE_TAX = [
        ...
        ['Арбитраж · Дейтинг, adult, прочее', ['Дейтинг', 'Знакомства СНГ', 'Adult', 'Adult · вебкам', 'Adult · подписки / OnlyFans', 'Adult · секс-товары', 'Свипстейки / розыгрыши', 'Установки приложений / PWA', 'Мобильные игры', 'VPN / утилиты', 'Эссе / дипломы', 'Инфобизнес / заработок', 'MLM / сетевой']],
