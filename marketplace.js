(function () {
    ...
    var NICHE_TAX = [
        ...
        ['Дом, хобби, увлечения', ['Путешествия / туризм', 'Кулинария / рецепты', 'Дом / интерьер', 'Ремонт / строительство', 'Сад / огород / дача', 'Растения', 'Рукоделие', 'Охота / рыбалка', 'Авто / мото', ['Пригон авто из-за рубежа', 'Авто · Пригон из-за рубежа'], 'Транспорт', 'Коллекционирование', 'Настольные игры']],
