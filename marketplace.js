(function () {
    ...
    function injectStyles() {
        ...
        s.textContent = [
            ...
            '.fmx-nm{font-size:14px;font-weight:700;display:flex;align-items:center;gap:5px;padding-top:20px;line-height:18px;height:38px;overflow:hidden;}',
            '.fmx-seal{color:#818cf8;font-size:14px;}',
            '.fmx-meta{font-size:10.5px;color:#8990a8;margin-top:2px;line-height:13px;height:13px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}',
            '.fmx-badges{display:flex;gap:6px;flex-wrap:wrap;margin-bottom:10px;min-height:23px;}',
            '.fmx-bdg{font-size:10px;font-weight:600;padding:0 8px;height:23px;line-height:23px;border-radius:7px;display:inline-flex;align-items:center;gap:4px;}',
            ...
            '.fmx-desc{font-size:12px;color:#b9bdcf;line-height:17px;margin-bottom:11px;}',
            ...
            '.fmx-met .l{font-size:8.5px;color:#565b73;text-transform:uppercase;letter-spacing:0.2px;display:flex;align-items:center;gap:3px;margin-bottom:3px;white-space:nowrap;line-height:11px;height:11px;}',
            '.fmx-met .v{font-size:13.5px;font-weight:700;white-space:nowrap;line-height:17px;height:17px;}',
            '.fmx-met .pr{color:#5DCAA5;}',
            '.fmx-sp{margin-left:auto;display:flex;flex-direction:column;align-items:flex-start;}',
            '.fmx-sp svg{display:block;margin-top:-1.5px;}',
            ...
            '.fmx-fchips span{font-size:9.5px;color:#8990a8;background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.07);padding:0 8px;height:20px;line-height:19px;display:inline-flex;align-items:center;border-radius:6px;}',
    ...
    function todayLine() {
        ...
        return '<div class="fmx-pday"><i class="ti ti-flame" style="color:#f59e0b;"></i> Сегодня на Площадке: ' + bits.join(' · ') + '</div>';
    }
    ...
    function renderBuy() {
        ...
        if (!_pulse) loadPulse(function () { if (_mainTab === 'market' && _subTab === 'buy' && _pulse) renderBuy(); });
    }
