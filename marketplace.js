(function () {
    ...
    function listItem(l) {
        var hc = _healthColor(l), accent = _accent(l), t = l.title || l.username || '?';
        ...
        return '<div class="fmx-li" data-u="' + _esc(l.username) + '">' +
            ...
            '<span class="fmx-lprice">' + _priceFrom(l) + '</span><i class="ti ti-chevron-down fmx-lchev"></i></div>' +
