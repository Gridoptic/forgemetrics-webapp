(function () {
    ...
    var L = function (s) { return (typeof window.t === 'function') ? window.t(s) : s; };
    ...
    function _audLabel(l) {
        if (l.audience_source === 'commenters' && l.female_pct != null && (l.gender_sample || 0) >= 15) {
            ...
            return { icon: fem ? 'ti-gender-female' : 'ti-gender-male', color: fem ? '#ff6fae' : '#5b9dff',
                short: (fem ? L('жен') : L('муж')) + ' ≈' + main + '%',
                text: '≈' + main + L('% комментаторов — ') + (fem ? L('женщины') : L('мужчины')),
                note: L('оценка по ') + l.gender_sample + L(' именам') };
        }
        return null;
    }
    function _audChip(l) {
    ...
    var COVER_NAMES = [L('Фиолет'), L('Изумруд'), L('Закат'), L('Океан'), L('Огонь'), L('Магента')];
    var COLORS = ['#818cf8', '#3b82f6', '#22d3ee', '#5DCAA5', '#a3e635', '#facc15', '#f59e0b', '#F0997B', '#ef4444', '#ec4899', '#a78bfa', '#f5bf4f'];
    var FONTS = [['normal', L('Обычный')], ['bold', L('Жирный')], ['wide', L('Широкий')], ['mono', L('Моно')]];
    ...
    var TERMS = [
        [L('Подписчики'), L('Общее число подписок на канал. Само по себе почти ничего не значит: подписчиков накручивают, закупают и прогоняют ботами. 50 000 живых читателей и 50 000 накрученных стоят по-разному и дают разный результат. Всегда смотри подписчиков в паре с охватом и ER: важно не сколько подписано, а сколько человек фактически видит и читает посты.')],
        [L('Средний охват поста'), L('Сколько человек в среднем видит один пост: медиана по зрелым постам за последние недели; самые свежие — младше двух суток — не учитываются, они ещё набирают охват и занижали бы среднее. Ключевое число при закупке: через него считаются CPM и цена контакта. Важно: рекламный пост почти всегда собирает меньше органического — его листают, а в формате с удалением он живёт ограниченное время. Планируй по охвату недавних рекламных постов, а не обычных, и проси эту статистику у владельца — иначе фактический CPM окажется выше ожидаемого.')],
        [L('ER · вовлечённость'), L('Доля видевших пост, которые отреагировали: (реакции + репосты + комментарии) ÷ просмотры поста × 100%, медиана по зрелым постам. Не путать с ERR: та показывает, какая доля подписчиков вообще видит посты, а ER — насколько увиденное цепляет аудиторию. Ориентиры: ниже 1% — слабая вовлечённость, 1–3,5% — средняя, выше 3,5% — высокая; у новостных потоков нормы ниже, у узких экспертных ниш — выше. Высокий охват при ER около нуля — тревожный сигнал: аудиторию привели, но канал ей неинтересен, и реклама пройдёт мимо. Реакции подделать дороже, чем просмотры, поэтому ER — важный маркер при проверке на накрутку.')],
        [L('Отклик на рекламе'), L('Как аудитория реагирует именно на рекламные посты: (реакции ÷ охват) по рекламным публикациям канала. Сам по себе процент мало о чём говорит — смысл в сравнении с обычными постами того же канала. Если реклама собирает заметно меньше, аудитория её пролистывает: охват вы получите, действие — вряд ли. Рекламные посты определяются по маркировке (erid, «на правах рекламы», рекламные хештеги) и по структуре: метки отслеживания, промокод, внешняя ссылка с призывом. Метрика показывается при трёх и более рекламных постах — по одному-двум вывод делать нельзя, и на цену канала она не влияет.')],
        [L('ERR · охват к базе'), L('Какая доля подписчиков видит посты: охват ÷ подписчики × 100%. Норма зависит от размера канала: микро до 5к — 25–50%, малый 5–10к — 18–35%, средний 10к–100к — 7–22%, крупный 100к–1М — 6–16%, миллионник — 3–10%. У больших каналов процент всегда ниже, и это нормально. Сильно ниже своей нормы — признак выгоревшей или накрученной базы. Пример: 100 000 подписчиков при охвате 1 000 — это 1%, база выгоревшая, а число в шапке — витрина. Поправка на размер: у небольших каналов процент естественно выше (40–100%), у очень крупных 10–15% — уже норма, а не тревога.')],
        [L('ERR24 · охват за первые сутки'), L('Какую долю подписчиков пост собирает за первые 24 часа: охват за сутки ÷ подписчики × 100%. Показывается в карточке рядом с ERR, когда замеров достаточно. Для рекламодателя это главное окно: большинство форматов держится в топе часы, и именно суточный охват показывает, сколько людей фактически увидит размещение. В развороте форматов CPM считается по охвату рекламного поста за первые 24 часа — по фактическим замерам сделок.')],
        [L('CPM · цена за 1000 просмотров'), L('Стоимость тысячи показов рекламы: цена размещения ÷ показы (просмотры поста) × 1000. Главный инструмент сравнения каналов. Пример: пост за 5 000 ₽ при охвате 20 000 — CPM 250 ₽; пост за 8 000 ₽ при охвате 50 000 — CPM 160 ₽. Второй дороже на ценнике, но контакт в нём более чем в полтора раза дешевле. Сравнивай каналы одной ниши по CPM, а не по сумме размещения.')],
        [L('CTR · кликабельность'), L('Доля увидевших пост, которые кликнули по ссылке: клики ÷ показы × 100%. В размещениях в каналах ориентир 0,5–2%: выше — креатив и аудитория попали друг в друга, ниже — пост не цепляет или аудитория не та. CTR — метрика твоего креатива, а не канала: один и тот же канал даст разный CTR разным объявлениям. В Трекере кампаний считается автоматически по кликам и показам поста.')],
        [L('CPC · цена клика'), L('Стоимость одного перехода: цена размещения ÷ клики. Мост между ценой показа и ценой результата: CPM показывает цену внимания, CPC — цену заинтересованного человека. В Трекере кампаний считается по кликам ссылки размещения. Сравнивай CPC каналов только при одинаковых креативах — иначе сравниваешь не каналы, а объявления.')],
        [L('CPF · цена подписчика'), L('Потрачено ÷ новые подписчики с размещения. Главная метрика, когда цель закупки — рост собственного канала. Пример: пост за 5 000 ₽ привёл 250 подписчиков — CPF 20 ₽. В Трекере кампаний считается автоматически: подписки атрибутируются размещению в окне 7 дней. Смотри не только цену, но и качество: дешёвый мотивированный трафик отваливается за неделю — проверяй CPF в паре с удержанием.')],
        [L('Показы размещения'), L('Сколько человек увидело рекламный пост. До выхода поста показывается предварительная оценка по охвату канала; после выхода цифра заменяется фактическими просмотрами поста. База для расчёта CPM и CTR.')],
        [L('Клики по ссылке'), L('Сколько человек перешло из рекламного поста по ссылке отслеживания. Считаются люди, а не открытия: повторные клики и боты отсеиваются. База для расчёта CTR и CPC.')],
        [L('Конверсия в подписку'), L('Доля перешедших, которые подписались: подписки ÷ клики × 100%. Показывает качество связки «источник — канал»: при хорошем CTR и низкой конверсии слабое звено — оформление и первые посты канала.')],
        [L('Удержание 7 дней'), L('Метрика Трекера кампаний: сколько из вступивших по размещению остаются в канале через неделю. Отвал свежего трафика 10–25% — норма; заметно больше — креатив обещает не то, что человек находит в канале, либо трафик низкого качества. Смотри удержание в паре с CPF: дешёвый подписчик, который уходит через три дня, на деле дороже честного.')],
        [L('Цена оставшегося подписчика'), L('Потрачено ÷ подписчики, оставшиеся в канале через 7 дней после вступления. Честнее CPF: считает не всех пришедших, а только тех, кто остался после первичного отвала.')],
        [L('Отписки после размещения'), L('Сколько вступивших по размещению покинуло канал в окне отслеживания. Небольшой отвал в первые дни — норма; отвал больше трети вступивших — сигнал, что аудитория источника не совпала с контентом канала.')],
        [L('ROI · окупаемость'), L('Чистая прибыль ÷ затраты на размещение × 100%. Пример: пост за 5 000 ₽ принёс продаж на 12 000 ₽ при себестоимости 4 000 ₽ — прибыль 3 000 ₽, ROI 60%. Выше нуля — размещение в плюсе, ниже — в минусе. Фактический ROI считай по своим продажам через метку в ссылке.')],
        [L('Форматы размещения'), L('Как именно выходит реклама — это меняет и охват, и цену. Рыночная нотация «часы в топе / часы до удаления»: «1/24» — 1 час вверху ленты и удаление через 24 часа, «2/48» — 2 часа вверху и удаление через 48 часов, «3/72» — 3 часа и 72. Первая цифра (часы в топе) — главный параметр охвата, за неё и доплачивают; вторая — сколько пост живёт до удаления. Другие форматы: пост без удаления (на биржах его обычно называют «30 дней», не «вечный»), закреп сверху канала, нативная интеграция в авторский пост, формат-кружок. Дольше в топе и дольше до удаления — выше охват и цена. Сравнивай CPM только между одинаковыми форматами и уточняй у владельца часы в топе и срок удаления.')],
    ...
    var RULES = [
        [L('Запрещено полностью'), L('Наркотики и их пропаганда; оружие и взрывчатка; порнография; терроризм, экстремизм и символика запрещённых организаций; призывы к суициду и селф-харму; шок-контент — кровь, увечья, жестокость к людям и животным; торговля людьми, документами и краденым.')],
        [L('Финансы и «схемы»'), L('Пирамиды, скам-проекты, «бинарные опционы» и обещания гарантированного дохода — блокировка. Азартные игры — только лицензированные операторы с предупреждением о рисках. Кредитные продукты — только с полными и честными условиями.')],
        [L('Здоровье и «чудо-средства»'), L('Обещания вылечить болезни, «минус 20 кг за неделю» и псевдомедицина запрещены. Медицина, лекарства и добавки — только с корректными оговорками и без гарантий результата.')],
        [L('Алкоголь, табак, вейпы'), L('Реклама алкоголя, табака, вейпов и жидкостей для них на Площадке не размещается — в любом виде, включая «обзоры» с промокодами.')],
        [L('Картинки, GIF и видео'), L('Без чужих брендов, логотипов и персонажей — это чужая интеллектуальная собственность. Без реальных людей без их согласия, включая дипфейки. Без строб-вспышек чаще 3 раз в секунду. Дети в рекламе — только когда это оправдано самим товаром.')],
        [L('Эмодзи и стикеры'), L('Стикер или эмодзи с запрещённой символикой, наркотиками или 18+ — то же нарушение, что и картинка. Комбинации эмодзи, маскирующие запрещённые товары, тоже считаются нарушением.')],
        [L('18+ и серая зона'), L('Эротика 18+ — только в отдельном разделе с подтверждением возраста. Лицензируемые ниши — азартные игры, финансы, крипта — проверяются строже и дольше.')],
        [L('Маркировка рекламы'), L('В некоторых странах интернет-реклама подлежит обязательной маркировке (например, в России — токен erid). Это ответственность сторон сделки. Поле erid в оффере — опциональное: заполняй, если работаешь с аудиторией, где маркировка обязательна.')],
        [L('Ответственность'), L('За контент оффера отвечает тот, кто его разместил — это фиксируется при публикации. Также запрещено всё, что запрещено законами страны, на аудиторию которой направлена реклама. Нарушение — снятие оффера, повторное или грубое — бан. Пожаловаться на любой оффер можно в один тап.')]
    ];
    var TIPS = [
        [L('Закупщику · считай цену контакта, а не размещения'), L('Ориентир — не цена поста, а CPM (цена ÷ охват × 1000). Пример: пост за 5 000 ₽ при охвате 20 000 даёт CPM 250 ₽; пост за 3 000 ₽ при охвате 8 000 — CPM 375 ₽. Второй дешевле на ценнике, но каждая тысяча показов обходится в полтора раза дороже. Сравнивай каналы одной ниши по CPM — это единственная честная база для сравнения.')],
        [L('Закупщику · проверяй охват к подписчикам'), L('Раздели средний охват поста на число подписчиков и сравни с нормой для размера канала: микро до 5к — 25–50%, малый 5–10к — 18–35%, средний 10к–100к — 7–22%, крупный 100к–1М — 6–16%, миллионник — 3–10%. Сравнивать канал на 3 000 подписчиков с миллионником по одной шкале бессмысленно. Канал со 100 000 подписчиков и охватом 2 000 (2%) — почти всегда выгоревшая или накрученная база: платишь за число в шапке, а рекламу увидят единицы. Поправка: у небольших каналов процент естественно выше, у очень крупных ниже — это нормально.')],
        [L('Закупщику · читай ER в паре с охватом'), L('Высокий охват при ER около нуля означает, что аудиторию привели, но канал ей неинтересен. Живой канал с ER 5–10% нередко конвертирует лучше крупного с ER 1%. Реакции — лайки, репосты, комментарии — подделать дороже, чем просмотры, поэтому ER точнее показывает вовлечённость.')],
        [L('Закупщику · проверяй метрики вживую, не по скриншотам'), L('Скриншот статистики легко нарисовать или показать удачный день. Ориентируйся на живые метрики в оффере и на разворот канала, а не на присланные картинки. Если продавец отказывается показать актуальный охват и просит верить на слово — это повод насторожиться.')],
        [L('Закупщику · оценивай динамику, а не снимок дня'), L('Резкий скачок подписчиков за 30 дней без вирусного повода — частый признак закупки или накрутки; после него охват проседает, и реклама выходит на спаде. Плавный органический рост надёжнее. Жёлтый или красный светофор — сигнал открыть «Развернуть» и проверить график просмотров вручную.')],
        [L('Закупщику · релевантность ниши важнее размера'), L('Реклама финансового оффера в профильном канале о финансах отработает лучше, чем во вдвое большем канале о рецептах. Бейдж «В нише» помечает каналы твоей ниши. Узкий, но релевантный канал обычно даёт более дешёвую и качественную конверсию, чем широкий, но нерелевантный охват.')],
        [L('Закупщику · сверяй гео и язык аудитории с оффером'), L('Отличные ER и охват на аудитории из недорогого гео или на чужом языке денег не принесут — оффер платит по конкретным странам. Перед закупкой уточни топ-страны и язык аудитории (у владельца или в статистике канала) и бери канал под гео и язык своего оффера, а не только под нишу.')],
    ...
    function _short(n) {
        if (n == null) return '—';
        if (n >= 1000000) return (Math.round(n / 100000) / 10 + '').replace('.', ',') + L('М');
        if (n >= 1000) return (Math.round(n / 100) / 10 + '').replace('.', ',') + L('К');
        return String(n);
    }
    ...
    function uiConfirm(msg, cb) {
        ...
        bg.innerHTML = '<div class="fmx-cfm-box"><div class="fmx-cfm-t">' + _esc(String(msg)) + '</div>' +
            '<div class="fmx-cfm-r"><button class="fmx-btn" data-no>' + L('Отмена') + '</button><button class="fmx-btn" data-yes style="background:#818cf8;color:#fff;border-color:transparent;">' + L('Да') + '</button></div></div>';
    ...
    function _hlInfo(l) {
        var m = { green: ['#5DCAA5', L('Здоровый')], amber: ['#f59e0b', L('Средний')], yellow: ['#f59e0b', L('Средний')], red: ['#ef4444', L('Риск')] };
        var cls = l.health_class && m[l.health_class] ? (l.health_class === 'yellow' ? 'amber' : l.health_class) : null;
        if (!cls && l.reach_status) { var st = l.reach_status; cls = (st === 'норма' || st === 'выше нормы') ? 'green' : (st === 'ниже нормы') ? 'amber' : 'red'; }
        if (!cls) return { cls: 'none', color: '#565b73', word: L('Нет данных') };
    ...
    function _healthColor(l) { var m = { green: '#5DCAA5', amber: '#f59e0b', yellow: '#f59e0b', red: '#ef4444' }; if (l.health_class && m[l.health_class]) return m[l.health_class]; if (l.reach_status) { var st = l.reach_status; return (st === 'норма' || st === 'выше нормы') ? '#5DCAA5' : (st === 'ниже нормы') ? '#f59e0b' : '#ef4444'; } return '#565b73'; }
    ...
    function injectStyles() {
        ...
        s.textContent = [
            ...
            '.fmx-pillbar{position:relative;display:flex;margin:0 16px;background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.10);border-radius:13px;padding:4px;flex-shrink:0;}',
            ...
            '.fmx-card.fmx-prem{border-color:transparent;box-shadow:inset 0 1px 12px -6px rgba(245,191,79,0.5),0 0 22px -6px rgba(245,191,79,0.55),0 10px 30px -14px rgba(245,191,79,0.5),0 4px 16px rgba(0,0,0,0.45);}',
            ...
            '#fmx-hero .fmx-cov-bg::before{animation:none;}',
            '#fmx-hero .fmx-card,#fmx-hero .fmx-card *{transition:none !important;}',
            '.fmx-tag{position:absolute;top:9px;left:9px;font-size:9px;font-weight:700;padding:4px 8px;border-radius:6px;background:rgba(10,13,24,0.62);color:#5DCAA5;z-index:7;display:flex;align-items:center;gap:4px;}',
            '.fmx-tag.gold{background:linear-gradient(135deg,#fde68a,#f5bf4f);color:#2a1c00;}',
            '.fmx-star{position:absolute;bottom:9px;right:9px;width:30px;height:30px;border-radius:8px;background:rgba(10,13,24,0.58);border:none;color:#fff;cursor:pointer;font-size:15px;display:flex;align-items:center;justify-content:center;z-index:2;}',
            ...
            '.fmr-pulse{margin-top:6px;display:flex;gap:6px;align-items:center;flex-wrap:wrap;}',
            '.fmr-nline{margin-top:3px;font-size:11.5px;color:#c7ccf7;display:flex;align-items:center;gap:5px;flex-wrap:wrap;}',
            '.fmr-nline i{color:#818cf8;font-size:13px;}',
            '.fmr-nline .mt{color:#5DCAA5;font-weight:600;display:inline-flex;align-items:center;gap:4px;}',
            ...
            '.fmr-blk{border-radius:14px;padding:12px 13px;margin-bottom:10px;}',
            ...
            '.fmx-modal{width:100%;max-width:480px;max-height:88vh;background:rgba(17,20,31,0.9);border:0;border-top:1.5px solid rgba(255,255,255,0.38);border-radius:22px 22px 0 0;display:flex;flex-direction:column;overflow:hidden;animation:fmxUp 320ms cubic-bezier(.2,.8,.2,1);backdrop-filter:blur(22px) saturate(1.4);-webkit-backdrop-filter:blur(22px) saturate(1.4);box-shadow:0 -26px 64px rgba(0,0,0,0.75),0 1px 0 rgba(255,255,255,0.08) inset;}',
            ...
            '@media(min-width:640px){.fmx-modal{border-radius:22px;border:1.5px solid rgba(255,255,255,0.38);}.fmx-modal::before{display:none;}}',
            ...
            '.fmx-po{border:0.5px solid rgba(255,255,255,0.1);border-radius:13px;padding:14px;margin-bottom:11px;background:rgba(255,255,255,0.02);}',
            ...
            '.fmx-li.prem>.fmx-lrow{position:relative;border-color:transparent;box-shadow:inset 0 1px 10px -6px rgba(245,191,79,0.5),0 0 18px -5px rgba(245,191,79,0.55),0 8px 24px -12px rgba(245,191,79,0.45),0 4px 16px rgba(0,0,0,0.45);}',
            ...
            '.fmx-ps{width:100%;max-width:580px;max-height:92vh;overflow-y:auto;background:#0b0e18;border:0;border-top:1.5px solid rgba(255,255,255,0.38);border-radius:22px 22px 0 0;box-shadow:0 -26px 64px rgba(0,0,0,0.75),0 1px 0 rgba(255,255,255,0.08) inset;padding:14px 14px 22px;scrollbar-width:thin;scrollbar-color:rgba(129,140,248,0.35) transparent;scrollbar-gutter:stable;}',
            '.fmx-ps::-webkit-scrollbar{width:5px;}',
            '.fmx-ps::-webkit-scrollbar-track{background:transparent;}',
            '.fmx-ps::-webkit-scrollbar-thumb{background:rgba(129,140,248,0.22);border-radius:99px;}',
            ...
            '.fmx-t2fold:not(.open):after{content:\'\';position:absolute;left:-2px;right:-2px;bottom:0;height:54px;background:linear-gradient(180deg,rgba(10,13,24,0),rgba(10,13,24,0.88) 62%,#0a0d18 96%);pointer-events:none;}',
            ...
            '.fmx-frzTag{position:absolute;top:8px;right:max(56px,calc(50% - 119px));font-size:9px;font-weight:700;color:#8fb6ff;background:rgba(99,140,255,0.14);border:0.5px solid rgba(99,140,255,0.3);padding:3px 7px;border-radius:6px;display:flex;align-items:center;gap:4px;z-index:3;}',
            '.fmx-bmdel{position:absolute;top:50%;transform:translateY(-50%);right:max(7px,calc(50% - 168px));width:40px;height:40px;border-radius:11px;background:rgba(10,13,24,0.6);border:0.5px solid rgba(239,68,68,0.3);color:#ef4444;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:14px;z-index:3;transition:background 140ms,border-color 140ms,color 140ms,transform 140ms;}',
            '.fmx-bmdel.arm{background:#ef4444;border-color:#ef4444;color:#fff;transform:translateY(-50%) scale(1.1);}',
            ...
            '.fmx-bmdel{width:36px;height:36px;right:max(5px,calc(50% - 170px));}' +
            '}',
            '@media (max-width:330px){' +
            '.fmx-bmrow .fmx-lrow{padding-right:40px;padding-left:9px;}' +
            '.fmx-bmrow .fmx-lmet .fmx-lm:first-child i{display:none;}' +
            '.fmx-bmdel{width:34px;height:34px;right:max(4px,calc(50% - 171px));}' +
            '}',
            ...
            '.fmx-ent{display:flex;align-items:center;gap:14px;padding:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);border-radius:16px;cursor:pointer;margin-bottom:11px;transition:border-color 160ms,transform 160ms,background 160ms;}',
            ...
            '.fmx-lamps{display:flex;gap:8px;margin-bottom:11px;}',
            '.fmx-lamp{flex:1;min-width:0;background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.10);border-radius:12px;padding:10px 9px;text-align:left;cursor:pointer;font-family:inherit;min-height:56px;}',
            '.fmx-lamp .dot{width:8px;height:8px;border-radius:50%;display:block;margin-bottom:7px;background:#8990a8;}',
            '.fmx-lamp.ok .dot{background:#5DCAA5;box-shadow:0 0 10px rgba(93,202,165,0.75);}',
            '.fmx-lamp.warn .dot{background:#f59e0b;box-shadow:0 0 10px rgba(245,158,11,0.7);}',
            '.fmx-lamp.bad .dot{background:#f87171;box-shadow:0 0 10px rgba(248,113,113,0.7);}',
            '.fmx-lamp .k{font-size:10px;color:#6b7088;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
            '.fmx-lamp .n{font-size:13px;font-weight:800;color:#e8e8ed;margin-top:2px;font-variant-numeric:tabular-nums;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
            '.fmx-verd{border-radius:16px;padding:15px 15px 14px;margin-bottom:12px;background:linear-gradient(135deg,rgba(99,102,241,0.20),rgba(139,92,246,0.09));border:0.5px solid rgba(129,140,248,0.42);}',
            '.fmx-verd .big{font-size:25px;font-weight:800;color:#fff;line-height:1.06;letter-spacing:-0.02em;overflow-wrap:anywhere;}',
            '.fmx-verd .cap{font-size:11.5px;color:#c9cbe8;margin-top:5px;}',
            '.fmx-verd .split{display:flex;gap:6px;flex-wrap:wrap;margin-top:11px;}',
            '.fmx-vchip{font-size:10.5px;font-weight:600;padding:4px 9px;border-radius:99px;border:0.5px solid rgba(255,255,255,0.16);background:rgba(255,255,255,0.06);color:#c5c8d6;white-space:nowrap;}',
            '.fmx-vchip.bad{color:#f87171;border-color:rgba(248,113,113,0.34);background:rgba(239,68,68,0.12);}',
            '.fmx-vchip.warn{color:#f59e0b;border-color:rgba(245,158,11,0.32);background:rgba(245,158,11,0.10);}',
            '.fmx-verd.calm{background:linear-gradient(135deg,rgba(93,202,165,0.16),rgba(93,202,165,0.05));border-color:rgba(93,202,165,0.38);}',
            '.fmx-verd.calm .big{font-size:19px;color:#5DCAA5;}',
            '.fmx-verd.mute{background:rgba(255,255,255,0.04);border-color:rgba(255,255,255,0.10);}',
            '.fmx-verd.mute .big{font-size:17px;color:#c5c8d6;}',
            '.fmx-task{position:relative;background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.10);border-radius:14px;padding:13px 14px 13px 16px;margin-bottom:10px;overflow:hidden;transition:opacity .25s;}',
            '.fmx-task::before{content:"";position:absolute;left:0;top:0;bottom:0;width:3px;background:#818cf8;}',
            '.fmx-task.s-complaint::before{background:#f87171;}',
            '.fmx-task.s-stalled::before{background:#f59e0b;}',
            '.fmx-task.s-adult::before{background:#c084fc;}',
            '.fmx-task.done{opacity:.42;}',
            '.fmx-tkrow{display:flex;align-items:center;gap:8px;margin-bottom:6px;}',
            '.fmx-tkind{font-size:9.5px;font-weight:700;letter-spacing:0.05em;text-transform:uppercase;padding:3px 8px;border-radius:6px;color:#a5b4fc;background:rgba(99,102,241,0.14);border:0.5px solid rgba(99,102,241,0.32);white-space:nowrap;}',
            '.fmx-tkind.bad{color:#f87171;background:rgba(239,68,68,0.13);border-color:rgba(239,68,68,0.30);}',
            '.fmx-tkind.warn{color:#f59e0b;background:rgba(245,158,11,0.11);border-color:rgba(245,158,11,0.28);}',
            '.fmx-tkind.adult{color:#d8b4fe;background:rgba(192,132,252,0.12);border-color:rgba(192,132,252,0.30);}',
            '.fmx-tai{font-size:11px;color:#8990a8;margin-top:7px;padding:7px 9px;border-radius:9px;background:rgba(255,255,255,0.035);border:0.5px solid rgba(255,255,255,0.07);line-height:1.45;overflow-wrap:anywhere;}',
            '.fmx-tai b{color:#c5c8d6;font-weight:700;}',
            '.fmx-tdone{font-size:11.5px;color:#5DCAA5;font-weight:700;display:flex;align-items:center;gap:6px;margin-top:9px;}',
            '.fmx-sec{background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.10);border-radius:14px;margin-bottom:9px;overflow:hidden;}',
            '.fmx-sechd{display:flex;align-items:center;gap:11px;padding:13px 14px;min-height:56px;width:100%;background:transparent;border:0;font-family:inherit;text-align:left;cursor:pointer;}',
            '.fmx-secic{width:30px;height:30px;border-radius:9px;flex:0 0 auto;display:flex;align-items:center;justify-content:center;font-size:14px;background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.10);color:#8990a8;}',
            '.fmx-secic.green{background:rgba(93,202,165,0.13);border-color:rgba(93,202,165,0.28);color:#5DCAA5;}',
            '.fmx-secic.vio{background:rgba(139,92,246,0.14);border-color:rgba(139,92,246,0.30);color:#c4b5fd;}',
            '.fmx-secnm{font-size:13px;font-weight:700;color:#e8e8ed;}',
            '.fmx-secsub{font-size:10.5px;color:#6b7088;margin-top:2px;overflow-wrap:anywhere;}',
            '.fmx-secval{margin-left:auto;font-size:14px;font-weight:800;color:#e8e8ed;font-variant-numeric:tabular-nums;text-align:right;flex:0 0 auto;}',
            '.fmx-secval span{display:block;font-size:9.5px;font-weight:600;color:#6b7088;}',
            '.fmx-secchev{color:#565b73;font-size:14px;flex:0 0 auto;margin-left:8px;transition:transform .18s;}',
            '.fmx-sec.open .fmx-secchev{transform:rotate(180deg);}',
            '.fmx-secbody{padding:0 14px 13px;border-top:0.5px solid rgba(255,255,255,0.06);}',
            '.fmx-modfoot{font-size:10.5px;color:#565b73;text-align:center;margin:14px 0 4px;}',
            ...
            '.fmx-mcard{background:rgba(255,255,255,0.04);border:0.5px solid rgba(255,255,255,0.10);border-radius:14px;padding:13px 14px;margin-bottom:11px;}',
            ...
            '.fmx-sheet{position:fixed;bottom:0;left:50%;transform:translate(-50%,105%);width:100%;max-width:520px;z-index:9410;background:rgba(20,24,40,0.97);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-radius:22px 22px 0 0;border:0;border-top:1.5px solid rgba(255,255,255,0.38);box-shadow:0 -26px 64px rgba(0,0,0,0.75),0 1px 0 rgba(255,255,255,0.08) inset;padding:10px 16px 22px;transition:transform 240ms cubic-bezier(0.3,0.9,0.3,1);max-height:84dvh;overflow-y:auto;}',
            ...
            '.fmx-chmduo{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:9px;}',
            '.fmx-chmbig{background:rgba(255,255,255,.035);border:1px solid rgba(255,255,255,.07);border-radius:14px;padding:11px 12px;min-width:0;}',
            '.fmx-chml{font-size:9.5px;font-weight:700;letter-spacing:.4px;text-transform:uppercase;color:#6f748c;}',
            '.fmx-chmv{font-size:22px;font-weight:800;letter-spacing:-.5px;margin-top:3px;color:#e8e8ed;line-height:1.15;}',
            '.fmx-chmn{font-size:9.5px;color:#8990a8;margin-top:5px;line-height:1.4;overflow-wrap:anywhere;}',
            '.fmx-chmrows{margin-top:2px;}',
            '.fmx-chmrow{display:flex;align-items:center;gap:10px;padding:9px 0;border-top:1px solid rgba(255,255,255,.055);}',
            '.fmx-chmrow:first-child{border-top:none;}',
            '.fmx-chmn1{flex:1;min-width:0;}',
            '.fmx-chmn1 b{display:block;font-size:12px;font-weight:700;color:#cdd0de;}',
            '.fmx-chmn1 span{display:block;font-size:9.5px;color:#6f748c;margin-top:1px;line-height:1.35;overflow-wrap:anywhere;}',
            '.fmx-chmr{text-align:right;flex:0 0 auto;max-width:46%;}',
            '.fmx-chmp{display:inline-block;font-size:9.5px;font-weight:700;padding:2px 7px;border-radius:7px;border:1px solid;line-height:1.35;}',
            '.fmx-chmaud{margin-top:9px;background:rgba(255,255,255,.035);border:1px solid rgba(255,255,255,.07);border-radius:13px;padding:10px 11px;}',
            '.fmx-chmauh{display:flex;justify-content:space-between;align-items:baseline;gap:8px;}',
            '.fmx-chmauh b{font-size:12.5px;font-weight:700;color:#e8e8ed;white-space:nowrap;}',
            '.fmx-chmbar{height:6px;border-radius:4px;margin-top:7px;overflow:hidden;display:flex;}',
            '.fmx-chmbar i{display:block;height:100%;}',
            '.fmx-chmbl{display:flex;justify-content:space-between;gap:8px;font-size:9.5px;color:#6f748c;margin-top:4px;}',
            '.fmx-chmdead{font-size:11px;color:#f06978;margin-top:8px;line-height:1.45;}',
            ...
            '.fmx-tabmore{border:0.5px solid rgba(255,255,255,0.22);background:rgba(16,20,34,0.72);color:#fff;border-radius:99px;padding:9px 20px;font-size:11.5px;font-weight:700;cursor:pointer;font-family:inherit;min-height:38px;box-shadow:0 8px 24px rgba(0,0,0,0.45);}',
            ...
            '.fmx-tedhelp{margin-top:12px;padding:13px 14px;border-radius:14px;background:linear-gradient(135deg,rgba(129,140,248,0.14),rgba(129,140,248,0.05));border:1px solid rgba(129,140,248,0.35);}',
    ...
    function ensureRoot() {
        ...
        d.id = 'fmx-screen';
        d.innerHTML =
            '<div class="fmx-head"><button class="fmx-ibtn" id="fmx-back" title="' + L('Назад') + '" style="margin-right:2px;"><i class="ti ti-arrow-left"></i></button>' +
            '<div style="flex:1;min-width:0;overflow:hidden;"><h1 id="fmx-htitle" style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">' + L('Рынок рекламы') + '</h1><p id="fmx-hsub" style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:none;"></p></div>' +
            '<button class="fmx-ibtn" id="fmx-faq" title="' + L('Справка') + '"><i class="ti ti-help"></i></button>' +
            '<button class="fmx-ibtn" id="fmx-bhelp" style="margin-left:7px;" title="' + L('Что значат бейджи') + '"><i class="ti ti-rosette-discount-check"></i></button>' +
    ...
    function setMainTab(t, force) {
        ...
        if (ti && su) {
            if (t === 'catalog') { _mqText(ti, L('Радар каналов')); _mqText(su, L('Все каналы, собранные ботом')); su.style.display = ''; }
            else if (t === 'market') { _mqText(ti, L('Площадка')); _mqText(su, L('ForgeMetrics · живые офферы')); su.style.display = ''; }
            else if (t === 'pulse') { _mqText(ti, L('Рыночный терминал')); _mqText(su, L('Индекс CPM, теплокарта и события рынка')); su.style.display = ''; }
            else if (t === 'mod') { _mqText(ti, L('Модерация')); _mqText(su, L('Только для владельца')); su.style.display = ''; }
            else { _mqText(ti, L('Рынок рекламы')); _mqText(su, ''); su.style.display = 'none'; }
        }
    ...
    function _tFoldOpen(html, key, fh) {
        return '<div class="fmx-t2fold' + (_tFold[key] ? ' open' : '') + '" data-tfold="' + key + '" style="--fh:' + fh + 'px;">' + html + '</div>' +
            ...
            '<i class="ti ti-chevron-' + (_tFold[key] ? 'up' : 'down') + '"></i><span>' + (_tFold[key] ? L('Свернуть') : L('Развернуть')) + '</span></button></div>';
    }
    function _tBindFolds(host) {
        qsa(host, '[data-tfoldbtn]').forEach(function (b) {
            ...
            b.addEventListener('click', function () {
                ...
                b.innerHTML = '<i class="ti ti-chevron-' + (_tFold[key] ? 'up' : 'down') + '"></i><span>' + (_tFold[key] ? L('Свернуть') : L('Развернуть')) + '</span>';
    ...
    function _tSpark(vals, color) {
        ...
        if (vals.length < 3) {
            return '<span class="fmx-t2nospark">' +
                (vals.length ? L('день ') + vals.length + L(' из 3') : L('копится')) + '</span>';
        }
        ...
        return '<span class="fmx-t2spw"><svg width="62" height="24" viewBox="0 0 62 24">' +
            ...
            '<span class="fmx-t2spd">' + _termSpark + L('д') + '</span></span>';
    }
    var _MON_S = [L('янв'), L('фев'), L('мар'), L('апр'), L('мая'), L('июн'), L('июл'), L('авг'), L('сен'), L('окт'), L('ноя'), L('дек')];
    function _tArea(series, color, gid) {
        if (!series || series.length < 3) return '<div class="fmx-t2nochart">' + L('График появится с накоплением данных') + '</div>';
        ...
        var d0 = isTime ? series[0].t : series[0].day;
        function _dl(iso) {
            try {
                if (isTime) { var dt = new Date(iso); return ('0' + dt.getHours()).slice(-2) + ':' + ('0' + dt.getMinutes()).slice(-2); }
                var p = iso.split('-'); return parseInt(p[2], 10) + ' ' + _MON_S[parseInt(p[1], 10) - 1];
            } catch (e) { return ''; }
        }
        ...
        return '<svg viewBox="0 0 340 84" preserveAspectRatio="none" style="display:block;width:100%;">' +
            ...
            (function () {
                ...
                return '<div class="fmx-t2ax"><span>' + _dl(d0) + '</span>' + mids +
                    '<span>' + (isTime ? L('сейчас') : L('сегодня')) + '</span></div>';
            })();
    }
    function _tSeriesDelta(series, range) {
        ...
        if (range && days >= range - 1) {
            label = L('за ') + range + L(' дн');
        } else {
            var d0 = new Date(series[0].day);
            label = L('с ') + ('0' + d0.getDate()).slice(-2) + '.' + ('0' + (d0.getMonth() + 1)).slice(-2);
        }
    ...
    function _tTreemap(items, hottest) {
        ...
        var scale = W * H / total;
        var areas = list.map(function (n) { return _wt(n) * scale; });
    ...
    function _tEventHtml(e, isFirst) {
        ...
        var txt = '';
        if (e.type === 'spike') {
            txt = '<b>' + L('Всплеск подписчиков') + '</b> ' + L('в нише') + ' ' + niche + (e.pct ? ': +' + e.pct + '%' + (e.days ? L(' за ') + e.days + L(' дн') : '') : '') +
                (e.verdict === 'ok' ? L(' — охват растёт вместе с базой') : (e.verdict === 'bad' ? L(' — охват не растёт, возможна накрутка') : L(' — стоит проверить охват')));
        } else if (e.type === 'offer') {
            txt = '<b>' + L('Новый оффер') + '</b> ' + L('в нише') + ' ' + niche + (e.price ? L(' — от ') + _num(e.price) + ' ₽' : '');
        } else if (e.type === 'hot') {
            ...
            txt = '<b>' + L('Оффер изменил цену') + '</b> ' + L('в нише') + ' ' + niche + ': ' + _num(e.old) + ' → ' + _num(e.new) + ' ₽';
        } else if (e.type === 'niche_move') {
            txt = '<b>' + L('CPM в нише') + ' ' + niche + '</b> ' + _tFmtDelta(e.delta) + L(' за неделю');
        }
    ...
    var _CURVE_SHORT = { step: L('ступенчатый рост просмотров'), night: L('ночной набор просмотров'), late: L('поздние докрутки просмотров') };
            ...
            ov.innerHTML = '<div class="fmx-apk-in">' +
                ...
                e.items.map(function (it) {
                    return '<div class="fmx-t2top" data-evgo="' + _esc(it.username) + '" style="cursor:pointer;">' +
                        ...
                        (it.niche ? _esc(it.niche) + ' · ' : '') + '<span style="color:#f06978;">' + (_CURVE_SHORT[it.flag] || L('подозрительная кривая просмотров')) + '</span></span></span>' +
    ...
    function todayLine() {
        ...
        if (!total) return '';
        var bits = [];
        if (t.listings) bits.push('<b>' + t.listings + '</b> ' + _plural(t.listings, L('новый оффер'), L('новых оффера'), L('новых офферов')));
        if (t.requests) bits.push('<b>' + t.requests + '</b> ' + _plural(t.requests, L('заявка'), L('заявки'), L('заявок')));
    ...
    function _paintTerminal() {
        ...
        if (_term.generated_at) {
            ...
            if (!isNaN(gm) && gm >= 0) ago = gm <= 0 ? L('обновлено только что') : L('обновлено ') + gm + L(' мин назад');
        }
        ...
        html += '<div class="fmx-t2hero">' +
            ...
            '<div style="flex:1;min-width:0;"><div class="fmx-t2hl">' + L('Индекс CPM рынка') + '</div>' +
            ...
            '<div class="fmx-t2rng">' + [7, 30, 90].map(function (r) {
                return '<span data-trange="' + r + '"' + (r === _termRange ? ' class="on"' : '') + '>' + r + L('д') + '</span>';
            }).join('') + '</div></div>' +
            '<div style="margin-top:8px;">' + _tArea(series, '#818cf8', 'fmxTgIdx') + '</div></div>';

        html += '<div class="fmx-t2trow">' +
            '<div class="fmx-t2tc"><div class="v">' + _num(t.base_total || 0) + '</div><div class="l">' + L('каналов') + '</div>' + (t.base_new_week ? '<div class="d fmx-tup">+' + t.base_new_week + ' ' + L('нед') + '</div>' : '') + '</div>' +
            '<div class="fmx-t2tc"><div class="v">' + _num(t.market_total || 0) + '</div><div class="l">' + L('офферов') + '</div>' + (t.offers_new_week ? '<div class="d fmx-tup">+' + t.offers_new_week + ' ' + L('нед') + '</div>' : '') + '</div>' +
        ...
        if (movers.length >= 2) {
            ...
            if (up.length || dn.length) {
                html += '<div class="fmx-psec"><i class="ti ti-arrows-up-down" style="color:#5DCAA5;"></i> ' + L('Движение за неделю') + '</div>';
                var _mvHtml = '<div class="fmx-t2mv">';
                _mvHtml += '<div class="fmx-t2mvc"><div class="h fmx-tup">' + L('▲ Растут') + '</div>' + (up.length ? up.map(function (n) {
                    return '<div class="r" data-tniche="' + _esc(n.niche) + '"><span class="nm">' + _esc(n.niche) + '</span>' + _tFmtDelta(n.delta7) + '</div>';
                }).join('') : '<div class="r"><span class="nm fmx-tfl">' + L('пока тихо') + '</span></div>') + '</div>';
                _mvHtml += '<div class="fmx-t2mvc"><div class="h fmx-tdn">' + L('▼ Остывают') + '</div>' + (dn.length ? dn.map(function (n) {
                    return '<div class="r" data-tniche="' + _esc(n.niche) + '"><span class="nm">' + _esc(n.niche) + '</span>' + _tFmtDelta(n.delta7) + '</div>';
                }).join('') : '<div class="r"><span class="nm fmx-tfl">' + L('пока тихо') + '</span></div>') + '</div></div>';
                html += _tFoldOpen(_mvHtml, 'mv', 148);
            }
        }

        html += '<div class="fmx-psec"><i class="ti ti-list-details" style="color:#818cf8;"></i> ' + L('Ниши') +
        ...
        var _listHtml = '<div class="fmx-t2list">' + list.map(function (n) {
            ...
            var kind = n.source === 'market' ? _plural(n.count, L('оффер'), L('оффера'), L('офферов')) : (_plural(n.count, L('канал'), L('канала'), L('каналов')));
    ...
    function openTermNiche(name) {
        ...
        apiGet('/api/v1/marketplace/terminal/niche?name=' + encodeURIComponent(name)).then(function (r) {
            ...
            if (r.hours && r.hours.length) {
                ...
                var DW = [L('Пн'), L('Вт'), L('Ср'), L('Чт'), L('Пт'), L('Сб'), L('Вс')];
                html += '<div class="fmx-psec"><i class="ti ti-clock" style="color:#818cf8;"></i> ' + L('Когда читает аудитория ниши') + '</div>';
                ...
                html += '</div><div class="fmx-t2hint">' + L('По просмотрам постов офферов ниши · часы 0–24') + '</div>';
            }
            if (r.top_channels && r.top_channels.length) {
                html += '<div class="fmx-psec"><i class="ti ti-trophy" style="color:#f5bf4f;"></i> ' + L('Топ каналов ниши') + '</div>';
            ...
            html += '<button class="fmx-tnbtn" id="fmx-tnRadar" style="margin-top:14px;"><span class="ic" style="background:rgba(129,140,248,0.12);color:#818cf8;"><i class="ti ti-radar-2"></i></span>' + L('Каналы ниши в Радаре') + '</button>' +
                '<button class="fmx-tnbtn" id="fmx-tnBell" style="margin-top:8px;"><span class="ic" style="background:rgba(56,189,248,0.12);color:#38bdf8;"><i class="ti ti-bell"></i></span>' + L('Следить за нишей') + '</button>';
            b.innerHTML = html;
            ...
            var b = el('fmx-tnBody');
            if (b) b.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь.'));
        });
    }
    ...
    function renderMod() {
        ...
        host.innerHTML =
            ...
            '<div id="fmx-mverd"></div>' +
            '<div id="fmx-mtasks">' + loadHtml() + '</div>' +
            '<div id="fmx-msecs"></div>' +
            '<div class="fmx-modfoot">' + L('Обновляется автоматически') + '</div>';
        _modPaintLamps();
        _modPaintSections();
        _modLoad();
    }
    ...
    function _modLoad(quiet) {
        ...
        apiGet('/api/v1/admin/overview').then(function (r) {
            if (stale()) return;
            _mod.err.ov = !r || r.ok === false;
            if (!_mod.err.ov) _mod.ov = r;
    ...
    function _modTasks() {
        var q = _mod.q; if (!q) return [];
        var out = [];
        (q.listings || []).forEach(function (l) { out.push({ t: 'l', st: l.state || ((l.complaints || 0) > 0 ? 'complaint' : 'review'), d: l }); });
        (q.requests || []).forEach(function (x) { out.push({ t: 'r', st: 'request', d: x }); });
        var rank = { complaint: 0, stalled: 1, adult: 2, review: 3, request: 4 };
        out.sort(function (a, b) { return (rank[a.st] == null ? 9 : rank[a.st]) - (rank[b.st] == null ? 9 : rank[b.st]); });
        return out.filter(function (x) { return !_mod.done[x.t + x.d.id]; });
    }

    function _modLampCls(v) { return v === 0 ? 'ok' : (v <= 4 ? 'warn' : 'bad'); }

    function _modPaintLamps() {
        var box = el('fmx-mlamps'); if (!box) return;
        var h = '';
        if (_mod.err.q) h += '<div class="fmx-lamp"><span class="dot"></span><div class="k">' + L('Очередь') + '</div><div class="n">' + L('нет связи') + '</div></div>';
        else if (!_mod.q) h += '<div class="fmx-lamp"><span class="dot"></span><div class="k">' + L('Очередь') + '</div><div class="n">…</div></div>';
        else {
            var n = _modTasks().length;
            h += '<button class="fmx-lamp ' + _modLampCls(n) + '" data-lamp="tasks"><span class="dot"></span><div class="k">' + L('Очередь') + '</div>' +
                '<div class="n">' + (n === 0 ? L('пусто') : n + ' ' + _plural(n, L('задача'), L('задачи'), L('задач'))) + '</div></button>';
        }

        if (_mod.err.ov) h += '<div class="fmx-lamp"><span class="dot"></span><div class="k">' + L('Расход ИИ') + '</div><div class="n">' + L('нет связи') + '</div></div>';
        else if (!_mod.ov) h += '<div class="fmx-lamp"><span class="dot"></span><div class="k">' + L('Расход ИИ') + '</div><div class="n">…</div></div>';
        else {
            ...
            h += '<button class="fmx-lamp ' + cls + '" data-lamp="money"><span class="dot"></span>' +
                '<div class="k">' + L('Расход ИИ') + '</div>' +
                '<div class="n">$' + (sp >= 100 ? Math.round(sp) : sp.toFixed(2)) + '</div></button>';
        }

        if (_isOwner()) {
            if (_mod.err.ctrl) h += '<div class="fmx-lamp"><span class="dot"></span><div class="k">' + L('Проверка') + '</div><div class="n">' + L('нет связи') + '</div></div>';
            else if (!_mod.ctrl) h += '<div class="fmx-lamp"><span class="dot"></span><div class="k">' + L('Проверка') + '</div><div class="n">…</div></div>';
            else {
                var on = !!_mod.ctrl.moderation_enabled;
                h += '<button class="fmx-lamp ' + (on ? 'ok' : 'bad') + '" data-lamp="access"><span class="dot"></span><div class="k">' + L('Проверка') + '</div>' +
                    '<div class="n">' + (on ? L('включена') : L('выключена')) + '</div></button>';
            }
        }
        box.innerHTML = h;
        qsa(box, '[data-lamp]').forEach(function (b) {
            b.addEventListener('click', function () {
                _haptic('light');
                var k = b.getAttribute('data-lamp');
                if (k === 'tasks') { var t = el('fmx-mtasks'); if (t) t.scrollIntoView({ behavior: 'smooth', block: 'start' }); return; }
                _modOpenSec(k, true);
            });
        });
    }

    function _modPaintVerdict() {
        var box = el('fmx-mverd'); if (!box) return;
        if (_mod.err.q) {
            box.innerHTML = '<div class="fmx-verd mute"><div class="big">' + L('Нет связи с очередью') + '</div>' +
                '<div class="cap">' + L('Пока связь не восстановится, о задачах судить нельзя.') + '</div></div>';
            return;
        }
        if (!_mod.q) { box.innerHTML = ''; return; }
        var list = _modTasks();
        if (!list.length) {
            box.innerHTML = '<div class="fmx-verd calm"><div class="big">' + L('Всё разобрано') + '</div>' +
                '<div class="cap">' + L('Офферов на проверке и открытых жалоб нет.') + '</div></div>';
            return;
        }
        var c = { complaint: 0, stalled: 0, adult: 0, review: 0, request: 0 };
        list.forEach(function (x) { if (c[x.st] != null) c[x.st]++; });
        var chips = '';
        if (c.complaint) chips += '<span class="fmx-vchip bad">' + c.complaint + ' ' + _plural(c.complaint, L('жалоба'), L('жалобы'), L('жалоб')) + '</span>';
        if (c.stalled) chips += '<span class="fmx-vchip warn">' + c.stalled + ' ' + _plural(c.stalled, L('зависла'), L('зависли'), L('зависло')) + '</span>';
        if (c.adult) chips += '<span class="fmx-vchip">' + c.adult + ' ' + L('на раздел 18+') + '</span>';
        if (c.review) chips += '<span class="fmx-vchip">' + c.review + ' ' + L('на проверке') + '</span>';
        if (c.request) chips += '<span class="fmx-vchip">' + c.request + ' ' + _plural(c.request, L('заявка'), L('заявки'), L('заявок')) + '</span>';
        box.innerHTML = '<div class="fmx-verd"><div class="big">' + L('Требует решения:') + ' ' + list.length + '</div>' +
            '<div class="cap">' + L('Самое срочное — сверху') + '</div>' +
            '<div class="split">' + chips + '</div></div>';
    }

    var _MOD_KIND = {
        complaint: ['bad', L('Жалоба')], stalled: ['warn', L('Зависла')],
        adult: ['adult', L('Ждёт раздела 18+')], review: ['', L('На проверке')], request: ['', L('Заявка')],
    };

    function _modPaintTasks(quiet) {
        var box = el('fmx-mtasks'); if (!box) return;
        if (_mod.err.q) { _mod.sigTasks = ''; box.innerHTML = emptyHtml('ti-cloud-off', L('Очередь не загрузилась'), L('Проверь связь — панель повторит попытку сама.')); return; }
        if (!_mod.q) { if (!quiet) box.innerHTML = loadHtml(); return; }
        var list = _modTasks();
        var sig = list.map(function (x) { return x.t + x.d.id + ':' + x.st + ':' + (x.d.complaints || 0) + ':' + (x.d.is_adult ? 1 : 0); }).join('|');
        if (quiet && sig === _mod.sigTasks) return;
        _mod.sigTasks = sig;
        var over0 = (_mod.q.listings_overflow || 0) + (_mod.q.requests_overflow || 0);
        if (!list.length) {
            box.innerHTML = over0 ? '<div class="fmx-mmeta" style="text-align:center;margin:2px 0 10px;">' + L('…и ещё') + ' ' + over0 + ' ' + L('с жалобами — подтянутся при обновлении') + '</div>' : '';
            return;
        }
        var h = '';
        list.forEach(function (x) {
            var k = _MOD_KIND[x.st] || ['', L('На проверке')];
            if (x.t === 'r') {
                var q = x.d;
                h += '<div class="fmx-task s-complaint" data-task="r' + q.id + '">' +
                    '<div class="fmx-tkrow"><span class="fmx-tkind bad">' + L('Заявка · жалоб:') + ' ' + (q.complaints || 0) + '</span></div>' +
                    '<div class="fmx-mtitle">' + L('Заявка R') + q.id + '</div>' +
                    '<div class="fmx-msub">«' + _esc(q.text) + '»</div>' +
                    '<div class="fmx-mmeta">' + _esc(q.note) + '</div>' +
                    '<div class="fmx-mrow"><button class="fmx-mbtn ok" data-rest="' + q.id + '">Вернуть</button>' +
                    '<button class="fmx-mbtn no" data-rem="' + q.id + '">Снять</button></div></div>';
                return;
            }
            var l = x.d, ai = '';
            if (l.ai_category || l.ai_confidence != null) {
                var bits = [];
                if (l.ai_category) bits.push('<b>' + _esc(_CATRU[l.ai_category] || l.ai_category) + ' ' + L('список') + '</b>');
                if (l.ai_confidence != null) bits.push(L('уверенность ') + l.ai_confidence + '%');
                ai = L('Автопроверка: ') + bits.join(' · ');
            }
            if (l.ai_reason) ai += (ai ? '<br>' : '') + _esc(l.ai_reason);
            if (!ai && x.st === 'stalled') ai = L('Автопроверка не ответила — решение за тобой');
            h += '<div class="fmx-task s-' + x.st + '" data-task="l' + l.id + '">' +
                '<div class="fmx-tkrow"><span class="fmx-tkind ' + k[0] + '">' + k[1] + (l.complaints ? ' · ' + l.complaints : '') + '</span>' +
                (l.is_adult ? '<span class="fmx-tkind adult">18+</span>' : '') + '</div>' +
                '<div class="fmx-mtitle">#' + l.id + ' @' + _esc(l.username) + '</div>' +
                (l.title ? '<div class="fmx-msub">' + _esc(l.title) + '</div>' : '') +
                '<div class="fmx-mmeta">' + _esc(l.note) + '</div>' +
                (ai ? '<div class="fmx-tai">' + ai + '</div>' : '') +
                ...
                (l.link ? '<button class="fmx-mopen" data-open="' + _esc(l.link) + '"><i class="ti ti-external-link"></i> ' + L('Открыть канал') + '</button>' : '') +
                '</div>';
        });
        var ov = (_mod.q.listings_overflow || 0) + (_mod.q.requests_overflow || 0);
        if (ov) h += '<div class="fmx-mmeta" style="text-align:center;margin:6px 0 10px;">' + L('…и ещё') + ' ' + ov + ' ' + L('с жалобами — появятся после разбора текущих') + '</div>';
        box.innerHTML = h;
    ...
    function _modTyping() {
        try {
            ...
            var secs = el('fmx-msecs');
            return !!(secs && secs.contains(a));
        } catch (e) { return false; }
    }

    function _modSec(key, ic, icCls, name, sub, val, valSub, body) {
        var open = !!_mod.open[key];
        return '<div class="fmx-sec' + (open ? ' open' : '') + '" data-sec="' + key + '">' +
            '<button class="fmx-sechd" data-sectg="' + key + '" aria-expanded="' + open + '">' +
            '<span class="fmx-secic ' + icCls + '"><i class="ti ' + ic + '"></i></span>' +
            '<span style="min-width:0;flex:1;"><span class="fmx-secnm" style="display:block;">' + name + '</span>' +
            '<span class="fmx-secsub" style="display:block;">' + sub + '</span></span>' +
            (val ? '<span class="fmx-secval">' + val + (valSub ? '<span>' + valSub + '</span>' : '') + '</span>' : '') +
            '<i class="ti ti-chevron-down fmx-secchev"></i></button>' +
            (open ? '<div class="fmx-secbody">' + body + '</div>' : '') + '</div>';
    }

    function _modMoneyBody() {
        ...
        var s = _mod.ov.spend || {}, rf = _mod.ov.referrals || {};
    ...
    function _modPeopleBody() {
        if (_mod.err.ov) return '<div class="fmx-mmeta" style="padding-top:11px;">' + L('Не загрузилось — панель повторит попытку.') + '</div>';
        if (!_mod.ov) return loadHtml();
        var u = _mod.ov.users || {}, h = '';
        h += '<div class="fmx-mstatrow" style="border-top:0;margin-top:11px;padding-top:0;"><span>' + L('Всего') + '</span><b>' + _num(u.total) + '</b></div>' +
            '<div class="fmx-mstatrow"><span>' + L('С покупками') + '</span><b>' + _num(u.paid) + '</b></div>';
        if ((_mod.ov.top_spenders || []).length) {
            h += '<div class="fmx-meyebrow" style="margin-top:13px;">' + L('Кто тратит больше всех') + '<em>' + L('за месяц') + '</em></div><div class="fmx-plist">';
            _mod.ov.top_spenders.forEach(function (t) {
                h += _pRow({ id: t.user_id, name: 'ID ' + t.user_id, meta: t.calls + ' ' + _plural(t.calls, L('обращение'), L('обращения'), L('обращений')) + L(' к ИИ'), val: '$' + t.spent_usd.toFixed(2) });
            });
            h += '</div>';
        }
        h += '<div class="fmx-meyebrow" style="margin-top:13px;">' + L('Найти по Telegram ID') + '</div>' +
            '<div style="display:flex;gap:8px;"><input class="fmx-inp" id="fmx-muid" inputmode="numeric" placeholder="' + L('например 100000000') + '" style="flex:1;">' +
            ...
            '<div class="fmx-mdsub" style="margin-top:7px;">' + L('Нажатие на любого человека в списках открывает его карточку.') + '</div>';
        h += '<div id="fmx-modact" style="margin-top:13px;">' +
            (_mod.actState === 'loading' ? loadHtml() : '') +
            (_mod.actState === 'error'
                ? '<div class="fmx-mmeta" style="display:flex;align-items:center;justify-content:space-between;gap:10px;">' +
                  '<span>' + L('Списки активности не загрузились') + '</span>' +
                  '<button class="fmx-btn" id="fmx-actretry" style="flex:0 0 auto;padding:8px 12px;min-height:40px;">' + L('Повторить') + '</button></div>'
                : '') + '</div>';
        return h;
    }

    function _modBoostCard() {
        return '<div class="fmx-ctrlcard">' +
            '<div class="fmx-ctrlt">' + L('Ручное продвижение оффера') + '</div>' +
            '<div class="fmx-ctrls" style="margin-bottom:10px;">' + L('Включает офферу бейдж «Продвигается» и золотое оформление на 30 дней. Работает только со своим оффером — ID виден в задачах очереди.') + '</div>' +
            '<div style="display:flex;gap:8px;"><input class="fmx-inp" id="fmx-mboostid" inputmode="numeric" placeholder="' + L('ID оффера') + '" style="flex:1;">' +
    ...
    function _modAccessBody() {
        ...
        return '<div class="fmx-ctrl" style="margin-top:12px;">' +
            ...
            '<div class="fmx-ctrls">' + (on
                ? L('Каждый новый оффер проходит проверку перед публикацией.')
                : L('ВЫКЛЮЧЕНА: офферы публикуются сразу, без проверки.')) + '</div></div>' +
    ...
    function _modPaintSections() {
        var box = el('fmx-msecs'); if (!box || _modTyping()) return;
        var sig = JSON.stringify([_mod.ov, _mod.ctrl, _mod.open, _mod.actState, _mod.err.ov, _mod.err.ctrl, _mod.act]);
        if (sig === _mod.sigSecs && box.firstChild) return;
        _mod.sigSecs = sig;
        var keep = {};
        qsa(box, 'input').forEach(function (i) { if (i.id && i.value) keep[i.id] = i.value; });
        var u = (_mod.ov && _mod.ov.users) || {};
        var money = _mod.ov ? (_num(_mod.ov.revenue_month_rub) + ' ₽') : '';
        ...
        qsa(box, 'input').forEach(function (i) { if (i.id && keep[i.id]) i.value = keep[i.id]; });
        _modWireUids(box);
        _modBindPeople(box);
        if (_mod.open.access) _modBindAccess(box);
        if (_mod.open.people && _mod.actState === 'ready') _modPaintActivity();
    }

    function _modOpenSec(key, forceOpen) {
        _mod.open[key] = forceOpen ? true : !_mod.open[key];
        _modPaintSections();
        if (key === 'people' && _mod.open.people && _mod.actState === 'idle') _modLoadActivity();
        if (forceOpen) {
            var node = document.querySelector('[data-sec="' + key + '"]');
            if (node) node.scrollIntoView({ behavior: 'smooth', block: 'start' });
        }
    }

    function _modBindPeople(box) {
        var rt = el('fmx-actretry');
        if (rt) rt.addEventListener('click', function () { _haptic('light'); _modLoadActivity(); });
        var find = function () {
            var inp = el('fmx-muid'); if (!inp) return;
            var v = (inp.value || '').trim();
            if (!/^\d+$/.test(v)) { uiAlert(L('Введи числовой Telegram ID')); return; }
            _modUserSheet(v);
        };
        var fb = el('fmx-mufind');
        if (fb) fb.addEventListener('click', find);
        var inp = el('fmx-muid');
        if (inp) inp.addEventListener('keydown', function (e) { if (e.key === 'Enter') find(); });
    }
    ...
    function _ctrlTestersHtml(r) {
        ...
        var rows = (r.testers || []).map(function (t) {
            ...
            var tag = t.source === 'env' ? '<span class="fmx-mdtag">' + L('из настроек сервера') + '</span>' : '';
            if (!act) tag += '<span class="fmx-mdtag off">' + L('на паузе') + '</span>';
            var sw = '<button class="fmx-sw sm' + (act ? ' on' : '') + '" data-tstg="' + t.user_id + '" data-on="' + act + '" role="switch" aria-checked="' + act + '" aria-label="' + L('Тестовый доступ') + '"><span></span></button>';
            var del = t.source === 'db'
                ? '<button class="fmx-mdel" data-tsrm="' + t.user_id + '" aria-label="' + L('Удалить из списка') + '"><i class="ti ti-x"></i></button>' : '';
        ...
        return '<div class="fmx-ctrlcard">' +
            '<div class="fmx-ctrltop"><div><div class="fmx-ctrlt">' + L('Тестовый доступ') + '</div>' +
            '<div class="fmx-ctrls">' + (on
                ? L('Для перечисленных ограничения не применяются — функции работают без ограничений.')
                : L('ВЫКЛЮЧЕН: все, включая тестеров, работают в обычном режиме.')) + '</div></div>' +
            '<button class="fmx-sw' + (on ? ' on' : '') + '" id="fmx-tssw" role="switch" aria-checked="' + on + '"><span></span></button>' +
            '</div>' +
            '<div class="fmx-mdlist" style="margin-top:12px;">' + (rows || '<div class="fmx-mdsub">' + L('Пока никого') + '</div>') + '</div>' +
            '<div class="fmx-mdadd"><input class="fmx-mdinp" id="fmx-tsq" placeholder="' + L('@username или ID') + '" autocomplete="off" spellcheck="false">' +
            '<button class="fmx-mdbtn" id="fmx-tsadd">' + L('Выдать доступ') + '</button></div>' +
            '<div class="fmx-mdsub" style="margin-top:8px;">' + L('Тумблер ставит доступ на паузу, не удаляя из списка. Крестик удаляет совсем. Расход на ИИ у тестеров не ограничен — держи список коротким.') + '</div>' +
            '</div>';
    }
    ...
    function _bindTesterControls(box) {
        ...
        if (sw) sw.addEventListener('click', function () {
            ...
            uiConfirm(next ? L('Включить тестовый доступ?') : L('Выключить тестовый доступ? Тестеры вернутся в обычный режим.'), function () {
                apiPost('/api/v1/admin/controls/tester-mode', { enabled: next }).then(function (res) {
                    if (!res || res.ok === false) { uiAlert(L('Не удалось изменить')); return; }
                    _haptic('success'); toast(next ? L('Тестовый доступ включён') : L('Тестовый доступ выключен'));
                    _modReloadCtrl();
        ...
        if (addBtn) addBtn.addEventListener('click', function () {
            ...
            apiPost('/api/v1/admin/testers', { query: q }).then(function (res) {
                ...
                _haptic('success'); toast(res.message || L('Доступ выдан'));
                inp.value = '';
                _modReloadCtrl();
        ...
        qsa(box, '[data-tstg]').forEach(function (b) {
            b.addEventListener('click', function () {
                ...
                apiPost('/api/v1/admin/testers/' + uid + '/toggle', { enabled: next }).then(function (res) {
                    if (!res || res.ok === false) { b.disabled = false; uiAlert(L('Не удалось изменить')); return; }
                    _haptic('light'); toast(res.message || (next ? L('Доступ включён') : L('Доступ на паузе')));
                    _modReloadCtrl();
                }).catch(function () { b.disabled = false; uiAlert(L('Не удалось изменить')); });
            });
        });
        qsa(box, '[data-tsrm]').forEach(function (b) {
            b.addEventListener('click', function () {
                var uid = b.getAttribute('data-tsrm');
                uiConfirm(L('Удалить из списка тестеров? Чтобы временно отключить, используй тумблер.'), function () {
                    apiRequest('/api/v1/admin/testers/' + uid, { method: 'DELETE' }).then(function (res) {
                        ...
                        _haptic('success'); toast(res.message || L('Доступ снят'));
                        _modReloadCtrl();
    ...
    function _modBindAccess(box) {
        var sw = el('fmx-modsw');
        if (sw) sw.addEventListener('click', function () {
            var next = !sw.classList.contains('on');
            var act = next ? L('Включить проверку офферов?') : L('Выключить проверку? Офферы будут публиковаться без модерации.');
        ...
        if (boost) boost.addEventListener('click', function () {
            var f = el('fmx-mboostid'); if (!f) return;
            var v = (f.value || '').trim();
            if (!/^\d+$/.test(v)) { uiAlert(L('Введи числовой ID оффера')); return; }
            boost.disabled = true;
            apiPost('/api/v1/marketplace/mod/boost', { listing_id: +v }).then(function (r) {
                boost.disabled = false;
                if (r && r.ok) { _haptic('success'); toast(L('Продвижение включено на 30 дней')); f.value = ''; }
                else { uiAlert((r && r.error) || L('Не удалось')); }
            }).catch(function () { boost.disabled = false; uiAlert(L('Не удалось. Повтори попытку.')); });
        });
        _bindTesterControls(box);
    }

    function _modReloadCtrl() {
        apiGet('/api/v1/admin/controls').then(function (r) {
            if (_mainTab !== 'mod') return;
            _mod.err.ctrl = !r || r.ok === false;
            if (!_mod.err.ctrl) _mod.ctrl = r;
            _modPaintLamps(); _modPaintSections();
        }).catch(function () {});
    ...
    function _modAfter(r, key, label, keep) {
        if (r && r.ok === false) { _haptic('error'); uiAlert(r.error || L('Не удалось')); return; }
        _haptic('success'); toast((r && r.message) || L('Готово'));
        if (keep) { _modLoad(true); return; }
        _modResolve(key, label);
    }
    function _modResolve(key, label) {
        ...
        if (card) {
            ...
            var row = card.querySelector('.fmx-mrow'); if (row) row.remove();
            var op = card.querySelector('.fmx-mopen'); if (op) op.remove();
            if (!card.querySelector('.fmx-tdone')) {
                card.insertAdjacentHTML('beforeend', '<div class="fmx-tdone"><i class="ti ti-check"></i>' + _esc(label || L('Решено')) + '</div>');
            }
        }
        _modPaintLamps(); _modPaintVerdict();
    }
    var _TERMS_B = [
        ['ti-brand-telegram', '#5DCAA5', L('Сделка — напрямую с владельцем'), [
            L('Кнопка «Написать» открывает личный диалог с владельцем канала: в сообщении уже подставлены оффер, формат и выбранная дата.'),
            L('Договорённость и оплата — напрямую между вами, без комиссии. Площадка деньги не держит и гарантом расчётов не выступает.')]],
        ['ti-heart-handshake', '#818cf8', L('Фиксация сделки — обеими сторонами'), [
            L('После договорённости отметьте сделку в развороте оффера. Она засчитывается, когда владелец подтвердит её со своей стороны. Счётчик сделок в оффере растёт только по подтверждённым.')]],
        ['ti-chart-bar', '#818cf8', L('Замер результата — автоматический'), [
            L('Владелец присылает ссылку на вышедший рекламный пост — не старше 72 часов. Охват поста замеряется автоматически через 12, 24 и 48 часов, отчёты придут в бот.'),
            L('Из замеров складывается «Рекламный охват» оффера и точность заявленных цифр.')]],
        ['ti-star', '#818cf8', L('Отзыв и рейтинг'), [
            L('После подтверждённой сделки можно оставить отзыв и оценку — они видны всем в оффере.')]],
        ['ti-file-certificate', '#818cf8', L('Маркировка рекламы'), [
            L('В каждом оффере указано, кто оформляет erid: рекламодатель, канал или по договорённости. Уточните это до выхода поста.')]],
        ['ti-shield-check', '#f5bf4f', L('Что гарантируется, а что нет'), [
            L('Метрики офферов обновляются автоматически, признаки накрутки помечаются, жалобу можно отправить одним нажатием из оффера.'),
            L('Результат размещения не гарантируется: подписчики и продажи зависят от креатива и совпадения аудитории. Оценивайте канал по метрикам до сделки.')]],
    ];
    var _TERMS_S = [
        ['ti-door-enter', '#5DCAA5', L('Вход — публичный канал, без порогов'), [
            L('Нужен канал с публичным @именем, подключённый к боту. Минимума подписчиков нет — решают метрики, а не размер.')]],
        ['ti-coin', '#5DCAA5', L('Цены и форматы — только ваши'), [
            L('Форматы вы включаете сами, обязательных нет. Цену каждого формата назначаете вы — Площадка её не диктует и не корректирует.'),
            L('Комиссии нет: оплата приходит напрямую от рекламодателя.')]],
        ['ti-shield-search', '#818cf8', L('Модерация — до публикации'), [
            L('Оффер выходит на витрину после проверки. Правка содержимого живого оффера — текст, обложка, стикер, фон, витрина — отправляет его на повторную проверку, на это время оффер снимается с витрины. Лимит — 10 отправок в день.'),
            L('Цены, форматы и календарь правятся без повторной проверки.')]],
        ['ti-heart-handshake', '#818cf8', L('Сделки и замеры'), [
            L('Сделку вы подтверждаете в разделе «Мои офферы» — заявки покупателей появляются там в блоке сделок. После выхода поста вставьте туда же ссылку на него, не позднее 72 часов. Больше ничего присылать не нужно: охват замерится автоматически через 12, 24 и 48 часов, появится в оффере как «Рекламный охват», а отчёт уйдёт покупателю.')]],
        ['ti-activity', '#818cf8', L('Метрики — автоматические и честные'), [
            L('Цифры оффера поддерживаются без вашего участия. Признаки накрутки помечаются в оффере — честные метрики поднимают доверие и цену размещения.')]],
        ['ti-alert-triangle', '#f5bf4f', L('Ограничения тематик'), [
            L('Контент 18+ не показывается в общей ленте. Запрещённые законом тематики не публикуются — причина отказа приходит с результатом проверки, оффер можно исправить и отправить снова.')]],
    ];
    ...
    function openTermsPassport(tab) {
        ...
        bg.innerHTML = '<div class="fmx-cfm-box fmx-tpbox">' +
            '<div class="fmx-cfm-t" style="display:flex;align-items:center;gap:8px;"><i class="ti ti-clipboard-text" style="color:#818cf8;"></i><span>' + L('Как работает Площадка') + '</span><span class="fmx-tpx"><i class="ti ti-x"></i></span></div>' +
            '<div class="fmx-tptabs"><div class="fmx-tptab" data-tt="b">' + L('Покупателю рекламы') + '</div><div class="fmx-tptab" data-tt="s">' + L('Владельцу канала') + '</div></div>' +
            '<div class="fmx-tpbody" id="fmx-tpbody"></div>' +
            '<div class="fmx-tpfoot">' + L('Условия описывают действующие механики Площадки и обновляются вместе с ними.') + '</div></div>';
        document.body.appendChild(bg);
        function show(t) {
    ...
    function modPrompt(opts, cb) {
        ...
        bg.innerHTML = '<div class="fmx-cfm-box"><div class="fmx-cfm-t">' + _esc(opts.title) + '</div>' +
            ...
            '<div class="fmx-cfm-r" style="margin-top:12px;"><button class="fmx-btn" data-no>' + L('Отмена') + '</button>' +
            '<button class="fmx-btn" data-yes style="background:#818cf8;color:#fff;border-color:transparent;">' + _esc(opts.btn || L('ОК')) + '</button></div></div>';
        document.body.appendChild(bg);
        function done() { bg.remove(); }
        bg.addEventListener('click', function (e) { if (e.target === bg) done(); });
        bg.querySelector('[data-no]').addEventListener('click', done);
    ...
    function modApprove(id) {
        uiConfirm(L('Одобрить оффер #') + id + L(' и опубликовать?'), function () {
            apiPost('/api/v1/admin/listing/' + id + '/approve').then(function (r) { _modAfter(r, 'l' + id, L('Одобрено')); }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
        });
    }
    function modAdultOff(id) {
        uiConfirm(L('Снять метку 18+ с оффера #') + id + L('? Если оффер уже одобрен, он сразу выйдет в общую ленту.'), function () {
            apiPost('/api/v1/admin/listing/' + id + '/adult', { adult: false }).then(function (r) { _modAfter(r, 'l' + id, L('Метка 18+ снята'), true); }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
        });
    }
    function modReject(id) {
        modPrompt({ title: L('Отклонить оффер #') + id, placeholder: L('Причина (необязательно) — автор увидит и сможет исправить'), btn: L('Отклонить'), optional: true }, function (reason) {
            apiPost('/api/v1/admin/listing/' + id + '/reject', { reason: reason }).then(function (r) { _modAfter(r, 'l' + id, L('Отклонено')); }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
        });
    }
    var _CATRU = { white: L('белый'), grey: L('серый'), black: L('чёрный') };
    ...
    function modRestore(id) {
        uiConfirm(L('Вернуть заявку R') + id + L(' и снять жалобы?'), function () {
            apiPost('/api/v1/admin/request/' + id + '/restore').then(function (r) { _modAfter(r, 'r' + id, L('Возвращено')); }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
        });
    }
    function modRemove(id) {
        modPrompt({ title: L('Снять заявку R') + id, placeholder: L('Причина (необязательно)'), btn: L('Снять'), optional: true }, function (reason) {
            apiPost('/api/v1/admin/request/' + id + '/remove', { reason: reason }).then(function (r) { _modAfter(r, 'r' + id, L('Снято')); }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
        });
    }
    ...
    function _collapsible(box, key, total) {
        qsa(box, '[data-more="' + key + '"]').forEach(function (b) {
            b.addEventListener('click', function () {
                ...
                if (key === 'users') _mod.usersOpen = host.classList.contains('open');
                var hidden = qsa(host, '.fmx-prow.hid');
                hidden.forEach(function (n) { n.style.display = host.classList.contains('open') ? '' : 'none'; });
                b.textContent = host.classList.contains('open') ? L('Свернуть') : (L('Показать всех · ') + total);
            });
        });
    }

    function _modOpenUser(id) { _haptic('light'); _modUserSheet(String(id)); }
    ...
    var _EVN = { app_open: L('Вход в приложение'), tariffs: L('Витрина Forge'), fn_create_post: L('Создать пост'), fn_rewrite_post: L('Рерайт поста'), fn_content_plan: L('Контент-план'), fn_ai_audit: L('AI-аудит'), fn_ai_strategy: L('ИИ-стратегия'), fn_competitor_analysis: L('Анализ конкурентов'), fn_my_channels: L('Мои каналы'), fn_add_channel: L('Подключение канала'), fn_radar: L('Радар'), fn_marketplace: L('Рынок рекламы'), fn_referral: L('Друзья и промокод'), fn_profile: L('Кабинет'), fn_find_advertisers: L('Поиск рекламодателей'), fn_post_price: L('Цена поста'), fn_negotiation_templates: L('Шаблоны переговоров'), fn_voice_settings: L('Голос канала'), mx_catalog: L('Радар (раздел)'), mx_market: L('Площадка (раздел)'), mx_mod: L('Админ-панель'), mxs_buy: L('Площадка · Купить'), mxs_sell: L('Площадка · Продать'), mxs_mine: L('Мои офферы'), mxs_create: L('Конструктор оффера'), mxs_deals: L('Сделки') };
    var _OPN = { generate: L('Генерация поста'), modify: L('Правка поста'), intent: L('Уточняющие вопросы'), suggest: L('Подсказки правок'), ideas: L('Идеи тем'), rewrite: L('Рерайт (ИИ)'), voice: L('Голос канала (ИИ)'), audit: L('AI-аудит'), strategy: L('ИИ-стратегия'), strategy_chat: L('Чат стратегии'), competitors: L('Анализ конкурентов'), ad_exchange: L('Биржа (ИИ)'), content_plan: L('Контент-план: идея'), content_plan_day: L('Контент-план: день'), moderation: L('Модерация (платформа)'), niche: L('Ниша (платформа)') };
    function _modLoadActivity(quiet) {
        var gen = _mod.gen;
        if (!quiet) { _mod.actState = 'loading'; _modPaintSections(); }
        apiGet('/api/v1/admin/activity').then(function (a) {
            if (_mainTab !== 'mod' || gen !== _mod.gen) return;
            if (!a || a.ok === false) { _mod.actState = 'error'; _modPaintSections(); return; }
            _mod.act = a;
            _mod.actState = 'ready';
            _modPaintSections();
        }).catch(function () {
            if (_mainTab !== 'mod' || gen !== _mod.gen) return;
            _mod.actState = 'error'; _modPaintSections();
        });
    }

    function _modPaintActivity() {
        var box = el('fmx-modact');
        var a = _mod.act;
        if (box && a) {
            var h = '';
            if (a.visitors_7d && a.visitors_7d.length) {
                h += '<div class="fmx-mcard"><div class="fmx-meyebrow">' + L('Активные') + '<em>' + L('за 7 дней') + '</em></div><div class="fmx-plist">';
                a.visitors_7d.forEach(function (v) {
                    h += _userRow(v, _num(v.events) + L(' действ.'));
                });
                h += '</div></div>';
            }
            if (a.all_users && a.all_users.length) {
                var total = a.all_users.length;
                h += '<div class="fmx-mcard"><div class="fmx-meyebrow">' + L('Все пользователи') + '<em>' + _num(total) + '</em></div>' +
                ...
                h += '</div>';
                if (total > 6) h += '<button class="fmx-pmore" data-more="users">' + L('Показать всех ·') + ' ' + _num(total) + '</button>';
                h += '</div>';
            }
            ...
            if (evs.length) {
                ...
                h += '<div class="fmx-mcard"><div class="fmx-meyebrow">' + L('Что открывают') + '<em>' + L('за 7 дней') + '</em></div>';
            ...
            if (ops.length) {
                ...
                h += '<div class="fmx-mcard"><div class="fmx-meyebrow">' + L('Обращения к ИИ') + '<em>' + L('за 7 дней') + '</em></div>';
            ...
            if (a.purchases && a.purchases.length) {
                h += '<div class="fmx-mcard"><div class="fmx-meyebrow">' + L('Покупки') + '<em>' + L('оплачено') + '</em></div><div class="fmx-plist">';
                a.purchases.forEach(function (p) {
                    h += _pRow({ id: p.user_id, name: _esc(p.product || L('Покупка')), meta: 'ID ' + p.user_id,
            ...
            if (_mod.usersOpen) {
                var ul = box.querySelector('[data-list="users"]');
                if (ul) {
                    ul.classList.add('open');
                    qsa(ul, '.fmx-prow.hid').forEach(function (nd) { nd.style.display = ''; });
                    var mb = box.querySelector('[data-more="users"]');
                    if (mb) mb.textContent = L('Свернуть');
                }
            }
        }
    }

    function _modUserSheet(id) {
        var old = el('fmx-muBg'); if (old) old.remove();
        var bg = document.createElement('div');
        bg.id = 'fmx-muBg'; bg.className = 'fmx-cfm solid';
        bg.innerHTML = '<div class="fmx-cfm-box"><div class="fmx-cfm-t" style="display:flex;align-items:center;gap:8px;">' +
            '<i class="ti ti-user" style="color:#818cf8;"></i><span style="flex:1;">' + L('Карточка пользователя') + '</span>' +
            '<button class="fmx-ibtn" data-mux style="width:30px;height:30px;"><i class="ti ti-x"></i></button></div>' +
            '<div id="fmx-mubody" style="margin-top:11px;">' + loadHtml() + '</div></div>';
        document.body.appendChild(bg);
        function done() { bg.remove(); }
        bg.addEventListener('click', function (e) { if (e.target === bg) done(); });
        bg.querySelector('[data-mux]').addEventListener('click', done);
        apiGet('/api/v1/admin/user/' + id).then(function (r) {
            var body = el('fmx-mubody'); if (!body) return;
            if (!r || r.ok === false) { body.innerHTML = emptyHtml('ti-user-off', (r && r.error) || L('Пользователь не найден'), L('Проверь ID и повтори.')); return; }
            var u = r.user;
            body.innerHTML =
                ...
                '<div class="fmx-pmeta">' + (u.username && u.username !== '—' ? '@' + _esc(u.username) : L('без @username')) + '</div></div></div>' +
                '<div class="fmx-mstatrow"><span>ID</span><b>' + u.id + '</b></div>' +
                '<div class="fmx-mstatrow"><span>' + L('Промокод') + '</span><b>' + _esc(u.promo_code) + '</b></div>' +
                '<div class="fmx-mstatrow"><span>' + L('Уровень партнёрки') + '</span><b>' + _esc(u.referral_level) + '</b></div>' +
                '<div class="fmx-mstatrow"><span>' + L('Платных рефералов') + '</span><b>' + _num(u.paid_referrals) + '</b></div>' +
                '<div class="fmx-mstatrow"><span>' + L('Баланс Forge') + '</span><b>' + _num(u.forge_balance) + '</b></div>' +
                '<div class="fmx-mstatrow"><span>' + L('Расход за месяц') + '</span><b>$' + (u.spend_month_usd || 0).toFixed(4) + ' · ' + u.calls_month + ' ' + L('выз.') + '</b></div>' +
                '<div class="fmx-mstatrow"><span>' + L('Регистрация') + '</span><b>' + _esc(u.created_at) + '</b></div>' +
                (u.username && u.username !== '—'
                    ? '<button class="fmx-btn" data-muopen="' + _esc(u.username) + '" style="width:100%;margin-top:12px;"><i class="ti ti-brand-telegram"></i> ' + L('Написать @') + _esc(u.username) + '</button>'
                    : '<button class="fmx-btn" data-mucopy="' + u.id + '" style="width:100%;margin-top:12px;"><i class="ti ti-copy"></i> ' + L('Скопировать ID') + '</button>' +
                      '<div class="fmx-mdsub" style="margin-top:7px;text-align:center;">' + L('У пользователя нет @username — открыть профиль напрямую нельзя. Найди его по ID в поиске Telegram или через его оффер.') + '</div>');
            qsa(body, '[data-muopen]').forEach(function (b) {
                b.addEventListener('click', function () { _openChannel('https://t.me/' + b.getAttribute('data-muopen')); });
            });
            qsa(body, '[data-mucopy]').forEach(function (b) {
                b.addEventListener('click', function () {
                    var v = b.getAttribute('data-mucopy');
                    try {
                        if (navigator.clipboard) navigator.clipboard.writeText(v);
                        else { var ta = document.createElement('textarea'); ta.value = v; document.body.appendChild(ta); ta.select(); document.execCommand('copy'); ta.remove(); }
                        _haptic('success'); toast(L('ID скопирован'));
                    } catch (e) { uiAlert(L('Не удалось скопировать. ID: ') + v); }
                });
            });
        }).catch(function () {
            var body = el('fmx-mubody');
            if (body) body.innerHTML = emptyHtml('ti-cloud-off', L('Не загрузилось'), L('Проверь связь и повтори попытку.'));
        });
    }

    function _liveMod() {
        if (_mainTab !== 'mod' || !_opened) return false;
        if (document.querySelector('.fmx-cfm')) return false;
        if (_modTyping()) return false;
        _modLoad(true);
        if (_mod.open.people && _mod.actState === 'ready') _modLoadActivity(true);
        return true;
    }
    if (window.FMLive) window.FMLive.register('mod', 60000, _liveMod);
    function feedQuery() {
    ...
    function loadFeed(more) {
        ...
        apiGet(feedQuery()).then(function (r) {
            ...
            if (more) {
                ...
                _feedState = 'ready';
                toast(L('Не удалось загрузить продолжение. Повтори попытку.'));
                if (_mainTab === 'market' && _subTab === 'buy') paintBuyBody();
                return;
            }
            _feedState = 'error';
        ...
        _pubPollT = setInterval(function () {
            ...
            loadMyListings().then(function (list) {
                ...
                if (mine && mine.status === 'published') {
                    ...
                    toast(L('Оффер прошёл проверку и опубликован — уже в ленте'));
    ...
    function paintCatalogBody() {
        ...
        if (_catState === 'error') { box.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь и повтори попытку.')); return; }
        if (!_catalog || !_catalog.length) { box.innerHTML = emptyHtml('ti-radar-2', L('Радар скоро наполнится'), L('Здесь будет каталог каналов со всего Telegram — ищи по нише и договаривайся с владельцами напрямую.')); return; }
        var list = _catList();
        if (!list.length) {
            if (_sort === 'match' && !_catQ) {
                var myn = _myNichesStr();
                if (myn) box.innerHTML = emptyHtml('ti-target-arrow', L('В твоей нише пока пусто'), L('В Радаре пока нет каналов ниши «') + _esc(myn) + L('». Открой «Все каналы» или подбери близкую нишу через «Выбрать нишу».'));
                else box.innerHTML = emptyHtml('ti-target-arrow', L('Ниша не определена'), L('Выбери активный канал в главном меню — и Радар подберёт площадки твоей ниши. Пока открой «Все каналы».'));
                return;
            }
            box.innerHTML = emptyHtml('ti-search-off', L('Ничего не найдено'), L('Измени запрос или фильтр — подходящих каналов в каталоге пока нет.'));
            return;
        }
        ...
        function tailNote(loading) {
            ...
            if (loading || mounted < list.length || pendingSrv) {
                ...
                t.innerHTML = '<div style="text-align:center;color:#565b73;font-size:11.5px;padding:12px 8px 2px;">' + L('Показано') + ' ' + mounted + (known ? L(' из ') + known : '') + L(' — дальше подгружается при прокрутке') + (loading ? '…' : '') + '</div>';
                return;
            }
            t.innerHTML = list.length > FIRST ? '<div style="text-align:center;color:#565b73;font-size:11.5px;padding:12px 8px 2px;">' + list.length + ' ' + _plural(list.length, L('канал'), L('канала'), L('каналов')) + ' ' + L('— показаны все, что нашлись по фильтру') + '</div>' : '';
        }
        function mountNext() {
    ...
    function renderMarket() {
        ...
        _subTab = 'buy';
        host.innerHTML =
            searchHtml(L('Поиск по каналу или нише…')) +
            _sellCtaHtml() +
            '<div id="fmx-sub"></div>';
    ...
    function _sellCtaSub() {
        if (_myListings && _myListings.length) {
            var st = _myListings.length > 1
                ? _myListings.length + ' ' + _plural(_myListings.length, L('оффер'), L('оффера'), L('офферов'))
                : (_myListings[0].status_human || L('Оффер'));
            return st + L(' · нажми, чтобы управлять');
        }
        return L(L('Оформи оффер — его увидят покупатели'));
    }
    function _sellCtaHtml() {
        ...
        return '<div class="fmx-sellcta" id="fmx-sellcta">' +
            ...
            '<div class="fmx-sellcta-t"><div class="n" id="fmx-sellcta-n">' + (has ? L('Мой оффер') : L('Выставить свой канал')) + '</div>' +
    ...
    function _paintSellCta() {
        ...
        if (!n || !s || !cta) return;
        var has = _myListings && _myListings.length;
        n.textContent = has ? L('Мой оффер') : L('Выставить свой канал');
    ...
    function buySortRowHtml() {
        ...
        return '<div class="fmx-sortbar" id="fmx-buysort" style="display:flex;flex-wrap:nowrap;overflow-x:auto;-webkit-overflow-scrolling:touch;">' +
            ...
            '<button class="fmx-seg' + (nf ? ' on' : '') + '" id="fmx-bfilters" style="flex:0 0 auto;"><i class="ti ti-adjustments-horizontal"></i> ' + L('Фильтры') + (nf ? ' · ' + nf : '') + '</button></div>';
    }
    function _refreshFilterChip() {
        var bf = el('fmx-bfilters'); if (!bf) return;
        var nf = _buyFiltersCount();
        bf.classList.toggle('on', nf > 0);
        bf.innerHTML = '<i class="ti ti-adjustments-horizontal"></i> ' + L('Фильтры') + (nf ? ' · ' + nf : '');
    }
    var _qTimer = null;
        ...
        qsa(sub, '[data-bsort]').forEach(function (b) {
            b.addEventListener('click', function () {
                ...
                if (v !== 'smart' && _sort === 'match') {
                    _sort = 'all';
                    toast(L('Подбор «Под мою нишу» работает только в умной сортировке — снят'));
                }
    ...
    function openBuyFilters() {
        ...
        var _bfPair = function (lbl, id1, v1, id2, v2, step) {
            ...
            return '<div class="fmx-bfcell"><span class="fmx-lbl">' + lbl + '</span>' +
                '<div class="fmx-bfrow"><input class="fmx-inp" id="' + id1 + '" type="number" min="0"' + st + ' placeholder="' + L('от') + '" value="' + (v1 != null ? v1 : '') + '">' +
                '<input class="fmx-inp" id="' + id2 + '" type="number" min="0"' + st + ' placeholder="' + L('до') + '" value="' + (v2 != null ? v2 : '') + '"></div></div>';
        };
        bg.innerHTML = '<div class="fmx-cfm-box fmx-bf-compact" style="left:50%;transform:translateX(-50%);margin-left:0;width:calc(100vw - 20px);max-width:480px;bottom:12px;"><div class="fmx-cfm-t" style="margin-bottom:10px;display:flex;align-items:center;gap:8px;"><i class="ti ti-adjustments-horizontal" style="color:#818cf8;"></i> ' + L('Фильтры') +
            ...
            _bfPair(L('Цена, ₽'), 'fmx-bf-pmin', _fPriceMin, 'fmx-bf-pmax', _fPriceMax) +
            _bfPair(L('Охват'), 'fmx-bf-rmin', _fReachMin, 'fmx-bf-rmax', _fReachMax) +
            ...
            _bfPair(L('Индекс'), 'fmx-bf-hmin', _fHealthMin, 'fmx-bf-hmax', _fHealthMax) +
            _bfPair(L('Возраст, мес'), 'fmx-bf-agmin', _fAgeMin, 'fmx-bf-agmax', _fAgeMax) +
            _bfPair(L('Реклама, %'), 'fmx-bf-admin', _fAdpMin, 'fmx-bf-admax', _fAdpMax) +
            '<div class="fmx-bfcell"><span class="fmx-lbl">' + L('Свободно · с / по') + '</span>' +
            ...
            '</div>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Ниша') + '</span>' +
            ...
            '<button class="fmx-fx' + (_sort === 'niche' && _nicheSel ? ' on' : '') + '" data-nf="pick">' + (_sort === 'niche' && _nicheSel ? L('Ниша: ') + _esc(_nicheSel) : L('Выбрать нишу…')) + '</button>' +
            '</div>' +
            '<div class="fmx-cfm-r" style="margin-top:14px;"><button class="fmx-btn" data-reset>' + L('Сбросить') + '</button><button class="fmx-btn" data-apply style="background:#818cf8;color:#0a0d18;border-color:transparent;font-weight:700;">' + L('Применить') + '</button></div></div>';
        document.body.appendChild(bg);
        function done() { bg.remove(); }
    ...
    function paintBuyBody() {
        ...
        var moreBtn = '';
        if (loadingMore) moreBtn = '<button class="fmx-btn" id="fmx-more" disabled style="width:100%;margin-top:12px;min-height:40px;"><i class="ti ti-loader-2"></i> ' + L('Загружаю…') + '</button>';
        else if (left > 0) moreBtn = '<button class="fmx-btn" id="fmx-more" style="width:100%;margin-top:12px;min-height:40px;"><i class="ti ti-chevron-down"></i> ' + (nicheOn ? L('Показать ещё — искать нишу дальше') : L('Показать ещё (') + left + ')') + '</button>';
        if (_feedState === 'loading' && !loadingMore) body = loadHtml();
        else if (_feedState === 'error') body = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь и повтори попытку.'));
        else if (!_feed || !_feed.length) body = hasFilters
            ? emptyHtml('ti-search-off', L('Ничего не найдено'), L('Измени запрос или сбрось фильтры.'))
            : emptyHtml('ti-arrows-exchange', L('Пока пусто'), L('Здесь появятся оформленные офферы каналов от наших пользователей. Размести первый оффер кнопкой «Выставить свой канал».'));
        else {
            var feed = _applyBuyFilter(_feed);
            var rnote = (_regionFb && _regionFbBase != null && _feedTotal > _regionFbBase) ? _regionNoteHtml() : '';
            if (!feed.length) body = emptyHtml('ti-filter-off', L('По фильтру пусто'), L('В выбранной нише пока нет карточек. Попробуй «Все каналы» — или догрузи ленту дальше.')) + moreBtn;
        ...
        if (more) more.addEventListener('click', function () {
            more.disabled = true; more.innerHTML = '<i class="ti ti-loader-2"></i> ' + L('Загружаю…');
    ...
    function renderBuy() {
        ...
        sub.innerHTML =
            ...
            '<div class="fmx-picks"><button class="fmx-campbtn" id="fmx-campCta" title="' + L('Собрать кампанию под бюджет') + '"><i class="ti ti-calculator"></i><span>' + L('Кампания') + '</span></button>' +
    ...
    var REQ_FMT = { any: L('Любой формат') };
    ...
    function _ago(iso) {
        ...
        if (m < 60) return m + L(' мин назад');
        var h = Math.round(m / 60); if (h < 24) return h + L(' ч назад');
        var d = Math.round(h / 24); return d + L(' дн назад');
    }
    ...
    function reqCard(r) {
        ...
        var cts = r.contacts ? ' · <span style="color:#f59e0b;">' + r.contacts + ' ' + _plural(r.contacts, L('отклик'), L('отклика'), L('откликов')) + '</span>' : '';
        var leads = '';
        if (r.mine && r.leads && r.leads.length) {
            leads = '<div class="fmx-leads"><div class="fmx-leads-t"><i class="ti ti-users-group"></i> ' + L('Заинтересовались:') + '</div>' +
                r.leads.map(function (ld) {
                    return '<a class="fmx-lead" href="https://t.me/' + _esc(ld.username) + '" target="_blank" rel="noopener noreferrer"><b>' + _esc(ld.title || '@' + ld.username) + '</b><span>@' + _esc(ld.username) + (ld.subscribers ? ' · ' + _short(ld.subscribers) + L(' подп') : '') + '</span></a>';
                }).join('') + '</div>';
        }
        return '<div class="fmx-req' + (r.mine ? ' mine' : '') + '">' +
            '<div class="fmx-reqh">' + head.join('') + '<span class="fmx-reqb' + (r.budget ? '' : ' na') + '">' + (r.budget ? L('до ') + _num(r.budget) + ' ₽' : L('бюджет не указан')) + '</span></div>' +
            '<div class="fmx-reqt">' + _esc(r.text) + '</div>' + leads +
            '<div class="fmx-reqft"><span>' + _ago(r.created_at) + (r.mine ? L(' · твоя заявка') : '') + cts + '</span>' +
            (r.mine
                ? '<button class="fmx-btn" data-rclose="' + r.id + '" style="padding:7px 12px;"><i class="ti ti-x"></i>' + L('Закрыть') + '</button>'
                : '<span style="display:flex;gap:6px;align-items:center;"><button class="fmx-btn" data-rrep="' + r.id + '" title="' + L('Пожаловаться') + '" style="padding:7px 9px;"><i class="ti ti-flag"></i></button><button class="fmx-btn fmx-btn-p" data-rwrite="' + _esc(r.contact_username) + '" data-rid="' + r.id + '" style="padding:7px 14px;background:#818cf8;color:#fff;"><i class="ti ti-brand-telegram"></i>' + L('Написать') + '</button></span>') +
            '</div></div>';
    }
    function renderSell() {
        var sub = el('fmx-sub'); if (!sub) return;
        ...
        else if (_reqState === 'error') body = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь и повтори попытку.'));
        else if (!_reqs || !_reqs.length) body = emptyHtml('ti-speakerphone', L('Заявок пока нет'), L('Размести заявку — владельцы подходящих каналов напишут сами.'));
        else body = '<div style="display:flex;flex-direction:column;gap:9px;">' + _reqs.map(function (r) { return zw(reqCard(r)); }).join('') + '</div>';
        sub.innerHTML = '<div class="fmx-note"><i class="ti ti-speakerphone"></i> ' + L('Заявки рекламодателей: здесь ищут каналы для размещения. Твоя ниша подошла — пиши первым.') + '</div>' +
            '<div style="display:flex;gap:8px;margin:0 0 14px;flex-wrap:wrap;"><button class="fmx-save" id="fmx-newreq" style="margin:0;flex:1;min-width:170px;"><i class="ti ti-plus"></i> ' + L('Разместить заявку') + '</button>' +
            '<button class="fmx-btn" id="fmx-nbell" style="flex:0 0 auto;padding:0 13px;min-height:40px;"><i class="ti ti-bell"></i> ' + L('Следить за нишей') + '</button></div>' + body;
        scaleCards(sub);
        ...
        qsa(sub, '[data-rclose]').forEach(function (b) {
            b.addEventListener('click', function () {
                uiConfirm(L('Закрыть заявку? Она исчезнет из ленты.'), function () {
                    apiPost('/api/v1/marketplace/requests/' + b.getAttribute('data-rclose') + '/close', {}).then(function (r) {
                        if (r && r.ok === false) { uiAlert(r.error || L('Не удалось закрыть')); return; }
                        toast(L('Заявка закрыта')); _reqs = null; _reqState = 'idle'; renderSell();
                    }).catch(function () { uiAlert(L('Не удалось закрыть. Повтори попытку.')); });
                });
            });
        });
    }
    ...
    function _mineStatus(l) {
        var m = {
            published: ['#5DCAA5', L('Опубликовано')],
            paused: ['#8990a8', L('Заморожен')],
            rejected: ['#ef8080', L('Отклонён')],
            pending: ['#f5bf4f', L('На проверке')]
        };
    ...
    var _TEAM_ROLE_RU = { owner: L('Владелец'), trustee: L('Доверенный'), manager: L('Управляющий'), editor: L('Редактор'), viewer: L('Наблюдатель') };
    function mineCard(l) {
        ...
        return '<div class="fmx-minecard" data-mine="' + l.id + '">' +
            ...
            '<span class="fmx-hotx"><span class="t1">' + L('Точечные скидки') + '</span><span class="t2">' + L('свои даты, время и процент') + '</span></span>' +
    ...
    function _mineStrip(l) {
        ...
        function draw(r) {
            ...
            var demand = r.demand || {};
            var WD = [L('Вс'), L('Пн'), L('Вт'), L('Ср'), L('Чт'), L('Пт'), L('Сб')];
            var MO = [L('янв'), L('фев'), L('мар'), L('апр'), L('май'), L('июн'), L('июл'), L('авг'), L('сен'), L('окт'), L('ноя'), L('дек')];
            var h = '';
            ...
            qsa(box, '[data-sd]').forEach(function (dd) {
                dd.addEventListener('click', function () {
                    ...
                    if (dd.getAttribute('data-off')) { _haptic('light'); toast(L('Месяц закрыт для рекламы — открой его в «Весь календарь»')); return; }
                    apiPost('/api/v1/marketplace/listings/' + l.id + '/slots/toggle', { day: iso }).then(function (rr) {
                        if (!rr || !rr.ok) { _haptic('error'); uiAlert(L('Не удалось изменить день')); return; }
                        _haptic('light');
    ...
    function paintMine() {
        ...
        sub.innerHTML = '<div class="fmx-note"><i class="ti ti-briefcase"></i> ' + L('Кабинет продавца: статус, статистика и управление офферами. Занятые даты отмечай в календаре — покупатели видят свободные.') + '</div>' +
            (lim != null ? '<div style="background:rgba(255,255,255,0.03);border:0.5px solid rgba(255,255,255,0.09);border-radius:14px;padding:12px 13px;margin-bottom:10px;">' +
                '<div style="display:flex;align-items:center;gap:10px;"><span style="font-size:12.5px;font-weight:700;">' + L('Мои офферы') + '</span>' +
                '<span class="num" style="margin-left:auto;font-size:11px;color:#8990a8;">' + L('размещено:') + ' ' + used + L(' из ') + lim + '</span></div>' +
            ...
            (_channels.length >= 2 ?
                ...
                '<span style="flex:1;min-width:0;"><span style="display:block;font-size:12.5px;font-weight:700;">' + L('Сетка') + '</span><span style="display:block;font-size:10.5px;color:#8990a8;">' + L('Все каналы: сводка, пакетные цены и пауза') + '</span></span>' +
            ...
            '<button class="fmx-save" id="fmx-mineNew" style="margin-top:14px;"' + (avail === 0 ? ' disabled style="margin-top:14px;opacity:0.5;"' : '') + '><i class="ti ti-plus"></i> ' + L('Разместить ещё оффер') + (avail != null ? ' · ' + (avail > 0 ? L('доступен ещё ') + avail : L('лимит исчерпан')) : '') + '</button>' +
            '<div style="font-size:10px;color:#565b73;margin-top:7px;text-align:center;">' + L('Один канал — один оффер') + '</div>';
        loadPendingDeals();
        ...
        el('fmx-mineNew').addEventListener('click', function () {
            if (avail === 0) { _haptic('error'); uiAlert(L('Лимит исчерпан. Удали один из офферов, чтобы создать новый.')); return; }
        ...
        qsa(sub, '[data-mposter]').forEach(function (b) {
            b.addEventListener('click', function () {
                ...
                var ch = _mineChannelOf(l);
                if (!ch) { _haptic('error'); uiAlert(L('Канал этого оффера не найден в приложении.')); return; }
        ...
        qsa(sub, '[data-mpause]').forEach(function (b) {
            b.addEventListener('click', function () {
                ...
                apiPost('/api/v1/marketplace/listings/' + l.id + '/' + act, {}).then(function (r) {
                    ...
                    l.status_human = act === 'pause' ? L('Заморожен') : L('Опубликовано');
                    toast(act === 'pause' ? L('Оффер заморожен — с Площадки убран, вернёшь в любой момент') : L('Оффер снова на Площадке'));
                    _feed = null; _feedState = 'idle';
                    if (_subTab === 'mine') paintMine();
                }).catch(function () { b.disabled = false; uiAlert(L('Не удалось. Повтори попытку.')); });
            });
        });
        qsa(sub, '[data-mdel]').forEach(function (b) {
            b.addEventListener('click', function () {
                var l = _mineById(+b.getAttribute('data-mdel')); if (!l) return;
                uiConfirm(L('Удалить оффер «') + (l.title || l.username || '') + L('» с Площадки навсегда? Оформление и продвижение не сохранятся.'), function () {
                    b.disabled = true;
                    apiRequest('/api/v1/marketplace/listings/' + l.id, { method: 'DELETE' }).then(function (r) {
                        b.disabled = false;
                        if (r && r.ok === false) { _haptic('error'); uiAlert(r.error || L('Не удалось удалить')); return; }
                        _haptic('success'); toast(L('Оффер удалён'));
        ...
        _myListings.forEach(function (l) {
            apiGet('/api/v1/marketplace/my/' + l.id + '/stats').then(function (r) {
                ...
                if (!r || !r.ok) { n.textContent = L('За 7 дней: статистика недоступна'); return; }
                var t = r.totals || {};
                n.innerHTML = L('За 7 дней:') + ' <b>' + (t.views || 0) + '</b> ' + L('показов ·') + ' <b>' + (t.expands || 0) + '</b> ' + L('разворотов ·') + ' <b>' + (t.writes || 0) + '</b> ' + L('перешли в чат');
            }).catch(function () { var n = el('fmx-mst-' + l.id); if (n) n.textContent = L('За 7 дней: статистика недоступна'); });
        });
    }
    ...
    function netAttn(ch, l) {
        if (ch.bot_status !== 'connected') return { lvl: 'r', text: L('Бот не подключён к каналу') };
        if (l && (l.status === 'rejected' || l.status === 'banned')) return { lvl: 'a', text: L('Оффер отклонён модерацией') };
        return null;
    }
    ...
    function netOpen() {
        ...
        bg.innerHTML = '<div class="fmx-modal">' +
            '<div class="fmx-mhead"><div style="flex:1;min-width:0;"><h2><i class="ti ti-sitemap" style="color:#34d399;"></i> <span>' + L('Сетка') + '</span></h2><p id="fmx-netSub"><span>' + L('Каналы, офферы и пакетные операции') + '</span></p></div>' +
            ...
            '<button id="fmx-netSel" style="background:rgba(129,140,248,0.12);border:0.5px solid rgba(129,140,248,0.3);color:#818cf8;border-radius:999px;padding:7px 14px;font-size:12px;font-weight:700;font-family:inherit;cursor:pointer;flex:0 0 auto;"><span>' + L('Выбрать') + '</span></button>' +
    ...
    function netMode(on) {
        ...
        if (sb) sb.innerHTML = '<span>' + (on ? L('Отмена') : L('Выбрать')) + '</span>';
        netPaint();
    }
    ...
    function netReload() {
        Promise.all([apiGet('/api/v1/channels'), apiGet('/api/v1/marketplace/my'), apiGet('/api/v1/marketplace/network/batch').catch(function () { return null; })]).then(function (rr) {
            ...
            if (body) body.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь и повтори попытку.'));
        });
    }
    ...
    function netPaint() {
        ...
        function tile(icon, color, bgc, label, val, hint) {
            return '<div style="background:rgba(255,255,255,0.03);border:0.5px solid rgba(255,255,255,0.08);border-radius:14px;padding:11px 12px;min-width:0;">' +
        ...
        var tiles = '<div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:12px;">' +
            ...
            tile('ti-briefcase', '#f5bf4f', 'rgba(245,191,79,0.15)', L('Офферы'), _num(_net.used) + (_net.lim != null ? ' <span style="font-size:11px;font-weight:600;color:#565b73;">/ ' + _num(_net.lim) + '</span>' : ''),
                pend ? '<span>' + L('На модерации:') + '</span> <b class="num">' + pend + '</b>' : '') +
            '</div>';
        var chipDefs = [
            { k: 'all', t: L('Все'), n: rows.length },
            { k: 'pub', t: L('Опубликованы'), n: pub },
            { k: 'paused', t: L('Пауза'), n: paus },
            { k: 'none', t: L('Без оффера'), n: none },
            { k: 'attn', t: L('Внимание'), n: attn }
        ];
        ...
        var html = list.map(function (r) {
            ...
            if (l) {
                ...
                right = '<span style="flex:0 0 auto;text-align:right;display:flex;flex-direction:column;align-items:flex-end;gap:3px;">' +
                    '<span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#f5bf4f;background:rgba(245,191,79,0.1);border:0.5px solid rgba(245,191,79,0.35);border-radius:99px;padding:2px 8px;white-space:nowrap;"><i class="ti ti-player-pause" style="font-size:10px;"></i>' + L('На паузе') + '</span>' +
                    '';
            } else if (ch.username) {
                right = '<button data-netmk="' + ch.id + '" style="flex:0 0 auto;font-size:11.5px;font-weight:700;font-family:inherit;cursor:pointer;color:#818cf8;background:rgba(129,140,248,0.12);border:0.5px solid rgba(129,140,248,0.3);border-radius:999px;padding:6px 12px;"><span>' + L('Создать') + '</span></button>';
            } else {
                right = '<span style="font-size:10px;color:#565b73;flex:0 0 auto;max-width:92px;text-align:right;"><span>' + L('Нужен публичный @username') + '</span></span>';
            }
        ...
        if (!html) html = '<div class="fmx-empty" style="padding:26px 0;"><i class="ti ti-inbox"></i><div><span>' + L('Здесь пока пусто') + '</span></div></div>';
        ...
        if (batchRunning) {
            ...
            plate = '<div id="fmx-nbPlate" style="display:flex;align-items:center;gap:10px;background:rgba(129,140,248,0.08);border:0.5px solid rgba(129,140,248,0.3);border-radius:14px;padding:11px 13px;margin-bottom:10px;cursor:pointer;">' +
                ...
                '<span style="flex:1;min-width:0;"><span style="display:block;font-size:12.5px;font-weight:700;">' + L('Создание офферов') + '</span>' +
        ...
        if (!_net.mode && elig.length && !batchRunning) {
            mkBtn = '<button id="fmx-nbStart" class="fmx-save" style="margin-top:4px;"><i class="ti ti-stack-2"></i> <span>' + L('Создать офферы') + '</span> <span class="num">· ' + elig.length + '</span></button>';
        }
        ...
        if (sub) sub.innerHTML = _net.mode ? '<span>' + L('Выбрано:') + '</span> <b class="num">' + netSelIds().length + '</b>' : '<span>' + L('Каналы, офферы и пакетные операции') + '</span>';
        ...
        if (ab) {
            if (_net.mode) {
                ...
                ab.style.display = '';
                ab.innerHTML = allSel ? '<span>' + L('Сброс') + '</span>' : '<span>' + L('Все') + '</span>' + (selectable.length ? ' <b class="num" style="font-weight:800;">' + selectable.length + '</b>' : '');
                ab.onclick = function () {
                    _haptic('light');
                    if (allSel) _net.sel = {};
        ...
        if (bar) {
            if (_net.mode) {
                ...
                bar.innerHTML =
                    '<button data-netact="price" style="' + dis + 'flex:1.3;font-family:inherit;cursor:pointer;font-size:12.5px;font-weight:700;border-radius:12px;padding:11px 4px;background:#6366f1;border:0.5px solid #6366f1;color:#fff;"><i class="ti ti-tag"></i> <span>' + L('Цены') + '</span></button>' +
                    '<button data-netact="pause" style="' + dis + 'flex:1;font-family:inherit;cursor:pointer;font-size:12.5px;font-weight:700;border-radius:12px;padding:11px 4px;background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.12);color:#e8e8ed;"><i class="ti ti-player-pause"></i> <span>' + L('Пауза') + '</span></button>' +
                    '<button data-netact="resume" style="' + dis + 'flex:1;font-family:inherit;cursor:pointer;font-size:12.5px;font-weight:700;border-radius:12px;padding:11px 4px;background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.12);color:#e8e8ed;"><i class="ti ti-player-play"></i> <span>' + L('Возобновить') + '</span></button>';
    ...
    var _NET_REASONS = {
        ...
        state: L('статус не подходит')
    };

    function netAfterApply() {
        _feed = null; _feedState = 'idle';
        _net.mode = false; _net.sel = {};
        var sb = el('fmx-netSel'); if (sb) sb.innerHTML = '<span>' + L('Выбрать') + '</span>';
    ...
    function netState(ids, action) {
        ...
        apiPost('/api/v1/marketplace/network/state', { ids: ids, action: action }).then(function (r) {
            _net.busy = false;
            if (!r || r.ok === false) { _haptic('error'); toast(L('Не удалось. Повтори попытку.'), true); return; }
            _haptic('success');
            var m = (action === 'pause' ? L('Пауза: ') : L('Возобновлено: ')) + r.applied;
            if (r.skipped && r.skipped.length) m += ' · ' + L('Пропущено: ') + r.skipped.length;
            toast(m);
            netAfterApply();
        }).catch(function () { _net.busy = false; _haptic('error'); toast(L('Не удалось. Повтори попытку.'), true); });
    }
    ...
    function netPriceSheet(ids) {
        ...
        bg.innerHTML = '<div class="fmx-modal">' +
            '<div class="fmx-mhead"><div style="flex:1;min-width:0;"><h2><i class="ti ti-tag" style="color:#5DCAA5;"></i> <span>' + L('Пакетные цены') + '</span></h2><p><span>' + L('Выбрано:') + '</span> <b class="num">' + ids.length + '</b></p></div>' +
            '<button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div>' +
            '<div class="fmx-mbody">' +
            ...
            '</div>' +
            '<div style="font-size:11px;color:#5DCAA5;background:rgba(93,202,165,0.08);border:0.5px solid rgba(93,202,165,0.22);border-radius:11px;padding:9px 11px;margin-bottom:10px;"><i class="ti ti-circle-check"></i> <span>' + L('Смена цены применяется сразу и не требует повторной модерации') + '</span></div>' +
            ...
            '<button class="fmx-save" id="fmx-netCalc"><i class="ti ti-calculator"></i> <span>' + L('Показать расчёт') + '</span></button>' +
        ...
        el('fmx-netCalc').addEventListener('click', function () {
            ...
            apiPost('/api/v1/marketplace/network/prices', b).then(function (r) {
                ...
                if (skipped.length) {
                    html += '<div style="font-size:11px;color:#8990a8;margin-top:8px;"><span>' + L('Пропущено:') + '</span> <b class="num">' + skipped.length + '</b></div>' +
                ...
                if (hot) {
                    html = '<div style="font-size:11px;color:#f5bf4f;background:rgba(245,158,11,0.08);border:0.5px solid rgba(245,158,11,0.25);border-radius:11px;padding:9px 11px;margin-bottom:8px;"><i class="ti ti-alert-triangle"></i> <span>' + L('У части офферов действует горящая скидка — при смене цены она будет снята') + '</span></div>' + html;
                }
                if (!items.length) {
                    html += '<div style="font-size:12px;color:#8990a8;text-align:center;padding:10px 0;"><span>' + L('Ничего не рассчитано — офферы пропущены') + '</span></div>';
                }
                pv.innerHTML = html;
                ...
                if (go) {
                    ...
                    go.innerHTML = '<i class="ti ti-check"></i> <span>' + L('Применить к ') + items.length + '</span>';
                }
            }).catch(function () { _net.busy = false; _haptic('error'); toast(L('Не удалось. Повтори попытку.'), true); });
        });
        el('fmx-netGo').addEventListener('click', function () {
            ...
            apiPost('/api/v1/marketplace/network/prices', reqBody(false)).then(function (r) {
                ...
                if (!r || r.ok === false) { _haptic('error'); toast(L('Не удалось. Повтори попытку.'), true); return; }
                _haptic('success');
                toast(L('Цены обновлены: ') + (r.applied || 0));
                bg.remove();
                netAfterApply();
            }).catch(function () { _net.busy = false; _haptic('error'); toast(L('Не удалось. Повтори попытку.'), true); });
        });
    ...
    function nbOpen() {
        ...
        apiGet('/api/v1/marketplace/network/batch').then(function (r) {
            ...
            var b = el('fmx-nbBody');
            if (b) b.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь и повтори попытку.'));
        });
    }

    function nbHead(step) {
        var t = el('fmx-nbTtl'), s = el('fmx-nbStp');
        if (t) t.innerHTML = '<i class="ti ti-stack-2" style="color:#818cf8;"></i> <span>' + (step ? L('Новые офферы') : L('Создание офферов')) + '</span>';
        if (s) s.innerHTML = step ? '<span>' + (step === 1 ? L('Шаг 1 из 3') : step === 2 ? L('Шаг 2 из 3') : L('Шаг 3 из 3')) + '</span>' : '';
    }
    ...
    function nbPaint() {
        ...
        if (_nb.step === 1) {
            ...
            rows += rest.map(function (ch) {
                var why = !ch.username ? L('Нужен публичный @username') : L('Бот не подключён к каналу');
                return '<div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,0.03);border:0.5px solid rgba(255,255,255,0.07);border-radius:14px;padding:9px 12px;margin-bottom:8px;opacity:0.42;">' +
                    ...
                    '<span style="flex:1;min-width:0;"><span style="display:block;font-size:13.5px;font-weight:700;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">' + _esc(ch.title || L('Канал')) + '</span>' +
                    '<span style="display:block;font-size:10.5px;color:#565b73;"><span>' + why + '</span></span></span></div>';
            }).join('');
            body.innerHTML = nbBar(1) +
                '<div style="display:flex;gap:8px;font-size:12px;background:rgba(59,130,246,0.08);border:0.5px solid rgba(59,130,246,0.25);border-radius:11px;padding:9px 11px;margin-bottom:10px;color:#60a5fa;"><i class="ti ti-info-circle"></i> <span><span>' + L('Офферов свободно:') + '</span> <b class="num">' + lim.listings + '</b> · <span>' + L('Показаны каналы без оффера') + '</span></span></div>' +
                '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;">' +
                '<span style="font-size:12px;color:#8990a8;"><span>' + L('Выбрано:') + '</span> <b class="num" style="color:#e8e8ed;">' + n + '</b><span class="num"> / ' + elig.length + '</span></span>' +
                '<button id="fmx-nbAll" style="font-size:12px;font-weight:700;font-family:inherit;cursor:pointer;color:#a9aec0;background:rgba(255,255,255,0.05);border:0.5px solid rgba(255,255,255,0.12);border-radius:999px;padding:6px 12px;"><span>' + (n >= Math.min(elig.length, lim.max) && n > 0 ? L('Сброс') : L('Все')) + '</span>' + (n >= Math.min(elig.length, lim.max) && n > 0 ? '' : ' <b class="num">' + Math.min(elig.length, lim.max) + '</b>') + '</button></div>' +
                rows +
                (over ? '<div style="display:flex;gap:8px;font-size:12px;background:rgba(245,158,11,0.08);border:0.5px solid rgba(245,158,11,0.25);border-radius:11px;padding:9px 11px;color:#f5bf4f;"><i class="ti ti-alert-triangle"></i> <span><span>' + L('Доступно сейчас:') + '</span> <b class="num">' + lim.max + '</b> · <span>' + L('сними лишние отметки') + '</span></span></div>' : '');
            foot.innerHTML = '<button class="fmx-save" id="fmx-nbNext"' + (!n || over ? ' disabled style="opacity:0.5;"' : '') + '><span>' + L('Дальше') + '</span>' + (n ? ' <span class="num">· ' + n + '</span>' : '') + '</button>';
            ...
            body.innerHTML = nbBar(3) +
                ...
                '</div>' +
                '<div style="display:flex;gap:8px;font-size:12px;background:rgba(59,130,246,0.08);border:0.5px solid rgba(59,130,246,0.25);border-radius:11px;padding:9px 11px;color:#60a5fa;"><i class="ti ti-info-circle"></i> <span>' + L('Офферы создадутся сразу и уйдут на модерацию по очереди в фоне. Приложение можно закрыть — бот пришлёт итог.') + '</span></div>';
            foot.innerHTML = '<button class="fmx-save" id="fmx-nbGo"><i class="ti ti-rocket"></i> <span>' + L('Создать офферы') + '</span> <span class="num">· ' + cnt + '</span></button>' +
                '<button class="fmx-btn" id="fmx-nbBack" style="width:100%;color:#8990a8;"><i class="ti ti-arrow-left"></i> <span>' + L('Назад') + '</span></button>';
            ...
            el('fmx-nbGo').addEventListener('click', function () {
                ...
                apiPost('/api/v1/marketplace/network/batch', { channel_ids: ids, prices: prices, custom_text: _nb.text.trim() || null }).then(function (r) {
                    ...
                    btn.disabled = false; btn.style.opacity = '';
                    _haptic('error'); toast(L('Не удалось. Повтори попытку.'), true);
                });
            });
        }
    }
    ...
    function nbProgress() {
        ...
        nbHead(0);
        var b = (_nb.ov || {}).batch;
        if (!b) { body.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь и повтори попытку.')); return; }
        var c = b.counts || {};
        ...
        var html = '<div style="background:rgba(255,255,255,0.03);border:0.5px solid rgba(255,255,255,0.08);border-radius:14px;padding:14px;margin-bottom:12px;">' +
            '<div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:8px;"><span><span>' + (running ? L('Модерация в фоне') : L('Готово')) + '</span></span><b class="num">' + b.done + ' / ' + b.total + '</b></div>' +
        ...
        if (pubItems.length) {
            ...
            html += group('✓', { bg: 'rgba(16,185,129,0.15)', c: '#34d399', br: 'rgba(16,185,129,0.3)' }, L('Опубликовано'), pubItems.length, names);
        }
        if (revItems.length) {
            html += group('👁', { bg: 'rgba(245,158,11,0.15)', c: '#fbbf24', br: 'rgba(245,158,11,0.3)' }, L('На ручной проверке'), revItems.length, '<span>' + L('Проверим и опубликуем — обычно до суток') + '</span>');
        }
        badItems.forEach(function (it) {
            html += group('✕', { bg: 'rgba(239,68,68,0.15)', c: '#f87171', br: 'rgba(239,68,68,0.35)' }, _esc(it.title || L('Канал')), 1,
                (it.reason ? _esc(it.reason) + ' · ' : '') + '<span>' + L('Открыть и исправить') + '</span>', 'data-nbfix="' + it.channel_id + '"');
        });
        if (qN) {
            html += group('…', { bg: 'rgba(59,130,246,0.15)', c: '#60a5fa', br: 'rgba(59,130,246,0.3)' }, L('В очереди'), qN, '');
        }
        html += '<div style="display:flex;gap:9px;align-items:flex-start;background:rgba(59,130,246,0.08);border:0.5px solid rgba(59,130,246,0.25);border-radius:12px;padding:10px 12px;font-size:12px;color:#60a5fa;margin-top:2px;">🤖 <span>' + L('Можно закрыть приложение — по завершении бот пришлёт итог: сколько опубликовано и что требует правок.') + '</span></div>';
        body.innerHTML = html;
        ...
        foot.innerHTML = '<button class="fmx-btn" id="fmx-nbToNet" style="width:100%;color:#a9aec0;"><i class="ti ti-sitemap"></i> <span>' + L('К экрану «Сетка»') + '</span></button>';
    ...
    function renderMine() {
        ...
        Promise.all([loadChannels(), loadMyListings()]).then(function () {
            ...
            sub.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Проверь связь и повтори попытку.'));
        });
    }
    ...
    function openOwnerCalendar(l) {
        ...
        _ownerSelDay = null;
        var s = el('fmx-calSub'); if (s) s.textContent = '@' + (l.username || '') + (_ownerCalHot ? L(' — выбери день и назначь скидку, покупатели увидят её жёлтой') : L(' — отмечай занятые дни, покупатели увидят свободные'));
    ...
    var NICHE_TAX = [
        ['Арбитраж · Нутра', [['Нутра — вся', 'нутра'], 'Похудение', 'Потенция', 'Диабет', 'Зрение', 'Гипертония', 'Простатит', 'Варикоз', 'Геморрой', 'Омоложение', 'Иммунитет', 'БАДы / витамины', 'Спортпит', 'Кожа / волосы']],
        ...
        ['Арбитраж · Крипта и Web3', [['Крипта — вся', 'крипта'], 'Трейдинг', 'Сигналы / боты', 'Биржи / обменники', 'P2P', 'DeFi / стейкинг', 'NFT', 'Майнинг', ['Airdrop / launchpad', 'Airdrop'], 'Обучение трейдингу']],
        ['Арбитраж · Финансы и займы', [['Финансы — все', 'финансы'], 'Займы / МФО', 'Кредиты', 'Кредитные карты', 'Дебетовые карты', 'Ипотека', 'Автокредиты', 'Банкротство', 'Страхование', 'Кэшбэк', 'РКО', 'Субсидии / пособия', 'Налоговые вычеты']],
        ['Арбитраж · Трейдинг и инвест', ['Форекс', 'Брокеры / акции', 'Инвест-платформы', 'Копитрейдинг', 'ПАММ / ДУ', 'Проп-трейдинг']],
        ...
        ['Арбитраж · Дейтинг, adult, прочее', ['Дейтинг', 'Знакомства СНГ', 'Adult', 'Adult · вебкам', 'Adult · подписки / OnlyFans', 'Adult · секс-товары', 'Свипстейки / розыгрыши', 'Установки приложений / PWA', 'Мобильные игры', 'Эссе / дипломы', 'Инфобизнес / заработок', 'MLM / сетевой']],
        ['Сервисы для арбитража', ['Сервисы для арбитража', 'Антидетект-браузеры', 'Прокси-сервисы', 'Платёжки / антифрод', 'CPA-сети / партнёрки', 'Обмен / P2P-крипта']],
        ...
        [L('IT и технологии'), ['IT', 'Программирование', 'Нейросети / AI', 'Дизайн UX / UI', 'Кибербезопасность', 'Гаджеты / девайсы', 'Софт / приложения', 'Игры / гейминг', 'Киберспорт', 'Web3-разработка', 'No-code', 'DevOps', 'Data / ML']],
        ['Новости и общество', ['Новости', 'Политика', 'Экономика', 'Расследования', 'Региональные новости', 'Военное', 'Право / юриспруденция', 'Общество', 'Международные отношения', 'История']],
        ['Образование и развитие', [L('Образование'), 'Наука / научпоп', 'Языки / английский', 'Психология', 'Саморазвитие', 'Мотивация', 'Книги / литература', 'Цитаты', 'Философия', 'Продуктивность', 'Финграмотность']],
        ['Здоровье, спорт, ЗОЖ', ['Здоровье / медицина', 'Стоматология', 'Биохакинг и добавки', 'Ментальное здоровье', 'Фитнес', 'Питание / диетология', 'Спорт', 'Футбол', 'Хоккей', 'Баскетбол', 'Единоборства / ММА', 'Бег', 'Йога / медитация', 'Бодибилдинг']],
        ...
        ['Дом, хобби, увлечения', ['Путешествия / туризм', 'Кулинария / рецепты', 'Дом / интерьер', 'Ремонт / строительство', 'Сад / огород / дача', 'Растения', 'Рукоделие', 'Охота / рыбалка', 'Авто / мото', ['Пригон авто из-за рубежа', 'Авто · Пригон из-за рубежа'], 'Коллекционирование', 'Настольные игры']],
        ...
        ['B2B и отрасли', ['Госзакупки / тендеры', 'HoReCa / общепит', 'Бухгалтерия / налоги', '1С / учёт', 'HR / подбор', 'Логистика / ВЭД', 'Промышленность', 'Строительство', 'Коммерческая недвижимость', 'Сельское хозяйство / агро', 'Медицина для врачей', 'IT-B2B / SaaS', 'Оптовые поставки', 'Оценка бизнеса / M&A']],
        ...
        ['Служебное', ['Каталоги каналов', 'Агрегаторы / переходники', 'Объявления / барахолка', 'Прочее']]
    ];
    ...
    function openNichePick(onPick) {
        ...
        function draw(q) {
            ...
            if (_ex.length) {
                hits += _ex.length;
                html += '<div class="fmx-npg">' + L('Найдено в каталоге') + '</div><div class="fmx-fxw">' + _ex.map(function (nm) {
            ...
            var box = el('fmx-nlist'); if (box) box.innerHTML = hits ? html : '<div style="color:#565b73;font-size:12.5px;text-align:center;padding:22px 4px;">' + L('Ничего не нашлось. Попробуй другое слово.') + '</div>';
    ...
    function _regionChipHtml() { return '<button class="fmx-seg' + (_regionAll ? '' : ' on') + '" data-region style="flex:0 0 auto;"><i class="ti ti-world"></i> <span>' + (_regionAll ? L('Все регионы') : L('Мой регион')) + '</span></button>'; }
    function _regionNoteHtml() { return '<div class="fmx-note"><i class="ti ti-world"></i> <span>' + L('В твоём регионе площадок пока немного — показаны все регионы.') + '</span></div>'; }
    function _bindRegionChip(scope, after) {
        ...
        rc.addEventListener('click', function () {
            ...
            var sp = rc.querySelector('span'); if (sp) sp.textContent = _regionAll ? L('Все регионы') : L('Мой регион');
            after();
        });
    }
    ...
    var _RF_GEO = [['ru', L('Россия')], ['kz', L('Казахстан')], ['by', L('Беларусь')], ['ua', L('Украина')], ['uz', L('Узбекистан')], ['kg', L('Киргизия')], ['az', L('Азербайджан')], ['ge', L('Грузия')], ['am', L('Армения')], ['tj', L('Таджикистан')], ['tr', L('Турция')], ['ae', L('ОАЭ')], ['sa', L('Саудовская Аравия')], ['eg', L('Египет')], ['ir', L('Иран')], ['in', L('Индия')], ['bd', L('Бангладеш')], ['id', L('Индонезия')], ['vn', L('Вьетнам')], ['us', L('США')], ['gb', L('Великобритания')], ['de', L('Германия')], ['at', L('Австрия')], ['ch', L('Швейцария')], ['fr', L('Франция')], [L('it'), L('Италия')], ['es', L('Испания')], ['pt', L('Португалия')], ['br', L('Бразилия')], ['mx', L('Мексика')], ['ar', L('Аргентина')], ['et', L('Эфиопия')], ['tz', L('Танзания')], ['ke', L('Кения')], ['int', L('Международный')]];
    function _rfBtnLabel() {
        var b = el('fmx-rfbtn'); if (!b) return;
        var n = _rfCount();
        b.innerHTML = '<i class="ti ti-adjustments-horizontal"></i> ' + L('Фильтры') + (n ? ' · ' + n : '');
    ...
    function openRadarFilters() {
        ...
        var rows = _RF_RANGES.map(function (r) {
            ...
            var i2 = '<input class="fmx-inp" type="number" inputmode="numeric" min="0" placeholder="' + L('до') + '" value="' + mx + '" data-mx="' + r[0] + '">';
            return '<div class="fmx-bfcell"><span class="fmx-lbl">' + r[1] + '</span><div class="fmx-bfrow"><input class="fmx-inp" type="number" inputmode="numeric" min="0" placeholder="' + L('от') + '" value="' + mn + '" data-mn="' + r[0] + '">' + i2 + '</div></div>';
        }).join('');
        bg.innerHTML = '<div class="fmx-cfm-box fmx-bf-compact" style="left:50%;transform:translateX(-50%);margin-left:0;width:calc(100vw - 20px);max-width:480px;bottom:12px;">' +
            '<div class="fmx-cfm-t" style="margin-bottom:10px;display:flex;align-items:center;gap:8px;"><i class="ti ti-adjustments-horizontal" style="color:#818cf8;"></i> ' + L('Фильтры') +
            ...
            '<span class="fmx-lbl">' + L('Быстро') + '</span><div class="fmx-fxw" id="fmx-rf-pre">' + _RF_PRESETS.map(function (p) { return '<button class="fmx-fx' + (_rf.presets[p[0]] ? ' on' : '') + '" data-p="' + p[0] + '">' + p[1] + '</button>'; }).join('') + '</div>' +
            (function () {
                var selN = 0;
                ...
                return '<details class="fmr-more" style="margin-top:12px;"' + (selN ? ' open' : '') + '><summary><i class="ti ti-world" style="color:#818cf8;"></i> <span>' + L('Страна аудитории') + '</span>' +
            ...
            '<span class="fmx-lbl fmx-mt2">' + L('Точная настройка — от / до') + '</span><div class="fmx-bfgrid" style="margin-top:6px;">' + rows + '</div>' +
            '<div class="fmx-cfm-r" style="margin-top:14px;"><button class="fmx-btn" data-reset>' + L('Сбросить') + '</button><button class="fmx-btn" data-apply style="background:#818cf8;color:#0a0d18;border-color:transparent;font-weight:700;">' + L('Применить') + '</button></div></div>';
        document.body.appendChild(bg);
        function upd() { var c = el('fmx-rf-cnt'); if (c) c.textContent = L('Показать ') + (_catalog || []).filter(_rfPass).length; }
    ...
    var REP_REASONS = [['scam', L('Скам / обман')], ['fake_metrics', L('Накрутка метрик')], ['illegal', L('Запрещённый контент')], ['other', L('Другое')]];
    function openComplaint(target) {
        ...
        el('fmx-repBody').innerHTML =
            '<span class="fmx-lbl">' + L('Причина') + '</span><div class="fmx-fxw" id="fmx-rep-r">' + chips + '</div>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Комментарий') + ' <span style="color:#565b73;text-transform:none;">' + L('(для «Другое» — обязателен)') + '</span></span>' +
            '<textarea class="fmx-inp" id="fmx-rep-c" rows="3" maxlength="300" placeholder="' + L('Опиши проблему. Чем конкретнее — тем быстрее разберём.') + '"></textarea>' +
            '<div style="font-size:10px;color:#565b73;line-height:1.5;margin-top:8px;">' + L('Жалобы анонимны для владельца. Несколько жалоб от разных людей скрывают цель до ручной проверки.') + '</div>' +
            '<button class="fmx-save" id="fmx-rep-send" style="margin-top:14px;"><i class="ti ti-flag"></i> ' + L('Отправить жалобу') + '</button>';
        var sel = { v: 'scam' };
        ...
        el('fmx-rep-send').addEventListener('click', function () {
            ...
            apiPost('/api/v1/marketplace/complaints', body).then(function (r) {
                btn.disabled = false;
                if (r && r.ok === false) { _haptic('error'); uiAlert(r.error || L('Не удалось отправить')); return; }
                _haptic('success'); hideModal('fmx-repBg');
                toast(r && r.hidden ? L('Скрыто до проверки') : L('Жалоба отправлена — проверим'));
                if (r && r.hidden) {
            ...
            }).catch(function () { btn.disabled = false; uiAlert(L('Не удалось отправить. Повтори попытку.')); });
        });
        showModal('fmx-repBg');
    }
    ...
    function _nsRow(n) {
        ...
        return '<div class="fmx-nsrow"><span class="fmx-nsn">' + _esc(n) + '</span>' + right +
            '<button class="fmx-nsx" data-nsdel="' + _esc(n) + '" title="' + L('Отписаться') + '"><i class="ti ti-x"></i></button></div>';
    }
    ...
    function renderNsBody() {
        ...
        var chips = (_nsubs && _nsubs.length)
            ...
            : '<div style="font-size:11px;color:#8990a8;line-height:1.6;margin-bottom:4px;">' + L('Подписок пока нет. Ниша твоего оффера подписывается автоматически при публикации.') + '</div>';
        box.innerHTML = chips +
        ...
        var addFn = function () {
            ...
            apiPost('/api/v1/marketplace/niche_subs', { niche: v, on: true }).then(function (r) {
                if (r && r.ok === false) { uiAlert(r.error || L('Не удалось')); return; }
    ...
    var _SCOPE_LBL = { both: L('Радар + Площадка'), radar: L('Радар'), market: L('Площадка') };
    var _AL_RANGES = [['p', L('Цена не дороже, ₽'), 'mx'], ['cpm', L('CPM не дороже, ₽'), 'mx'], ['s', L('Подписчиков от'), 'mn'],
        ['r', L('Охват от'), 'mn'], ['err', L('ERR от, %'), 'mn'], ['er', L('ER от, %'), 'mn'],
        ['h', L('Индекс от'), 'mn'], ['age', L('Возраст от, мес'), 'mn'], ['adp', L('Рекламы не больше, %'), 'mx']];
    function _alertChips(f) {
        ...
        if (mn.s != null) out.push('<span class="fmx-alc">' + _short(mn.s) + L('+ подп') + '</span>');
        if (mn.r != null) out.push('<span class="fmx-alc">' + L('охват') + ' ' + _short(mn.r) + '+</span>');
        if (mn.err != null) out.push('<span class="fmx-alc">ERR ≥ ' + mn.err + '%</span>');
        if (mn.er != null) out.push('<span class="fmx-alc">ER ≥ ' + mn.er + '%</span>');
        if (mn.h != null) out.push('<span class="fmx-alc">' + L('индекс ≥') + ' ' + mn.h + '</span>');
        ...
        if (aud.length) out.push('<span class="fmx-alc">' + aud.map(function (a) { return { male: L('муж'), female: L('жен'), mixed: L('смеш') }[a] || a; }).join('/') + '</span>');
        return out.length ? out.join('') : '<span class="fmx-alc mut">' + L('любые каналы') + '</span>';
    }
    ...
    function _alertAutoName(f) {
        ...
        if (f.mx && f.mx.p != null) parts.push(L('до ') + _short(f.mx.p));
        if (f.mx && f.mx.cpm != null) parts.push('CPM≤' + f.mx.cpm);
        if (!parts.length) parts.push(L('Все каналы'));
    ...
    function _alHead(title, sub, withBack) {
        return '<div class="grip"></div><div class="fmx-alhd">' +
            (withBack ? '<button class="fmx-alback" id="fmx-al-back" title="' + L('Назад') + '"><i class="ti ti-arrow-left"></i></button>'
            ...
            '<button class="fmx-alx" id="fmx-al-close" title="' + L('Закрыть') + '"><i class="ti ti-x"></i></button></div>';
    }
    ...
    function openAlerts() {
        _haptic('light');
        _alSheet(_alHead(L('Умные уведомления'), L('Появится нужный канал — сообщим в бот'), false) +
    ...
    function loadAlerts() {
        ...
        }).catch(function () { var b = el('fmx-al-body'); if (b) b.innerHTML = emptyHtml('ti-cloud-off', L('Не загрузилось'), L('Проверь связь и повтори.')); });
    }
    function renderAlertsList(r) {
        ...
        var canAdd = used < lim;
        var h = '<button class="fmx-alnew" id="fmx-al-new"' + (canAdd ? '' : ' disabled') + '><i class="ti ti-plus"></i> ' + L('Новое уведомление') + '</button>' +
            '<div class="fmx-allim">' + L('Активно') + ' ' + used + L(' из ') + lim + (canAdd ? '' : L(' · достигнут предел')) + '</div>';
        if (!alerts.length) {
            h += emptyHtml('ti-bell-plus', L('Пока нет уведомлений'), L('Задай нишу, потолок цены и качество — подходящие каналы придут сами.'));
        } else {
            alerts.forEach(function (a) {
                ...
                h += '<div class="fmx-al' + (a.enabled ? '' : ' off') + '">' +
                    ...
                    '<div class="fmx-al-match">' + (a.enabled ? '<span style="color:' + (a.mode === 'digest' ? '#f5bf4f' : '#5DCAA5') + ';">●</span> ' + (a.seen_count ? a.seen_count + L(' найдено · ') : '') + (a.mode === 'digest' ? L('сводка раз в день') : L('мгновенно')) : '<span style="color:#565b73;">' + L('выключено') + '</span>') + '</div>' +
        ...
        qsa(body, '[data-del]').forEach(function (x) {
            x.addEventListener('click', function () {
                ...
                uiConfirm(L('Удалить это уведомление?'), function () {
                    apiDelete('/api/v1/marketplace/alerts/' + id).then(function (rr) {
                        if (rr && rr.ok === false) { uiAlert(rr.error || L('Не удалось удалить')); return; }
                        _haptic('success'); loadAlerts();
                    }).catch(function () { uiAlert(L('Не удалось удалить. Повтори попытку.')); });
                });
            });
        });
    ...
    function openAlertEditor(a) {
        ...
        var rangesHtml = _AL_RANGES.map(function (r) {
            ...
            return '<div class="fmx-bfcell"><span class="fmx-lbl">' + r[1] + '</span>' +
                '<input class="fmx-inp" type="number" inputmode="numeric" min="0" placeholder="' + L('не важно') + '" value="' + v + '" data-rng="' + r[0] + '" data-bnd="' + r[2] + '"></div>';
        }).join('');
        var sh = _alSheet(_alHead((_aEdit.id ? L('Изменить уведомление') : L('Новое уведомление')), L('Условия закупки'), true) +
            '<div class="fmx-ae-sec">' + L('Название') + '</div><input class="fmx-inp" id="fmx-ae-name" maxlength="60" value="' + _esc(_aEdit.name) + '">' +
            '<div class="fmx-ae-sec">' + L('Где искать') + '</div><div class="fmx-segw" id="fmx-ae-scope">' + seg(_aEdit.scope, [['both', L('Обе')], ['radar', L('Радар')], ['market', L('Площадка')]]) + '</div>' +
            '<div class="fmx-ae-sec">' + L('Ниши') + ' <span style="text-transform:none;letter-spacing:0;color:#565b73;font-weight:500;">' + L('— пусто = любые') + '</span></div><div class="fmx-fxw" id="fmx-ae-nw">' +
        ...
        el('fmx-ae-save').addEventListener('click', function () {
            ...
            apiPost('/api/v1/marketplace/alerts', payload).then(function (r) {
                if (r && r.ok === false) { uiAlert(r.message || r.error || L('Не удалось')); sv.disabled = false; return; }
                _haptic('success'); openAlerts();
            }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); sv.disabled = false; });
        });
    }
    var _amSeq = 0;
    function openAlertMatches(id, scope) {
        ...
        function draw() {
            _alSheet(_alHead(L('Совпадения сейчас'), L('Каналы под этот фильтр'), true) +
                '<div class="fmx-segw" id="fmx-am-sc">' +
                [['both', L('Обе')], ['radar', L('Радар')], ['market', L('Площадка')]].map(function (o) {
            ...
            apiGet('/api/v1/marketplace/alerts/' + id + '/matches?scope=' + cur).then(function (r) {
                ...
                var items = (r && r.items) || [];
                if (!items.length) { b.innerHTML = emptyHtml('ti-search', L('Пока пусто'), L('Здесь нет каналов под фильтр. Уведомление придёт, как только появится.')); return; }
                var h = '<div class="fmx-allim" style="margin:0 0 10px;">' + L('Подходит') + ' ' + (r.count || items.length) + ' ' + _plural(r.count || items.length, L('канал'), L('канала'), L('каналов')) + ' ' + L('— нажми, чтобы открыть в Telegram') + '</div>';
                items.forEach(function (it) {
                    ...
                    var src = it.source === 'market' ? '<span class="fmx-al-scope market">' + L('Площадка') + '</span>' : '<span class="fmx-al-scope radar">' + L('Радар') + '</span>';
                ...
                b.innerHTML = h;
            }).catch(function () { var b = el('fmx-am-body'); if (b) b.innerHTML = emptyHtml('ti-cloud-off', L('Не загрузилось'), L('Повтори попытку.')); });
        }
        draw();
    }
    function _proofHtml(r) {
        ...
        var lines = '';
        if (r.reach_12h != null) lines += '<div>' + L('Охват за 12 ч:') + ' <b style="color:#5ab0e6;">' + _num(r.reach_12h) + '</b></div>';
        if (r.reach_24h != null) lines += '<div>' + L('Охват за 24 ч:') + ' <b style="color:#5ab0e6;">' + _num(r.reach_24h) + '</b></div>';
        if (r.reach_48h != null) lines += '<div>' + L('Охват за 48 ч:') + ' <b style="color:#5ab0e6;">' + _num(r.reach_48h) + '</b></div>';
        var note;
        if (r.proof_status === 'measured') note = (r.reach_12h == null && r.reach_24h == null && r.reach_48h == null) ? '<div style="color:#8990a8;">' + L('Охват замерить не удалось — пост не в публичной ленте.') + '</div>' : '';
        else note = '<div style="color:#8990a8;">' + L('Замеряем охват — отчёт придёт через 12, 24 и 48 часов.') + '</div>';
        return '<div class="fmx-proof"><div class="fmx-proof-t"><i class="ti ti-chart-line"></i> ' + L('Доказательство размещения') + '</div>' +
    ...
    function calDraw(box, l, mode) {
        ...
        var h = '<div class="fmx-calhead">' +
            ...
            (mode === 'edit' && inHorizon ? '<div class="fmx-tglrow' + (monthOpen ? ' on' : '') + '" id="fmx-mopen" style="margin:2px 0 8px;"><span class="sw"></span><span style="flex:1;">' + L('Месяц открыт для рекламы') + '</span></div>' : '') +
            '<div class="fmx-slgrid">' + [L('Пн'), L('Вт'), L('Ср'), L('Чт'), L('Пт'), L('Сб'), L('Вс')].map(function (w) { return '<span class="fmx-slw">' + w + '</span>'; }).join('');
        ...
        h += '</div>' +
            '<div class="fmx-sleg"><span><i style="background:rgba(93,202,165,0.5);"></i>' + L('свободно') + '</span>' +
            '<span><i style="background:rgba(239,128,128,0.5);"></i>' + L('занято') + '</span>' +
            (r.hot ? '<span><i style="background:rgba(245,191,79,0.6);"></i>' + L('горящие') + ' ' + (r.hot.map ? L('до ') : '') + '−' + r.hot.pct + '%</span>' : '') +
            '<span style="margin-left:auto;">' + freeCount + ' ' + L('своб.') + '</span></div>' +
            (!inHorizon ? '<div class="fmx-slnote"><i class="ti ti-calendar-off"></i><span>' + L('Календарь ведётся на') + ' ' + (r.horizon_days || 180) + ' ' + L('дней вперёд') + '</span></div>'
                : (!monthOpen && mode === 'view' ? '<div class="fmx-slnote"><i class="ti ti-lock"></i><span>' + L('Владелец не открыл этот месяц для продажи') + '</span></div>' : '')) +
            (r.hot && r.hot.days && r.hot.days.length ? '<div class="fmx-slnote" style="color:#f5bf4f;"><i class="ti ti-discount-2"></i><span>' + L('Точечные скидки:') + ' ' + r.hot.days.length + ' ' + _plural(r.hot.days.length, L('дата'), L('даты'), L('дат')) + L(' · до −') + r.hot.pct + '%</span></div>' : '') +
            (r.slots_updated_at ? '<div style="font-size:10px;color:#565b73;margin-top:6px;">' + L('Обновлён') + ' ' + _agoDay(r.slots_updated_at) + '</div>' : '') +
        ...
        if (mode === 'edit') {
            ...
            if (_mo) _mo.addEventListener('click', function () {
                apiPost('/api/v1/marketplace/listings/' + l.id + '/months', { month: mKey, open: !monthOpen }).then(function (rr) {
                    if (!rr || !rr.ok) { _haptic('error'); uiAlert(rr && rr.error === 'forbidden' ? L('Управлять календарём может только владелец оффера') : L('Не удалось изменить месяц')); return; }
                    _haptic('success');
            ...
            qsa(box, '#fmx-calMode [data-cm]').forEach(function (b) {
                b.addEventListener('click', function () {
                    ...
                    if (_cs) _cs.textContent = '@' + (l.username || '') + (hotOn ? L(' — выбери день и назначь скидку, покупатели увидят её жёлтой') : L(' — отмечай занятые дни, покупатели увидят свободные'));
            ...
            b.addEventListener('click', function () {
                ...
                if (mode === 'edit') {
                    if (_ownerCalHot) {
                        ...
                        if (busy[iso] && !_hmap[iso]) { _haptic('error'); uiAlert(L('День занят — на занятые даты скидка не ставится')); return; }
                        var _lim = new Date(); _lim.setDate(_lim.getDate() + (r.horizon_days || 180));
                        if (iso > _isoOf(_lim)) { _haptic('error'); uiAlert(L('Скидку можно назначить максимум на ') + (r.horizon_days || 180) + L(' дней вперёд')); return; }
                ...
                if ((_lsSel.basket || []).some(function (x) { return x.day === iso; })) {
                    _lsSel.day = null; toast(L('Эта дата уже в заявке')); _haptic('light');
                    calDraw(box, l, 'view');
                ...
                var dq = demand[iso];
                toast(dq ? L('Дата выбрана. На неё уже ') + dq + ' ' + _plural(dq, L('запрос'), L('запроса'), L('запросов')) + L(' за неделю')
                         : L('Дата выбрана — кнопка «Написать» обновилась'));
            });
        });
    }
    function _agoDay(iso) {
        try {
            ...
            if (days <= 0) return L(L('сегодня'));
            if (days === 1) return L('вчера');
            return days + ' ' + _plural(days, L('день'), L('дня'), L('дней')) + L(' назад');
        } catch (e) { return ''; }
    }
    function _calToggleDay(box, l, iso) {
        apiPost('/api/v1/marketplace/listings/' + l.id + '/slots/toggle', { day: iso }).then(function (rr) {
            if (!rr || !rr.ok) { _haptic('error'); uiAlert(rr && rr.error === 'forbidden' ? L('Управлять датами может только владелец оффера') : L('Не удалось изменить день')); return; }
            _haptic('light');
            var r = _calData[l.id];
            if (rr.busy) { r.busy.push(iso); } else { r.busy = r.busy.filter(function (x) { return x !== iso; }); }
            r.slots_updated_at = new Date().toISOString();
    ...
    function _calWatchDay(box, l, iso) {
        apiPost('/api/v1/marketplace/listings/' + l.id + '/date_watch', { day: iso }).then(function (rr) {
            if (!rr || !rr.ok) { if (rr && rr.error === 'self') toast(L('Это твой оффер — даты меняются в кабинете'), true); return; }
            var r = _calData[l.id];
            if (rr.on) { (r.watch = r.watch || []).push(iso); toast(L('Сообщим в бота, когда владелец освободит эту дату')); }
            else { r.watch = (r.watch || []).filter(function (x) { return x !== iso; }); toast(L('Слежение за датой снято')); }
            _haptic('light');
            calDraw(box, l, 'view');
        }).catch(function () {});
    }
    ...
    function _peakBlock(l) { var lab = _peakLabel(l); if (!lab) return ''; return '<div class="fmx-peak"><i class="ti ti-chart-line"></i><span>' + L('Час пик просмотров ·') + ' <b>' + lab + '</b></span></div>'; }
    function _termsBlock(l) {
        var em = { advertiser: L('ставит рекламодатель'), channel: L('ставит канал'), discuss: L('обсуждается') };
        var lines = [];
        if (l.erid_who && em[l.erid_who]) lines.push(L('Маркировка (erid) — ') + em[l.erid_who]);
        if (l.rkn_url) lines.push(String(l.rkn_url).indexOf('app:') === 0
            ? L('Подана заявка в перечень РКН — номер в значке на карточке')
            : L('Канал зарегистрирован в перечне РКН — ссылка на запись в значке на карточке'));
        lines.push(L('Оплата напрямую с владельцем канала'));
        lines.push(L('Сделка и отзыв фиксируются в приложении после подтверждения сторонами'));
        return '<div class="fmx-lssect">' + L('Условия размещения') + '</div><div class="fmx-terms">' +
    ...
    function _buyerSlotsHtml(l, r) {
        ...
        var rows = cfg.times.map(function (t) {
            ...
            return '<div class="fmx-tsl' + (isBusy ? ' bs' : (sel ? ' sel' : '')) + (pk ? ' peak' : '') + (hp ? ' hot' : '') + '"' + (isBusy ? '' : ' data-ts="' + tm + '"') + '>' +
                ...
                (pk ? '<span class="fmx-peaktag">' + L('час пик') + '</span>' : '') +
                (hp ? '<span class="fmx-hottag">−' + hp + '%</span>' : '') +
                '<span class="st">' + (isBusy ? L('Занято') : (sel ? L('Выбрано ✓') : L('Свободно'))) + '</span></div>';
        }).join('');
        ...
        var hotHint = (_he && _he.times && _he.times.length)
            ? '<div style="font-size:10px;color:#f5bf4f;margin-bottom:6px;line-height:1.45;"><i class="ti ti-discount-2" style="font-size:11px;"></i> ' + L('Скидка −') + _he.pct + L('% действует на отдельное время — выбери жёлтый слот') + '</div>' : '';
        return '<div class="fmx-tslots"><div class="fmx-tslh"><i class="ti ti-clock"></i> ' + L('Время выхода ·') + ' ' + _fmtDayRu(day) + '</div>' + hotHint + rows + '</div>';
    }
    ...
    function _calModeHtml() {
        return '<div class="fmx-fxw" id="fmx-calMode" style="margin-top:10px;">' +
            '<button class="fmx-fx' + (!_ownerCalHot ? ' on' : '') + '" data-cm="busy"><i class="ti ti-calendar-x"></i> ' + L('Занятость') + '</button>' +
            '<button class="fmx-fx' + (_ownerCalHot ? ' on' : '') + '" data-cm="hot"><i class="ti ti-discount-2"></i> ' + L('Скидки') + '</button></div>';
    }
    function _ownerHotHtml(l, r) {
        var map = (r.hot && r.hot.map) || {};
        var h = '';
        if (!_ownerHotDay) {
            if (!((r.open_months || []).length)) return h + '<div style="font-size:11px;color:#f5bf4f;line-height:1.5;margin-top:9px;">' + L('Сначала открой месяц для рекламы в режиме «Занятость» — скидки назначаются в открытых месяцах.') + '</div>';
            h += '<div style="font-size:11px;color:#8990a8;line-height:1.5;margin-top:9px;">' + L('Выбери свободный день в календаре — назначь скидку на дату и, при желании, на конкретное время. Дни и времена со скидкой покупатель видит жёлтыми, цена в его заявке считается со скидкой автоматически. Горизонт —') + ' ' + ((r && r.horizon_days) || 180) + ' ' + L('дней вперёд.') + '</div>';
            var keys = Object.keys(map).sort();
            if (keys.length) {
                h += '<span class="fmx-lbl fmx-mt2">' + L('Назначено') + '</span><div style="display:flex;flex-direction:column;gap:5px;">' + keys.map(function (d) {
                    var e = map[d];
                    return '<div style="display:flex;align-items:center;gap:8px;font-size:12px;"><span style="color:#f5bf4f;font-weight:800;flex:0 0 44px;">−' + e.pct + '%</span><span>' + _fmtDayRu(d) + '</span>' +
                        (e.times && e.times.length ? '<span style="color:#8990a8;font-size:10.5px;">' + e.times.map(_fmtT).join(', ') + '</span>' : '<span style="color:#565b73;font-size:10.5px;">' + L('весь день') + '</span>') + '</div>';
                }).join('') + '</div>';
            }
            return h;
        }
        ...
        h += '<div style="font-size:12.5px;font-weight:700;margin-top:10px;">' + _fmtDayRu(_ownerHotDay) + (cur ? ' <span style="color:#f5bf4f;font-weight:600;font-size:11px;">' + L('· сейчас −') + cur.pct + '%</span>' : '') + '</div>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Размер скидки') + '</span><div class="fmx-fxw" id="fmx-hotPcts">' + pcts.map(function (p) {
                return '<button class="fmx-fx' + (p === _ownerHotPct ? ' on' : '') + '" data-hp="' + p + '">−' + p + '%</button>';
            }).join('') + '</div>';
        var cfg = _slotCfg(r);
        if (cfg && cfg.times && cfg.times.length) {
            h += '<span class="fmx-lbl fmx-mt2">' + L('Время со скидкой') + '</span><div class="fmx-fxw" id="fmx-hotTimes">' + cfg.times.map(function (t) {
                var tm = _tmin(t.t);
                return '<button class="fmx-fx' + (_ownerHotTimes.indexOf(tm) >= 0 ? ' on' : '') + '" data-ht="' + tm + '">' + _esc(t.t) + '</button>';
            }).join('') + '</div>' +
                '<div style="font-size:10px;color:#565b73;margin-top:4px;">' + L('Не выбрано время — скидка на весь день') + '</div>';
        }
        h += '<div style="display:flex;gap:8px;margin-top:12px;">' +
            (cur ? '<button class="fmx-btn" id="fmx-hotDel" style="color:#f7a58c;border-color:rgba(247,165,140,0.3);">' + L('Убрать скидку') + '</button>' : '') +
            '<button class="fmx-btn" id="fmx-hotSave" style="flex:1;background:#f5bf4f;color:#1c1503;border-color:transparent;font-weight:800;">' + L('Сохранить −') + _ownerHotPct + '%</button></div>';
        return h;
    }
    ...
    function _hotDaySave(box, l, pct) {
        apiPost('/api/v1/marketplace/listings/' + l.id + '/hot-day', {
            ...
            if (!rr || !rr.ok) {
                _haptic('error');
                var m = { forbidden: L('Управлять скидками может только владелец оффера'),
                    out_of_horizon: L('Скидку можно назначить максимум на ') + ((_calData[l.id] || {}).horizon_days || 180) + L(' дней вперёд'),
                    no_slots: L('У оффера не настроены слоты по времени — назначь скидку на весь день'),
                    bad_times: L('Выбранные времена не совпадают со слотами оффера'),
                    month_closed: L('Месяц закрыт для рекламы — открой его в режиме «Занятость»'),
                    day_busy: L('День занят — скидка на проданную дату не ставится') };
                uiAlert(m[rr && rr.error] || L('Не удалось сохранить скидку'));
                return;
            }
            _haptic('success'); toast(pct ? L('Скидка сохранена — покупатели увидят дату жёлтой') : L('Скидка с даты убрана'));
        ...
        }).catch(function () { _haptic('error'); uiAlert(L('Не удалось сохранить')); });
    }
    function _ownerSlotsHtml(l, r) {
        ...
        var h = '<details class="fmx-calguide"><summary><i class="ti ti-help-circle"></i> ' + L('Как пользоваться календарём') + '<i class="ti ti-chevron-down chev"></i></summary><ol>' +
            '<li><b>' + L('Открытые месяцы.') + '</b> ' + L('Покупатели бронируют размещения только в открытых месяцах — включи те, что готов продавать.') + '</li>' +
            '<li><b>' + L('Слоты по времени.') + '</b> ' + L('Отметь времена выхода, которые продаёшь, и сохрани — покупатель выберет свободный слот.') + '</li>' +
            '<li><b>' + L('Занятость.') + '</b> ' + L('Выбери день в календаре и отметь занятые слоты — их нельзя будет забронировать.') + '</li>' +
            '<li><b>' + L('Скидка на дату.') + '</b> ' + L('Задай процент на конкретный день — дата подсветится, а оффер получит бейдж «Горящие даты».') + '</li>' +
            '<li><b>' + L('Час пик') + '</b> ' + L('— подсказка по часам максимальной активности твоей аудитории.') + '</li>' +
            '</ol></details>' +
            '<div class="fmx-tsetup"><div class="fmx-tsh"><i class="ti ti-clock"></i> ' + L('Слоты по времени') + '</div>' +
            '<div class="fmx-tshint">' + L('Отметь времена, в которые продаёшь размещения — покупатель выберет свободный слот.') + '</div>' +
            '<div class="fmx-tchips">' + chips + '</div>' +
            '<div class="fmx-tswrow"><span>' + L('Только 1 выход в сутки') + '<i>' + L('эксклюзив для премиум-каналов') + '</i></span><div class="fmx-tsw2' + (cfg && cfg.one_per_day ? ' on' : '') + '" id="fmx-oneDay"></div></div>';
        if (Object.keys(onSet).length) {
            h += '<button class="fmx-btn fmx-tsave" id="fmx-slotSave"><i class="ti ti-check"></i> ' + L('Сохранить слоты') + '</button>';
            if (_ownerSelDay) {
                var bt = _busyTimes(r);
                var rows = cfg.times.map(function (t) {
                    ...
                    return '<div class="fmx-tsl' + (pk ? ' peak' : '') + '" data-otog="' + tm + '"><span class="tm">' + t.t + '</span>' +
                        (pk ? '<span class="fmx-peaktag">' + L('час пик') + '</span>' : '') +
                        '<span class="st">' + (isBusy ? L('Занято') : L('Свободно')) + '</span>' +
                        '<div class="fmx-osw' + (isBusy ? ' busy' : '') + '"></div></div>';
                }).join('');
                h += '<div class="fmx-tslots" style="margin-top:10px;"><div class="fmx-tslh"><i class="ti ti-calendar"></i> ' + L('Занятость ·') + ' ' + _fmtDayRu(_ownerSelDay) + '</div>' + rows + '</div>';
            }
        } else {
            h += '<button class="fmx-btn fmx-tsave" id="fmx-slotSave"><i class="ti ti-plus"></i> ' + L('Включить слоты по времени') + '</button>';
        }
        return h + '</div>';
    }
    function _saveSlotConfig(box, l) {
        ...
        apiPost('/api/v1/marketplace/listings/' + l.id + '/slots/config', { times: times, one_per_day: oneDay, prime_pct: 0 }).then(function (rr) {
            if (!rr || !rr.ok) { _haptic('error'); uiAlert(L('Не удалось сохранить слоты')); return; }
            _calData[l.id].slot_config = rr.slot_config;
            if (!rr.slot_config) _ownerSelDay = null;
            _haptic('light'); toast(rr.slot_config ? L('Слоты по времени сохранены') : L('Слоты по времени выключены'));
            calDraw(box, l, 'edit');
        }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
    }
        ...
        qsa(box, '.fmx-tsl[data-otog]').forEach(function (b) {
            b.addEventListener('click', function () {
                ...
                apiPost('/api/v1/marketplace/listings/' + l.id + '/slots/time-toggle', { day: _ownerSelDay, tmin: tm }).then(function (rr) {
                    if (!rr || !rr.ok) { _haptic('error'); uiAlert(L('Не удалось изменить слот')); return; }
    ...
    function drawBuyerSlots(box, l) {
        ...
        if (!kept) {
            box.innerHTML = '<div style="display:flex;gap:8px;align-items:flex-start;font-size:11.5px;color:#8990a8;line-height:1.5;">' +
                ...
                '<span>' + L('Владелец не заполнил календарь — уточни даты в сообщении.') + '</span></div>';
            return;
        }
        var busy = {}; (r.busy || []).forEach(function (x) { busy[x] = 1; });
        var demand = r.demand || {};
        ...
        var h = '<div style="display:flex;align-items:center;gap:6px;font-size:11.5px;margin-bottom:9px;">' +
            (freeFrom ? '<span style="color:#5DCAA5;">●</span><span id="fmx-freeFrom" style="color:#5DCAA5;font-weight:600;cursor:pointer;text-decoration:underline dotted rgba(93,202,165,0.5);">' + L('Свободно с') + ' ' + _fmtDayRu(freeFrom) + ' ›</span>' : (!om.length ? '<span style="color:#8990a8;">●</span><span style="color:#8990a8;font-weight:600;">' + L('Владелец пока не открыл даты для продажи') + '</span>' : '<span style="color:#ef8080;">●</span><span style="color:#ef8080;font-weight:600;">' + L('Открытые даты заняты') + '</span>')) +
            (r.slots_updated_at ? '<span style="margin-left:auto;font-size:10px;color:#565b73;">' + L('Обновлён') + ' ' + _agoDay(r.slots_updated_at) + '</span>' : '') + '</div>';
        ...
        h += '</div>' +
            ...
            '<span><i style="display:inline-block;width:8px;height:8px;border-radius:3px;background:rgba(93,202,165,0.5);"></i> ' + L('свободно') + '</span>' +
            '<span><i style="display:inline-block;width:8px;height:8px;border-radius:3px;background:rgba(239,128,128,0.5);"></i> ' + L('занято') + '</span>' +
            (r.hot ? '<span><i style="display:inline-block;width:8px;height:8px;border-radius:3px;background:rgba(245,191,79,0.6);"></i> ' + L('горящие') + ' ' + (r.hot.map ? L('до ') : '') + '−' + r.hot.pct + '%</span>' : '') +
            '<span style="margin-left:auto;">' + L('тап по дню → дата в сообщении') + '</span></div>' +
            '<div id="fmx-buyerExtra">' + _buyerSlotsHtml(l, r) + _basketHtml(l) + '</div>' +
            '<button class="fmx-btn fmx-slmore" id="fmx-calMonth"><i class="ti ti-calendar-month"></i> ' + L('Весь месяц') + '</button>' +
        ...
        qsa(box, '[data-bd]').forEach(function (b) {
            b.addEventListener('click', function () {
                ...
                if (_lsSel.day !== iso) _lsSel.time = null;
                if ((_lsSel.basket || []).some(function (x) { return x.day === iso; })) {
                    _lsSel.day = null; toast(L('Эта дата уже в заявке')); _haptic('light'); _refreshBuyerExtra(box, l); _redrawFullIfOpen(box, l); return;
                }
                _lsSel.day = iso;
                _haptic('light');
        ...
        if (mBtn) mBtn.addEventListener('click', function () {
            ...
            if (open) { full.style.display = 'none'; mBtn.innerHTML = '<i class="ti ti-calendar-month"></i> ' + L('Весь месяц'); }
            else {
                if (!full._ym && freeFrom) full._ym = { y: +freeFrom.slice(0, 4), m: +freeFrom.slice(5, 7) - 1 };
                full.style.display = 'block';
                mBtn.innerHTML = '<i class="ti ti-chevron-up"></i> ' + L('Свернуть месяц');
                calDraw(full, l, 'view');
            }
            _haptic('light');
        });
        ...
        if (ffEl) ffEl.addEventListener('click', function () {
            ...
            full.style.display = 'block';
            var mb = box.querySelector('#fmx-calMonth'); if (mb) mb.innerHTML = '<i class="ti ti-chevron-up"></i> ' + L('Свернуть месяц');
            calDraw(full, l, 'view');
            _haptic('light');
        });
    }
    ...
    function _calWatchBuyer(box, l, iso) {
        apiPost('/api/v1/marketplace/listings/' + l.id + '/date_watch', { day: iso }).then(function (rr) {
            ...
            drawBuyerSlots(box, l);
            if (_wasOpen) { var _f2 = box.querySelector('#fmx-calFull'); if (_f2) _f2.style.display = 'block'; var _mb = box.querySelector('#fmx-calMonth'); if (_mb) _mb.innerHTML = '<i class="ti ti-chevron-up"></i> ' + L('Свернуть месяц'); }
            _redrawFullIfOpen(box, l);
        }).catch(function () {});
    }
    ...
    function renderTablo(json, mount, opts) {
        ...
        if (opts.cut !== false) h += '<div class="fmx-tabmw"><button class="fmx-tabmore">' + L('Развернуть') + '</button></div>' +
            '<button class="fmx-btn fmx-tabless" style="display:none;margin:8px auto 0;"><i class="ti ti-chevron-up"></i> ' + L('Свернуть витрину') + '</button>';
        mount.innerHTML = h;
        ...
        qsa(host, '.fmx-card[data-u], .fmx-li[data-u]').forEach(function (c) {
            c.addEventListener('pointerdown', function () {
                ...
                t = setTimeout(function () {
                    ...
                    if (!ok) el('fmx-peekIn').innerHTML = '<div style="padding:28px 20px;text-align:center;background:#10131f;"><div style="font-size:22px;">🎬</div><div style="font-size:12px;color:#8990a8;margin-top:8px;line-height:1.5;">' + L('Владелец пока не оформил витрину оффера') + '</div></div>';
    ...
    function _writeText() {
        ...
        var t = L('Здравствуйте. Интересует размещение в вашем канале: формат ') + f.fmt;
        if (items.length > 1) {
            t += L('. Интересуют даты: ') + items.map(_slotLabel).join(', ') + '.';
            var anyHot = f.l && items.some(function (x) { return _hotPct(f.l, x.day, x.time) != null; });
            t += f.price ? L(' Ориентир по прайсу ') + _num(f.price) + L(' ₽ за размещение') + (anyHot ? L(' (на части дат действует скидка — итог уточним)') : '') + L('. Подтвердите свободные слоты.') : L(' Пришлите условия размещения.');
        } else if (items.length === 1) {
            var tm = items[0].time != null ? _fmtT(items[0].time) : null;
            t += L(', дата ') + _fmtDayRu(items[0].day) + (tm ? L(', время ') + tm : '');
            ...
            t += f.price ? L(', по прайсу ') + _num(_p1) + ' ₽' + (_hp1 ? L(' (с учётом скидки −') + _hp1 + '%)' : '') + '.' : L('. Пришлите условия размещения.');
            if (f.price) t += L(' Подтвердите, свободн') + (tm ? L(' ли слот') : L('а ли дата')) + '.';
        } else {
            t += f.price ? L(', по прайсу ') + _num(f.price) + ' ₽.' : L('. Пришлите условия размещения.');
            t += L(' Какие даты свободны в ближайшие две недели?');
        }
        return t;
    }
    function _basketHtml(l) {
        ...
        var addBtn = f.day ? '<button class="fmx-baddbtn" id="fmx-badd"><i class="ti ti-plus"></i> ' + L('Добавить ещё дату к заявке') + '</button>' : '';
        if (!chips && !addBtn) return '';
        return '<div class="fmx-basket">' + (chips ? '<div class="fmx-bchips"><span class="fmx-blbl">' + L('Заявка на') + ' ' + ((f.basket || []).length + (f.day ? 1 : 0)) + ':</span>' + chips + '</div>' : '') + addBtn + '</div>';
    }
    function _bindBasket(box, l) {
        ...
        if (addB) addB.addEventListener('click', function () {
            ...
            _haptic('light'); _refreshBuyerExtra(box, l);
            toast(L('Дата добавлена в заявку — выбери ещё или нажми «Написать»'));
        });
    ...
    function openWriteSheet(l) {
        ...
        var _wpHtml = function (full, now) {
            ...
            if (full != null && now < full) {
                ...
                return L(L('По прайсу:')) + ' <s style="color:#565b73;">' + _num(full) + '</s> <b style="color:#f5bf4f;">' + _num(now) + ' ₽</b>' + (_pp ? ' <span style="color:#f5bf4f;font-size:10px;">−' + _pp + '%</span>' : '');
            }
            return L(L('По прайсу:')) + ' <b>' + _num(now) + ' ₽</b>';
        };
        sh.innerHTML = '<div class="grip"></div><h3>' + L('Сообщение владельцу канала') + '</h3>' +
            ...
            '<span>' + L('Дата:') + ' <b id="fmx-wd">' + ((f.basket && f.basket.length) ? (f.basket.length + (f.day ? 1 : 0)) + ' ' + _plural(f.basket.length + (f.day ? 1 : 0), L('дата'), L('даты'), L('дат')) : (f.day ? _fmtDayRu(f.day) + (f.time != null ? ' ' + _fmtT(f.time) : '') : L('уточню в чате'))) + '</b></span>' +
            '<button class="fmx-seg" id="fmx-wchg" style="min-height:28px;padding:4px 10px;">' + L('Изменить') + '</button>' +
            ...
            '<button class="fmx-save" id="fmx-wgo" style="margin-top:10px;"><i class="ti ti-brand-telegram"></i> ' + L('Скопировать и открыть чат') + '</button>' +
            '<button class="fmx-btn" id="fmx-wcopy" style="width:100%;margin-top:8px;">' + L('Скопировать текст') + '</button>' +
            '<div style="font-size:10px;color:#565b73;text-align:center;margin-top:8px;line-height:1.5;">' + L('Текст скопируется — вставь его в чате. Оффер добавится в закладки со статусом «Написал»') + '</div>';
        ...
        el('fmx-wchg').addEventListener('click', function () {
            ...
            toast(L('Выбери свободный день в календаре'));
        });
    ...
    function _initSel(l) {
        ...
        _lsSel = {
            ...
            fmt: (best ? best.fmt : (f0.label || f0.format || L('размещение'))),
    ...
    function _syncWriteBtn(l) {
        ...
        var label = L('Написать');
        if (bn > 0) { var total = bn + (f.day ? 1 : 0); label += ': ' + total + ' ' + _plural(total, L('дата'), L('даты'), L('дат')); }
    ...
    var _TED_STK = ['🚀', '🔥', '💎', '⚡', '🎯', '📈', '💰', '🏆', '⭐', '✅',
        ...
        '🚗', '🏠', '🧸', '🐶', '📰', '🎲', '📦', '🌿'];
    var _TED_BG = [
        { id: 'g1', n: L('Изумруд') }, { id: 'g2', n: L('Ультрафиолет') }, { id: 'mid', n: L('Полночь') },
        { id: 'net', n: L('Сетка') }, { id: 'aur', n: L('Аврора') }, { id: 'coal', n: L('Уголь') },
        { id: 'ocean', n: L('Океан') }, { id: 'sunset', n: L('Закат') }, { id: 'lime', n: L('Лайм') },
        { id: 'rose', n: L('Роза') }, { id: 'steel', n: L('Сталь') }, { id: 'space', n: L('Космос') },
        { id: 'waves', n: L('Волны') }, { id: 'amber', n: L('Янтарь') }
    ];
    ...
    function openTabloEditor(l) {
        ...
        if (!el('fmx-tedBg')) {
            ...
            bg.innerHTML = '<div class="fmx-modal" style="max-width:440px;">' +
                '<div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-layout-collage" style="color:#f5bf4f;"></i> ' + L('Витрина оффера') + '</h2>' +
                '<p>' + L('Свободный холст: перетаскивай, растягивай за угол, поворачивай за верхнюю точку, крестик — удалить') + '</p></div>' +
                '<button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div>' +
    ...
    function _tedPaint() {
        ...
        body.innerHTML =
            '<div class="fmx-tedhelp fmx-tedwhy" style="margin:0 0 12px;"><div class="th"><i class="ti ti-sparkles" style="color:#818cf8;"></i> ' + L('Витрина — презентация твоего оффера') + '</div>' +
            '<div style="font-size:10.5px;line-height:1.6;color:#c9cbe0;">' + L('Закупщик видит её в развороте сразу после метрик. Это твоё рекламное пространство: покажи, почему размещение у тебя окупится.') + '</div>' +
            '<ul>' +
            '<li>' + L('скриншоты статистики: охваты, прирост, вовлечённость;') + '</li>' +
            '<li>' + L('примеры интеграций и их результаты в цифрах;') + '</li>' +
            '<li>' + L('сильные стороны аудитории: гео, платёжеспособность, ниша;') + '</li>' +
            '<li>' + L('форматы, условия, бонус при заказе серии размещений;') + '</li>' +
            '<li>' + L('короткое видео-знакомство с каналом.') + '</li>' +
            '</ul></div>' +
            '<div class="fmx-tedbar">' +
            '<button class="fmx-seg" id="fmx-tedBgBtn"><i class="ti ti-palette"></i> ' + L('Фон') + '</button>' +
            '<button class="fmx-seg" data-tadd="title"><i class="ti ti-h-1"></i> ' + L('Заголовок') + '</button>' +
            '<button class="fmx-seg" data-tadd="text"><i class="ti ti-text-caption"></i> ' + L('Текст') + '</button>' +
            '<button class="fmx-seg" data-tadd="img"><i class="ti ti-photo"></i> ' + L('Фото/гиф') + '</button>' +
            '<button class="fmx-seg" data-tadd="video"><i class="ti ti-video"></i> ' + L('Видео') + '</button>' +
            '<button class="fmx-seg" data-tadd="stk"><i class="ti ti-sticker"></i> ' + L('Стикер') + '</button>' +
            '</div>' +
            ...
            '<button class="fmx-save" id="fmx-tedSave" style="margin-top:12px;"><i class="ti ti-device-floppy"></i> ' + L('Сохранить витрину') + '</button>' +
            '<div style="font-size:10px;color:#565b73;margin-top:7px;line-height:1.5;">' + L('До 12 элементов. Закупщик видит верхнюю половину, остальное — по «Развернуть»') + '</div>' +
            '<div class="fmx-tedhelp"><div class="th"><i class="ti ti-info-circle" style="color:#818cf8;"></i> ' + L('Как оформить витрину') + '</div><ol>' +
            '<li><b>' + L('Фон') + '</b> ' + L('— первая кнопка: 14 готовых градиентов или свой цвет через палитру.') + '</li>' +
            '<li><b>' + L('Добавь элемент') + '</b>' + L(': заголовок, текст, фото/гиф, видео или стикер.') + '</li>' +
            '<li><b>' + L('Стикеры') + '</b> ' + L('— твоя коллекция из бота: отправь боту стикер в личные сообщения, и он появится в списке. Плюс набор эмодзи.') + '</li>' +
            '<li><b>' + L('Тап по элементу') + '</b> ' + L('— выбрать. Перетаскивай прямо пальцем: фон затемнится и появится сетка для ровной расстановки.') + '</li>' +
            '<li><b>' + L('Угловая ручка') + '</b> ' + L('— размер,') + ' <b>' + L('верхняя точка') + '</b> ' + L('— поворот,') + ' <b>' + L('красный крестик') + '</b> ' + L('— удалить. Щипок двумя пальцами: размер и поворот одновременно.') + '</li>' +
            '<li><b>' + L('Три точки под рамкой') + '</b> ' + L('— режим отображения: обычный, «Слияние» (полупрозрачный, вписывается в фон) и «Поверх» (выше всех элементов).') + '</li>' +
            '<li><b>' + L('Повторный тап по выбранному тексту') + '</b> ' + L('— правка надписи; то же делает кнопка «Изменить текст» под холстом.') + '</li>' +
            '<li><b>' + L('Зажми текст на секунду') + '</b> ' + L('— откроется передвижное окно цвета: спектр, оттенок, HEX и RGB; цветовые точки есть и под холстом.') + '</li>' +
            '<li>' + L('Закупщик видит верхнюю половину витрины сразу, остальное — по кнопке «Развернуть». Самое важное размещай сверху.') + '</li>' +
            '<li>' + L('Нажми') + ' <b>' + L('«Сохранить витрину»') + '</b> ' + L('— изменения сразу видны в развороте оффера.') + '</li>' +
            '</ol></div>' +
        ...
        _ted.els.forEach(function (e, i) {
            ...
            if (e.missing) {
                h += '<div class="el med' + sel + ' gone" data-i="' + i + '" style="' + st + 'height:' + (e.h || 18) + '%;">' +
                    '<span class="fmx-tedgone">' + L('Файл недоступен — удали элемент и загрузи заново') + '</span>' + _tedHnd(i) + '</div>';
                return;
            }
    ...
    function _tedHnd(i) {
        ...
        return '<span class="fmx-hnd" data-hz="' + i + '"></span>' +
            ...
            '<button class="fmx-tmd' + (!e.m ? ' on' : '') + '" data-tm="" title="' + L('Обычный') + '"><i></i></button>' +
            '<button class="fmx-tmd' + (e.m === 'b' ? ' on' : '') + '" data-tm="b" title="' + L('Слияние') + '"><i></i></button>' +
            '<button class="fmx-tmd' + (e.m === 't' ? ' on' : '') + '" data-tm="t" title="' + L('Поверх') + '"><i></i></button>' +
            '</span>';
    }
    ...
    function _tedBindPick(idBase, cur, set, title) {
        ...
        if (rb) rb.addEventListener('click', function () {
            openColorStudio(box.getAttribute('data-cur') || cur, function (hex) { set(hex); _tedMarkPick(box, hex); }, title || L('Свой'));
        });
    }
    function _tedRow() {
        ...
        row.innerHTML =
            (isTxt ? '<button class="fmx-btn" id="fmx-tedTxt" style="flex:1;min-width:150px;"><i class="ti ti-pencil"></i> ' + L('Изменить текст') + '</button>' : '') +
            (e.t === 'stk' ? '<button class="fmx-btn" id="fmx-tedStk" style="flex:1;"><i class="ti ti-sticker"></i> ' + L('Сменить стикер') + '</button>' : '') +
        ...
        }, e.t === 'title' ? L('Заголовок') : L('Текст'));
    }
    function _tedEditText(e) {
        _ensureSheets();
        var sh = el('fmx-writeSheet');
        sh.innerHTML = '<div class="grip"></div><h3>' + (e.t === 'title' ? L('Заголовок') : L('Текст')) + ' ' + L('витрины') + '</h3>' +
            ...
            '<button class="fmx-save" id="fmx-tedTaOk" style="margin-top:10px;">' + L('Готово') + '</button>';
    ...
    function _tedBgSheet() {
        ...
        sh.innerHTML = '<div class="grip"></div><h3>' + L('Фон витрины') + '</h3>' +
            '<div class="fmx-tbgw">' +
            '<button class="fmx-tbgc' + (!_ted.bg ? ' on' : '') + '" data-tbg=""><span class="fmx-tbgt"><span class="mini" style="background:linear-gradient(150deg,#131a30,#0c1020 45%,#0e1526 70%,#101a2c);"></span></span><em>' + L('Стандарт') + '</em></button>' +
            ...
            '</div>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Свой цвет фона') + '</span>' + colorPick('fmx-tedbgc', curC || '#0a0d18', 22) +
            '<button class="fmx-save" id="fmx-tedBgOk" style="margin-top:12px;">' + L('Готово') + '</button>';
    ...
    function _tedPickStk(e) {
        ...
        function paint() {
            ...
            var lst = _stickers || [];
            _sheetOwn('sticker');
            sh.innerHTML = '<div class="grip"></div><h3>' + L('Стикер') + '</h3>' +
                '<span class="fmx-lbl fmx-mt2">' + L('Твоя коллекция из бота') + '</span>' +
                (lst.length ? '<div class="fmx-stkgrid" style="margin-top:8px;">' +
                    ...
                    : '<div style="font-size:10.5px;color:#8990a8;line-height:1.5;margin-top:4px;">' + L('Коллекция пуста: отправь боту стикер в личные сообщения — он появится здесь.') + '</div>') +
                '<span class="fmx-lbl fmx-mt2">' + L('Эмодзи') + '</span>' +
                ...
                '<button class="fmx-tabmore" id="fmx-emMore" style="min-height:32px;padding:6px 16px;font-size:10.5px;">' + L('Развернуть') + '</button></div>';
            ...
            if (emb) emb.addEventListener('click', function () {
                ...
                emb.textContent = open ? L('Свернуть') : L('Развернуть');
        ...
        if (_stickers) paint();
            ...
            _sheetOwn('sticker');
            sh.innerHTML = '<div class="grip"></div><h3>' + L('Стикер') + '</h3><div style="font-size:11px;color:#8990a8;padding:14px 0;">' + L('Загружаю коллекцию…') + '</div>';
    ...
    function _tedAdd(t) {
        if (_ted.els.length >= 12) { uiAlert(L('На витрине помещается до 12 элементов — удали лишний.')); return; }
        if (t === 'video' && (_ted.els || []).some(function (e) { return e.t === 'video'; })) {
            uiAlert(L('На витрине допускается одно видео — удали текущее, чтобы загрузить другое.'));
            return;
        }
        if (t === 'img' || t === 'video') { _tedUpload(t); return; }
        if (t === 'stk') { _tedPickStk(null); return; }
        var e;
        if (t === 'title') e = { t: 'title', x: 6, y: 4, w: 70, h: 10, rot: 0, fs: 16, s: L('Заголовок витрины') };
        else e = { t: 'text', x: 6, y: 20, w: 55, h: 12, rot: 0, fs: 11, s: L('Расскажи, что получает рекламодатель') };
        _ted.els.push(e); _ted.sel = _ted.els.length - 1;
    ...
    function _tedUpload(kind) {
        ...
        inp.onchange = function () {
            ...
            if (!f) return;
            if (f.size > MEDIA_MAX_BYTES) { uiAlert(L('Файл ') + Math.round(f.size / 1048576) + L(' МБ — больше лимита. Выбери файл меньше.')); return; }
            var fd = new FormData();
            ...
            toast(L('Загружаю файл…'));
            fetch(base + '/api/v1/marketplace/upload', { method: 'POST', headers: headers, body: fd })
                .then(function (r) { if (!r.ok) return r.json().catch(function () { return {}; }).then(function (j) { throw new Error(j.detail || (L('код ') + r.status)); }); return r.json(); })
                .then(function (j) {
                    if (!j || !j.url) throw new Error(L('сервер не вернул адрес файла'));
                ...
                .catch(function (e3) { uiAlert(L('Не удалось загрузить: ') + e3.message); });
        };
        inp.click();
    }
    var _tedDrag = null;
            ...
            if (hz) {
                ...
                if (e3.t === 'title' || e3.t === 'text') {
                    ...
                    _tedLpT = setTimeout(function () {
                        ...
                        }, e3.t === 'title' ? L('Заголовок') : L('Текст'));
                    }, 480);
                }
            } else {
    ...
    function _tedSave() {
        ...
        apiPost('/api/v1/marketplace/listings/' + _ted.l.id + '/tablo', { els: _ted.els, bg: _ted.bg }).then(function (r) {
            btn.disabled = false;
            if (!r || !r.ok) { _haptic('error'); uiAlert((r && r.error) || L('Не удалось сохранить витрину')); return; }
            _ted.l.expand_content_json = { v: 2, els: _ted.els, bg: _ted.bg };
            _haptic('success');
            toast(r.resubmitted ? L('Витрина отправлена на проверку — оффер вернётся на Площадку после модерации')
                : L('Витрина сохранена — закупщики видят её в развороте оффера'));
            hideModal('fmx-tedBg');
        }).catch(function () { btn.disabled = false; uiAlert(L('Не удалось. Повтори попытку.')); });
    }
    ...
    function openCampaign() {
        ...
        sh.innerHTML = '<div class="grip"></div><h3>' + L('Собрать кампанию под бюджет') + '</h3>' +
            '<div style="font-size:10.5px;color:#8990a8;line-height:1.5;">' + L('Готовый медиаплан из офферов со свободными датами — без ручного перебора') + '</div>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Бюджет, ₽') + '</span>' +
            ...
            '<button class="fmx-seg on" data-n="">' + L('Все ниши') + '</button>' +
            niches.slice(0, 6).map(function (n) { return '<button class="fmx-seg" data-n="' + _esc(n) + '">' + _esc(n) + '</button>'; }).join('') + '</div>' +
            '<button class="fmx-save" id="fmx-cgo" style="margin-top:14px;"><i class="ti ti-calculator"></i> ' + L('Собрать медиаплан') + '</button>' +
            '<div id="fmx-cres"></div>';
        var selN = '';
        ...
        el('fmx-cgo').addEventListener('click', function () {
            ...
            if (!bud || bud < 500) { uiAlert(L('Укажи бюджет от 500 ₽')); return; }
            ...
            apiPost('/api/v1/marketplace/campaign', { budget: Math.min(bud, 100000000), niche: selN || null }).then(function (r) {
                ...
                btn.disabled = false;
                if (!r || !r.ok) { uiAlert((r && r.error) || L('Не удалось собрать план')); return; }
                _haptic('success');
                var t = r.totals || {};
                if (!r.items || !r.items.length) {
                    el('fmx-cres').innerHTML = '<div class="fmx-empty" style="padding:22px 10px;"><i class="ti ti-filter-off"></i><h3>' + L('Под этот бюджет и нишу офферов нет') + '</h3><p>' + L('Попробуй другую нишу или измени бюджет.') + '</p></div>';
                    return;
                }
                el('fmx-cres').innerHTML =
                    ...
                    '<div><div class="l">' + L('Офферов') + '</div><div class="v">' + t.count + '</div></div>' +
                    '<div><div class="l">' + L('Сумма') + '</div><div class="v">' + _num(t.sum) + ' ₽</div></div>' +
                    '<div><div class="l">' + L('Показы') + '</div><div class="v">~' + _num(t.impressions != null ? t.impressions : t.reach) + '</div></div>' +
                    '<div><div class="l">' + L('Ср. CPM') + '</div><div class="v" style="color:#5DCAA5;">' + (t.avg_cpm != null ? _num(t.avg_cpm) + ' ₽' : '—') + '</div></div></div>' +
                    ...
                    r.items.map(function (it) {
                        return '<div style="display:flex;align-items:center;gap:8px;padding:10px 0;border-bottom:0.5px solid rgba(255,255,255,0.05);font-size:11.5px;" class="num">' +
                            ...
                            (it.day ? ' · ' + _fmtDayRu(it.day) : L(' · дата уточняется')) +
                            (it.hot_pct ? ' <span style="color:#f5bf4f;">−' + it.hot_pct + '%</span>' : '') + '</div>' +
                            '<b style="white-space:nowrap;">' + _num(it.price_final) + ' ₽</b></div>';
                    }).join('') + '</div>' +
                    '<div style="font-size:10px;color:#565b73;margin-top:8px;line-height:1.45;">' + L('Остаток бюджета') + ' ' + _num(t.rest) + ' ₽<br>' +
                    L('Показы — сумма просмотров всех размещений. Уникальных людей будет меньше: аудитории каналов одной ниши пересекаются.') + '</div>' +
                    '<div style="display:flex;gap:8px;margin-top:12px;">' +
                    '<button class="fmx-btn" id="fmx-cbm" style="flex:1;">' + L('В закладки весь план') + '</button>' +
                    '<button class="fmx-btn" id="fmx-ccopy" style="flex:1;">' + L('Скопировать план') + '</button></div>';
                el('fmx-cbm').addEventListener('click', function () {
                    ...
                    chain.then(function () {
                        ...
                        toast(L('Все офферы плана добавлены в закладки'));
                    });
                });
                el('fmx-ccopy').addEventListener('click', function () {
                    var lines = [L('План кампании · бюджет ') + _num(bud) + ' ₽'];
                    r.items.forEach(function (it) {
                        lines.push('@' + it.username + ' — ' + it.format + (it.day ? ' — ' + _fmtDayRu(it.day) : '') + ' — ' + _num(it.price_final) + ' ₽');
                    });
                    lines.push(L('Итого: ') + _num(t.sum) + L(' ₽ · показы ~') + _num(t.impressions != null ? t.impressions : t.reach) + L(' · средний CPM ') + (t.avg_cpm != null ? _num(t.avg_cpm) + ' ₽' : '—'));
                    lines.push(L('Показы — сумма просмотров; уникальный охват меньше из-за пересечения аудиторий.'));
                    copyText(lines.join('\n'));
                    toast(L('Скопировано: план кампании'));
                });
            }).catch(function () { btn.disabled = false; uiAlert(L('Не удалось. Повтори попытку.')); });
        });
        el('fmx-shbg').classList.add('on');
    ...
    function toggleCmp(u) {
        ...
        if (_cmp[u]) { delete _cmp[u]; }
            ...
            if (_cmpCount() >= CMP_MAX) { _haptic('error'); toast(L('Можно сравнить не больше ') + CMP_MAX + L(' каналов — сними лишний.')); return; }
            if (!l) { _haptic('error'); toast(L('Не удалось добавить канал к сравнению.')); return; }
            _cmp[u] = l;
        }
        _haptic('light');
    ...
    function drawCmpBar() {
        ...
        if (!n) return;
        bar.innerHTML = '<span class="fmx-cmpn">' + L('Выбрано') + ' ' + n + L(' из ') + CMP_MAX + '</span>' +
            '<button class="fmx-cmpclr" id="fmx-cmpClr">' + L('Сбросить') + '</button>' +
            '<button class="fmx-cmpgo" id="fmx-cmpGo"' + (n < 2 ? ' disabled' : '') + '><i class="ti ti-columns-3"></i> ' +
            (n < 2 ? L('Выбери ещё один') : L('Сравнить')) + '</button>';
    ...
    var CMP_ROWS = [
        { k: 'subs', label: L('Подписчики'), dir: null, get: function (l) { return l.subscribers || null; }, fmt: function (v) { return _num(v); } },
        { k: 'views', label: L('Охват'), dir: 'up', get: function (l) { return l.avg_views || null; }, fmt: function (v) { return '~' + _num(v); } },
        { k: 'er', label: L('ERR'), dir: 'up', get: function (l) { return l.er != null ? l.er : null; }, fmt: function (v) { return (Math.round(v * 10) / 10) + '%'; } },
        { k: 'reach', label: L('Охват к подп.'), dir: 'up', get: _reachRate, fmt: function (v) { return v + '%'; } },
        { k: 'cpm', label: 'CPM', dir: 'down', get: _cpm, fmt: function (v) { return _num(v) + ' ₽'; } },
        { k: 'price', label: L('Цена от'), dir: 'down', get: _minPrice, fmt: function (v) { return _num(v) + ' ₽'; } },
        { k: 'health', label: L('Здоровье'), dir: 'up', get: function (l) { return l.health_score != null ? l.health_score : null; }, fmt: function (v) { return Math.round(v); } }
    ];
    ...
    function openCompare() {
        ...
        h += '</tbody></table></div>' +
            '<div class="fmx-cmpleg"><i class="ti ti-check"></i> ' + L('Лучшее в строке. Подписчиков не отмечаем: размер канала сам по себе не говорит о качестве.') + '</div>' +
    ...
    function _dealTrackHtml() {
        return '<div id="fmx-dealTrk"><button class="fmx-btn" id="fmx-dealTrkGo" style="width:100%;margin-top:8px;color:#5ab0e6;border-color:rgba(90,176,230,0.35);"><i class="ti ti-route"></i> <span>' + L('Ссылка отслеживания в рекламный пост') + '</span></button></div>';
    }
    ...
    function _dealTrackCreate(dealId, channelId) {
        ...
        apiPost('/api/v1/placements/from-deal', body).then(function (r) {
            _trkBusy = false;
            if (!r || r.ok === false) { _haptic('error'); uiAlert((r && r.message) || L('Не удалось. Повтори попытку.')); return; }
            if (r.need_channel) {
                boxT.innerHTML = '<div class="fmx-dealline" style="justify-content:flex-start;margin-top:8px;"><i class="ti ti-route"></i> <span>' + L('В какой канал вести подписчиков?') + '</span></div>' +
            ...
            _haptic('success');
            boxT.innerHTML = '<div class="fmx-proof" style="margin-top:8px;"><div class="fmx-proof-t"><i class="ti ti-route"></i> <span>' + L('Отслеживание готово — запись уже в Трекере') + '</span></div>' +
                '<div style="font-size:11px;color:#8990a8;margin-top:4px;"><span>' + L('Эта ссылка — в рекламный пост: подписки, показы и цена подписчика посчитаются автоматически') + '</span></div>' +
                ...
                '<button class="fmx-btn" id="fmx-trkCopy" style="flex:0 0 auto;padding:6px 10px;"><span>' + L('Скопировать') + '</span></button></div></div>';
            var cp = el('fmx-trkCopy');
            if (cp) cp.addEventListener('click', function () {
                try { navigator.clipboard.writeText(url); } catch (e) {}
                _haptic('light'); toast(L('Ссылка скопирована — вставь её в рекламный пост'));
            });
        }).catch(function () { _trkBusy = false; uiAlert(L('Не удалось. Повтори попытку.')); });
    }
    function _cardDealMark(lid) {
        ...
        apiGet('/api/v1/marketplace/deals/state?listing_id=' + lid).then(function (r) {
            ...
            if (st === 'pending') { toast(L('Сделка уже отмечена — ждём подтверждения владельца')); return; }
            if (st === 'confirmed' || st === 'reviewed') { toast(L('Сделка по этому офферу уже есть — статус в развороте карточки')); return; }
            uiConfirm(L('Отмечай только реальную сделку. Появится ссылка отслеживания для рекламного поста, владелец подтвердит сделку, пройдут автозамеры охвата — и после их завершения засчитаешь сделку в рейтинг кнопкой «Мы провели сделку».'), function () {
                apiPost('/api/v1/marketplace/deals', { listing_id: lid }).then(function (rr) {
                    if (rr && rr.ok === false) { _haptic('error'); uiAlert(rr.error || L('Не удалось')); return; }
                    _haptic('success'); toast(L('Отправлено владельцу на подтверждение'));
                }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
            });
        }).catch(function () { uiAlert(L('Не удалось. Повтори попытку.')); });
    }
    function renderDealBox(l) {
        ...
        apiGet('/api/v1/marketplace/deals/state?listing_id=' + l.id).then(function (r) {
            if (!r || !r.ok) return;
            if (r.state === 'pending') {
                box.innerHTML = '<div class="fmx-dealline"><i class="ti ti-hourglass"></i> ' + L('Сделка отмечена — ждём подтверждения владельца.') + '</div>' + _dealTrackHtml();
                _dealTrackBind(r.deal_id);
            } else if (r.state === 'confirmed' && r.can_complete) {
                box.innerHTML = _proofHtml(r) + '<button class="fmx-save" id="fmx-dealDone" style="margin-top:10px;background:linear-gradient(135deg,#34d399,#5DCAA5);color:#052012;"><i class="ti ti-heart-handshake"></i> ' + L('Мы провели сделку') + '</button>' +
                    '<div style="font-size:10px;color:#565b73;margin-top:6px;line-height:1.5;">' + L('Автозамеры завершены, пост дожил до контрольного срока. Нажатие засчитает сделку в рейтинг оффера и откроет отзыв.') + '</div>';
                el('fmx-dealDone').addEventListener('click', function () {
                    var b = this; b.disabled = true;
                    apiPost('/api/v1/marketplace/deals/' + r.deal_id + '/complete', {}).then(function (rr) {
                        b.disabled = false;
                        if (rr && rr.ok === false) { _haptic('error'); uiAlert(rr.error || L('Не удалось')); return; }
                        _haptic('success'); toast(L('Сделка засчитана — рейтинг оффера обновлён'));
                        _feed = null; _feedState = 'idle';
                        renderDealBox(l);
                    }).catch(function () { b.disabled = false; uiAlert(L('Не удалось. Повтори попытку.')); });
                });
                ...
                box.innerHTML = _proofHtml(r) + _dealTrackHtml() +
                    '<div class="fmx-dealline"><i class="ti ti-radar-2"></i> ' + L('Идёт отслеживание размещения. Зачёт сделки в рейтинг и отзыв откроются после автозамеров — 48 часов после выхода поста.') + '</div>';
                _dealTrackBind(r.deal_id);
            } else if (r.state === 'completed') {
                box.innerHTML = _proofHtml(r) + '<div class="fmx-dealline" style="color:#5DCAA5;"><i class="ti ti-circle-check"></i> ' + L('Сделка проведена — подтверждена автозамерами.') + '</div>' +
                    '<button class="fmx-btn" id="fmx-dealRev" style="width:100%;margin-top:10px;color:#f59e0b;border-color:rgba(245,158,11,0.35);"><i class="ti ti-star"></i> ' + L('Оставить отзыв о сделке') + '</button>';
                el('fmx-dealRev').addEventListener('click', function () { hideModal('fmx-listBg'); openReviewForm(r.deal_id); });
            } else if (r.state === 'reviewed') {
                box.innerHTML = _proofHtml(r) + '<div class="fmx-dealline" style="color:#5DCAA5;"><i class="ti ti-circle-check"></i> ' + L('Сделка проведена, отзыв оставлен.') + '</div>';
            } else {
                box.innerHTML = '<button class="fmx-btn" id="fmx-dealGo" style="width:100%;margin-top:10px;color:#5ab0e6;border-color:rgba(90,176,230,0.35);"><i class="ti ti-heart-handshake"></i> ' + L('Отметить сделку') + '</button>';
    ...
    function renderReviews(l) {
        ...
        apiGet('/api/v1/marketplace/listings/' + l.id + '/reviews').then(function (r) {
            ...
            box.innerHTML = '<div class="fmx-revs"><div class="fmx-revs-t"><i class="ti ti-star-filled" style="color:#f59e0b;"></i> ' + (l.rating_avg || '') + ' · ' + l.reviews_count + ' ' + _plural(l.reviews_count, L('отзыв'), L('отзыва'), L('отзывов')) + '</div>' +
                r.reviews.map(function (rv) {
                    var stars = '★★★★★'.slice(0, rv.rating) + '☆☆☆☆☆'.slice(0, 5 - rv.rating);
                    return '<div class="fmx-rev"><span class="fmx-rev-s">' + stars + '</span> <span style="font-size:9px;font-weight:700;border-radius:99px;padding:2px 7px;background:rgba(93,202,165,0.15);color:#5DCAA5;white-space:nowrap;">' + L('Сделка подтверждена') + '</span>' + (rv.text ? '<span class="fmx-rev-x">' + _esc(rv.text) + '</span>' : '') + '<span class="fmx-rev-a">' + _ago(rv.created_at) + '</span></div>';
                }).join('') + '</div>';
        }).catch(function () {});
    }
    function openReviewForm(dealId) {
        ...
        el('fmx-revBody').innerHTML =
            '<span class="fmx-lbl">' + L('Оценка') + '</span><div class="fmx-fxw" id="fmx-rev-r">' +
            ...
            '<span class="fmx-lbl fmx-mt2">' + L('Пара слов (необязательно)') + '</span><textarea class="fmx-inp" id="fmx-rev-t" rows="3" maxlength="300" placeholder="' + L('Как прошла сделка? Вышел ли пост вовремя, честные ли охваты.') + '"></textarea>' +
            '<button class="fmx-save" id="fmx-rev-send" style="margin-top:14px;opacity:0.5;" disabled><i class="ti ti-send"></i> ' + L('Поставь оценку') + '</button>';
        qsa(el('fmx-rev-r'), '[data-rv]').forEach(function (b) { b.addEventListener('click', function () { sel.v = +b.getAttribute('data-rv'); qsa(el('fmx-rev-r'), '.fmx-fx').forEach(function (x) { x.classList.remove('on'); }); b.classList.add('on'); var sb = el('fmx-rev-send'); if (sb) { sb.disabled = false; sb.style.opacity = '1'; sb.innerHTML = '<i class="ti ti-send"></i> ' + L('Отправить отзыв'); } }); });
        el('fmx-rev-send').addEventListener('click', function () {
            ...
            apiPost('/api/v1/marketplace/deals/' + dealId + '/review', { rating: sel.v, text: el('fmx-rev-t').value }).then(function (r) {
                btn.disabled = false;
                if (r && r.ok === false) { _haptic('error'); uiAlert(r.error || L('Не удалось')); return; }
                _haptic('success'); hideModal('fmx-revBg'); toast(L('Отзыв отправлен'));
                _feed = null; _feedState = 'idle';
            }).catch(function () { btn.disabled = false; uiAlert(L('Не удалось. Повтори попытку.')); });
        });
        showModal('fmx-revBg');
    ...
    function openReqForm() {
        ...
        el('fmx-reqBody').innerHTML =
            '<span class="fmx-lbl">' + L('Ниша каналов') + '</span><input class="fmx-inp" id="fmx-rq-niche" maxlength="64" placeholder="' + L('например, Биохакинг') + '">' +
            '<span class="fmx-lbl fmx-mt2">' + L('Бюджет, ₽ (необязательно)') + '</span><input class="fmx-inp" id="fmx-rq-budget" type="number" min="0" step="500" placeholder="' + L('например, 15000') + '">' +
            '<span class="fmx-lbl fmx-mt2">' + L('Формат размещения') + '</span><div class="fmx-fxw" id="fmx-rq-fmt">' + fchips + '</div>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Что рекламируем и требования') + '</span><textarea class="fmx-inp" id="fmx-rq-text" rows="4" maxlength="500" placeholder="' + L('Продукт, гео аудитории, пожелания к каналам. Минимум 20 символов.') + '"></textarea>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Контакт для связи') + '</span><div class="fmx-chbtn" style="cursor:text;"><span style="color:#8990a8;">@</span><input class="fmx-inp" id="fmx-rq-contact" style="border:none;background:transparent;padding:0 0 0 4px;flex:1;" maxlength="64" value="' + _esc(uname) + '" placeholder="username"></div>' +
            '<div style="font-size:10px;color:#565b73;line-height:1.5;margin-top:8px;">' + L('Заявка видна всем владельцам каналов — они напишут на указанный контакт. Максимум 3 активных заявки. Правила площадки действуют и здесь.') + '</div>' +
            '<button class="fmx-save" id="fmx-rq-send" style="margin-top:14px;"><i class="ti ti-send"></i> ' + L('Опубликовать заявку') + '</button>';
        var fsel = { v: 'any' };
        ...
        el('fmx-rq-send').addEventListener('click', function () {
            ...
            if (bad) {
                ...
                bad.insertAdjacentHTML('afterend', '<div id="fmx-rq-hint" style="font-size:10.5px;color:#ef4444;margin-top:5px;">' + (bad === txtEl ? L('Опиши задачу подробнее — минимум 20 символов.') : L('Укажи @username — сюда будут писать владельцы каналов.')) + '</div>');
                bad.focus();
                return;
            }
            var btn = this; btn.disabled = true;
            apiPost('/api/v1/marketplace/requests', {
                ...
                btn.disabled = false;
                if (r && r.ok === false) { _haptic('error'); uiAlert(r.error || L('Не удалось опубликовать')); return; }
                _haptic('success'); hideModal('fmx-reqBg'); toast(L('Заявка размещена'));
                _reqs = null; _reqState = 'idle'; renderSell();
            }).catch(function () { btn.disabled = false; uiAlert(L('Не удалось опубликовать. Повтори попытку.')); });
        });
        showModal('fmx-reqBg');
    }
    ...
    function renderCreate() {
        var sub = el('fmx-sub'); if (!sub) return;
        sub.innerHTML = '<div class="fmx-load"><i class="ti ti-loader-2"></i><div style="font-size:12px;margin-top:10px;">' + L('Загружаю конструктор…') + '</div></div>';
        Promise.all([loadChannels(), loadMyListings()]).then(function () {
            var pubs = _channels.filter(function (c) { return c.username; });
            if (!pubs.length) { sub.innerHTML = emptyHtml('ti-plus', L('Нет подходящих каналов'), L('Чтобы выставить канал на Площадку, у него должен быть публичный @username. Добавь или настрой канал в приложении.')); return; }
            var def = null;
            if (_mineEditCh != null) {
            ...
            sub.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить конструктор'), L('Проверь связь и повтори попытку.'));
        });
    }
    ...
    function hydrate(l) {
        ...
        ['cover', 'avatar', 'cardbg'].forEach(function (k) {
            ...
            _ss._media[k] = { url: mediaAbs(srvUrl), kind: kk, name: a.name || L('файл на сервере') };
        });
    ...
    function curChannel() { return channelById(_ss.channelId) || { title: L('Твой канал'), username: 'your_channel', subscribers: null }; }
    ...
    function paintCreate() {
        ...
        var rows = _chSortForPicker(_channels, function (cid) { return !!listingForChannel(cid); }).map(function (c) {
            ...
            var ok = pub && !paused;
            var sub2 = !pub
                ? '<div class="fmx-chuu">' + L('приватный — нужен публичный @username') + '</div>'
                : (paused
                    ? '<div style="margin-top:2px;"><span style="display:inline-flex;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#f5bf4f;background:rgba(245,191,79,0.1);border:0.5px solid rgba(245,191,79,0.35);border-radius:99px;padding:2px 8px;white-space:nowrap;"><i class="ti ti-player-pause" style="font-size:10px;"></i>' + L('На паузе') + '</span></div>'
                    : '<div class="fmx-chuu">@' + _esc(c.username) + '</div>');
            return '<div class="fmx-chrow' + (c.id === _ss.channelId ? ' sel' : '') + (ok ? '' : ' dis') + '" data-cid="' + c.id + '" data-pub="' + (pub ? 1 : 0) + '" data-paused="' + (paused ? 1 : 0) + '"><div class="fmx-chav"' + (ok ? '' : ' style="background:rgba(255,255,255,0.08);color:#8990a8;"') + '>' + (c.avatar_url ? '<img src="' + mediaAbs(c.avatar_url) + '" style="width:100%;height:100%;object-fit:cover;border-radius:inherit;">' : _esc((c.title || c.username || '?').charAt(0))) + '</div><div style="flex:1;min-width:0;"><div class="fmx-chtt">' + _esc(c.title || (pub ? '@' + c.username : L('Канал'))) + '</div>' + sub2 + '</div>' + (ok ? (listingForChannel(c.id) ? '<i class="ti ti-circle-check-filled" style="color:#5DCAA5;flex-shrink:0;"></i>' : '') : (paused ? '' : '<i class="ti ti-lock" style="color:#565b73;flex-shrink:0;"></i>')) + '</div>';
        }).join('');
        sub.innerHTML =
            '<div class="fmx-hero" id="fmx-hero"></div>' +
            '<div style="font-size:10px;color:#565b73;text-align:center;margin:8px 0 10px;line-height:1.35;"><i class="ti ti-hand-click"></i> ' + L('Нажми на часть оффера, чтобы изменить его') + '</div>' +
            '<button class="fmx-btn" id="fmx-resetAll" style="width:100%;margin:0 0 12px;color:#8990a8;"><i class="ti ti-restore"></i> ' + L('Сброс настроек') + '</button>' +
            '<div id="fmx-hlist" style="margin:-4px 0 16px;"></div>' +
            '<div class="fmx-chdd" id="fmx-chdd"><button class="fmx-chbtn" id="fmx-chbtn" type="button"><i class="ti ti-broadcast lead"></i><span style="flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">' + _esc(cur ? ('@' + cur.username + (cur.title ? ' · ' + cur.title : '')) : L('Выбери канал')) + '</span><i class="ti ti-chevron-down chev"></i></button><div class="fmx-chlist">' + rows + '</div></div>' +
            (function () {
                if (!existing) return '<div class="fmx-chnote">' + L('Новое размещение для этого канала') + '</div>';
                var ms = existing.moderation_status || '';
                if (existing.status === 'rejected') return '<div class="fmx-chnote" style="color:#ef8080;border:0.5px solid rgba(239,68,68,0.3);border-radius:10px;padding:9px 12px;">' + L('Оффер отклонён') + (existing.reject_reason ? ': ' + _esc(existing.reject_reason) : '') + '<br>' + L('Исправь и нажми «Сохранить оффер» — он уйдёт на повторную проверку.') + '</div>';
                if (existing.status === 'pending' && (ms === 'needs_review' || ms === 'complaints_hold')) return '<div class="fmx-chnote" style="color:#f5bf4f;border:0.5px solid rgba(245,191,79,0.3);border-radius:10px;padding:9px 12px;"><span>' + L('Оффер на ручной проверке — это не блокировка') + '</span>' + (existing.reject_reason ? '. <span>' + _esc(existing.reject_reason) + '</span>' : '') + '<br>' + L('Проверим и опубликуем — обычно до суток.') + '</div>';
                if (existing.status === 'published') return '<div class="fmx-chnote">' + L('Оффер опубликован на Площадке. Правки после сохранения пройдут быструю проверку и обновят карточку.') + '</div>';
                if (existing.status === 'paused') return '<div class="fmx-chnote">' + L('Оффер заморожен и скрыт с Площадки. Правки сохранятся — вернуть его можно в «Мои офферы».') + '</div>';
                if (ms === 'pending' || existing.status === 'review') return '<div class="fmx-chnote">' + L('Оффер на проверке. Правки добавятся к текущей заявке.') + '</div>';
                return '<div class="fmx-chnote">' + L('Редактируешь существующий оффер этого канала.') + '</div>';
            })() +
            accSec('cover', 'ti-photo', L('Обложка'), paneCover()) +
            accSec('fx', 'ti-sparkles', L('Эффекты и анимация'), paneFx()) +
            accSec('sticker', 'ti-sticker', L('Стикер'), '<div id="fmx-stkBody">' + loadHtml() + '</div>') +
            accSec('style', 'ti-palette', L('Стиль'), paneStyleMin()) +
            accSec('price', 'ti-cash', L('Форматы и цены'), panePrice()) +
            accSec('text', 'ti-text-caption', L('Текст'), paneText()) +
            '<button class="fmx-save" id="fmx-save" style="margin-top:18px;"><i class="ti ti-rocket"></i> ' + (_ss.listingId ? L('Сохранить оффер') : L('Опубликовать на Площадке')) + '</button>' +
            '<div class="fmx-tplink" data-terms="s"><i class="ti ti-clipboard-text"></i> <span>' + L('Условия размещения') + '</span></div>' +
            (_ss.listingId ? '<button class="fmx-btn" id="fmx-toMine" style="width:100%;margin-top:10px;"><i class="ti ti-briefcase"></i> ' + L('Кабинет «Мои офферы»') + '</button>' : '') +
            ...
            '<div class="fmx-savenote">' + L('После публикации оффер пройдёт проверку по смыслу. Опции с замком применяются при активном продвижении на 30 дней.') + '</div>';
        var dd = el('fmx-chdd');
        el('fmx-chbtn').addEventListener('click', function (e) { e.stopPropagation(); dd.classList.toggle('on'); });
        qsa(dd, '.fmx-chrow').forEach(function (r) { r.addEventListener('click', function () { if (r.getAttribute('data-pub') !== '1') { toast(L('Нужен публичный @username — включи его в настройках канала в Telegram')); return; } if (r.getAttribute('data-paused') === '1') { toast(L('Канал на паузе. Сними паузу в настройках канала, чтобы разместить оффер.')); return; } dd.classList.remove('on'); _haptic('light'); selectChannel(+r.getAttribute('data-cid')); }); });
        ...
        if (ra) ra.addEventListener('click', function () {
            uiConfirm(L('Сбросить все настройки оформления к стандартным? На Площадке изменения появятся после сохранения оффера.'), function () {
                ...
                _haptic('success'); toast(L('Настройки сброшены к стандартным'));
                paintCreate();
            });
        });
        loadStickerPane();
        ...
        window.__fmxCdDock = _fmxBuildCardDock({
            ...
            sections: [['cover', L('Обложка')], ['fx', L('Эффекты')], ['sticker', L('Стикер')], ['style', L('Стиль')], ['price', L('Цены')], ['text', L('Текст')]],
    ...
    function mediaBoxHtml(target, hint) {
        ...
        var row = m
            ? '<div class="fmx-note fmx-gr" style="margin-bottom:9px;"><i class="ti ' + (m.kind === 'video' ? 'ti-video' : 'ti-photo-check') + '"></i> ' + _esc(m.name || L('файл выбран')) + '</div>' +
              '<div class="fmx-uplrow"><button class="fmx-upl" data-mp="' + target + '"><i class="ti ti-refresh"></i> ' + L('Заменить') + '</button>' +
              '<button class="fmx-upl sec" data-me="' + target + '"><i class="ti ti-crop"></i> ' + L('Кадрирование') + '</button>' +
              '<button class="fmx-upl sec" data-md="' + target + '"><i class="ti ti-trash"></i></button></div>'
            : '<button class="fmx-upl" data-mp="' + target + '"><i class="ti ti-cloud-upload"></i> ' + L('Выбрать файл') + '</button>';
    ...
    function paneCover() {
        var seg = '<div class="fmx-mtabs" id="fmx-covtype">' +
            '<button class="fmx-mt' + (_ss.covType === 'grad' ? ' on' : '') + '" data-ct="grad"><i class="ti ti-color-swatch"></i> ' + L('Градиент') + '</button>' +
            '<button class="fmx-mt' + (_ss.covType !== 'grad' ? ' on' : '') + '" data-ct="img"><i class="ti ti-cloud-upload"></i> ' + L('Загрузить') + '</button></div>';
        var custom = !!_ss.coverGrad;
        var grads = '<div id="fmx-gradbox" style="' + (_ss.covType === 'grad' ? '' : 'display:none;') + '"><span class="fmx-lbl">' + L('Фон обложки') + '</span><div class="fmx-grads" id="fmx-grads">' +
            ...
            '<div class="fmx-gd fmx-dot-rb' + (custom ? ' on' : '') + '" data-grb="1" title="' + L('Свой градиент') + '"></div></div>' +
    ...
    function paneFx() {
        return '<div class="fmx-fxg"><div class="fmx-fxl vipc">' + L('Свечение оффера') + ' <i class="ti ti-lock"></i></div>' +
            '<div class="fmx-fxlock">' + L('Золотое свечение карточки в ленте. Доступно при любом продвижении — с замком можно примерить в предпросмотре.') + '</div>' +
            '<div class="fmx-fxw" id="fmx-glowcard">' +
            '<button class="fmx-fx' + (!_ss.glowCard ? ' on' : '') + '" data-gc="off">Выключено</button>' +
            '<button class="fmx-fx vip' + (_ss.glowCard ? ' on' : '') + '" data-gc="on"><i class="ti ti-lock"></i>' + L('Золотое свечение') + '</button>' +
            '</div></div>' +
            '<div class="fmx-fxg"><div class="fmx-fxl vipc">' + L('Кнопки карточки') + ' <i class="ti ti-lock"></i></div>' +
            '<div class="fmx-fxlock">' + L('Стекло — при продвижении от недели. «Все — в цвет» красит три кнопки выбранным цветом, доступно всем.') + '</div>' +
            '<div class="fmx-fxw" id="fmx-btnstyle">' +
            (function () {
                var cur = _ss.glass !== 'none' ? _ss.glass : (_ss.btns === 'accent' ? 'accent' : 'std');
                return [['std', L('Стандарт'), 0], ['frost', L('Матовое стекло'), 1], ['dark', L('Дымка'), 1], ['accent', L('Все — в цвет'), 0]].map(function (o) {
                    return '<button class="fmx-fx' + (cur === o[0] ? ' on' : '') + (o[2] ? ' vip' : '') + '" data-bs="' + o[0] + '">' + (o[2] ? '<i class="ti ti-lock"></i>' : '') + o[1] + '</button>';
                }).join('');
            })() +
            '</div></div>' +
            '<div style="margin-top:10px;">' +
            '<div style="font-size:10.5px;color:#8990a8;margin-bottom:2px;">' + L('Бейдж «Продвигается»') + ' <i class="ti ti-lock" style="font-size:10px;color:#f5bf4f;"></i></div>' +
            '<div class="fmx-fxlock" style="margin:0 0 6px;">' + L('Только при продвижении «Месяц в ленте»') + '</div>' +
            ...
            '</div>' +
            '<div style="font-size:10.5px;color:#8990a8;margin:8px 0 2px;">' + L('Расположение бейджа') + '</div>' +
    ...
    function paneStyleMin() {
        return '<span class="fmx-lbl">' + L('Цвет кнопки') + '</span>' + colorPick('fmx-colors', _ss.color) +
            '<span class="fmx-lbl fmx-mt2">' + L('Шрифт заголовка') + '</span><div class="fmx-mtabs" id="fmx-font">' +
            FONTS.map(function (f) { return '<button class="fmx-mt' + (f[0] === _ss.font ? ' on' : '') + '" data-f="' + f[0] + '">' + f[1] + '</button>'; }).join('') + '</div>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Фон оффера') + '</span>' +
            '<div id="fmx-bodybox">' + mediaBoxHtml('cardbg', L('Картинка-фон — доступна всем. GIF и MP4-анимация — только при продвижении «Месяц в ленте». Подложка под цифрами затемняется автоматически, читаемость не страдает.')) + '</div>';
    }
    function hslHex(h) {
    ...
    function colorPick(idBase, cur, sz) {
        ...
        return '<div class="fmx-dots" id="' + idBase + '" data-cur="' + _esc(cur) + '">' +
            ...
            '<div class="fmx-dot fmx-dot-rb' + (custom ? ' on' : '') + '" data-rb="1" style="' + st + (custom ? 'box-shadow:0 0 0 2px ' + cur + ';' : '') + '" title="' + L('Свой цвет') + '"></div></div>';
    }
    function bindColorPick(idBase, set, title) {
        ...
        if (rb) rb.addEventListener('click', function () {
            openColorStudio(box.getAttribute('data-cur') || '#5DCAA5', function (hex) { set(hex); mark(hex); _liveAccent(hex); _heroDebounced(); }, title || L('Свой'));
        });
    }
    ...
    function openColorStudio(cur, onPick, title) {
        ...
        bg.innerHTML = '<div class="fmx-cfm-box" id="fmx-cp-box">' +
            '<div class="fmx-cp-head" id="fmx-cp-head"><div class="fmx-cp-pt">' + L('Цвет:') + ' <b>' + (title || L('Свой')) + '</b></div>' +
            '<div style="display:flex;gap:6px;"><button class="fmx-cp-x" id="fmx-cp-mode" title="' + L('Стиль палитры') + '">⇄</button><button class="fmx-cp-x" id="fmx-cp-close" aria-label="' + L('Закрыть') + '">✕</button></div></div>' +
            ...
            '<div class="fmx-cp-cap" id="fmx-cp-huecap" style="text-align:left;margin:10px 0 3px;">' + L('Оттенок') + '</div>' +
        ...
        function setMode(m) {
            ...
            var hc = el('fmx-cp-huecap'); if (hc) hc.textContent = m === 'spec' ? L('Насыщенность') : L('Оттенок');
            draw(); sync();
        }
    ...
    function bindStyle() {
        bindColorPick('fmx-colors', function (v) { _ss.color = v; }, L('Цвет кнопки'));
        ...
        qsa(el('fmx-main'), '[data-fxg]').forEach(function (g) { var key = g.getAttribute('data-fxg'); qsa(g, '.fmx-fx').forEach(function (b) { b.addEventListener('click', function () { _ss[key] = b.getAttribute('data-v'); qsa(g, '.fmx-fx').forEach(function (x) { x.classList.remove('on'); }); b.classList.add('on'); renderHero(); sizePanes(); }); }); });
        ...
        qsa(el('fmx-btnstyle'), 'button').forEach(function (b) {
            b.addEventListener('click', function () {
                var v = b.getAttribute('data-bs');
                if (v === 'frost' || v === 'dark') { _ss.glass = v; _ss.btns = 'std'; }
                else if (v === 'accent') { _ss.glass = 'none'; _ss.btns = 'accent'; }
                else { _ss.glass = 'none'; _ss.btns = 'std'; }
                qsa(el('fmx-btnstyle'), 'button').forEach(function (x) { x.classList.remove('on'); });
                b.classList.add('on');
                _haptic('light'); renderHero();
            });
        });
    ...
    function _fmtTile(f, i, av) {
        ...
        if (f.base) title += '<span class="fmx-ftbase">' + L('база') + '</span>';
    ...
    function panePrice() {
        var note = '<div class="fmx-note" style="margin-top:6px;"><i class="ti ti-bulb"></i><span>' + L('Нотация') + ' <b>X/Y</b> ' + L('— часов в топе / часов в ленте. Цену задаёшь сам,') + ' <b>CPM</b> ' + L('считается от охвата канала; верхний CPM оффера — по формату 1/24.') + '</span></div>';
        var eridOpts = [['advertiser', L('Ставит рекламодатель')], ['channel', L('Ставит канал')], ['discuss', L('Обсуждается')]];
        var erid = '<span class="fmx-lbl fmx-mt2"><i class="ti ti-tag"></i> ' + L('Маркировка рекламы (erid)') + '</span>' +
            ...
            '<div class="fmx-note" style="margin-top:6px;"><i class="ti ti-info-circle"></i><span>' + L('Выбор — чья сторона регистрирует креатив в ОРД и получает erid. Токен выдаётся на каждое размещение отдельно и вносится при маркировке поста; постоянного erid у канала не существует.') + '</span></div>';
        var rkn = '<span class="fmx-lbl fmx-mt2"><i class="ti ti-shield-check"></i> ' + L('Перечень РКН') + '</span>' +
            '<input type="url" class="fmx-inp" id="fmx-rkn" maxlength="200" placeholder="https://knd.gov.ru/license?id=…" value="' + _esc(_ss._rkn || '') + '">' +
            '<div class="fmx-note" style="margin-top:6px;"><i class="ti ti-info-circle"></i><span>' + L('Для каналов от 10 000 подписчиков. Вставь ссылку на запись канала в перечне РКН (knd.gov.ru) — на оффере появится значок «Зарегистрирован в РКН» со ссылкой для проверки закупщиком.') + '</span></div>';
        var ins = '<span class="fmx-lbl fmx-mt2"><i class="ti ti-chart-line"></i> ' + L('Аналитика в витрине') + '</span>' +
            '<div class="fmx-htog" id="fmx-hideIns"><div class="fmx-htl">' + L('Показывать час пик и рекл. охват') + '<i>' + (_ss._hideInsights ? L('Скрыто · видно только тебе') : L('Считает площадка по метрикам канала')) + '</i></div><div class="fmx-hsw' + (_ss._hideInsights ? '' : ' on') + '"></div></div>';
        return '<span class="fmx-lbl">' + L('Что продаёшь и почём') + '</span><div id="fmx-fmts">' + fmtRows() + '</div>' + note + erid + rkn + ins;
    }
    ...
    function bindPrice() {
        ...
        if (hi) hi.addEventListener('click', function () {
            ...
            var sub = hi.querySelector('.fmx-htl i'); if (sub) sub.textContent = _ss._hideInsights ? L('Скрыто · видно только тебе') : L('Считает площадка по метрикам канала');
        });
        var rk = el('fmx-rkn');
        if (rk) {
            ...
            rk.addEventListener('blur', function () {
                ...
                if (v && v.indexOf('https://knd.gov.ru/') !== 0 && !/^(?:app:|№)?\s*\d{8,12}$/.test(v)) {
                    toast(L('Укажи ссылку на запись в перечне РКН (knd.gov.ru) или номер заявки'));
                }
            });
        }
    }
    ...
    function paneText() {
        return '<span class="fmx-lbl">' + L('О канале (видно при «Развернуть»)') + '</span><textarea class="fmx-inp" id="fmx-desc" maxlength="200" placeholder="' + L('Чем хорош канал и какая аудитория…') + '">' + _esc(_ss._desc || '') + '</textarea>' +
            '<span class="fmx-lbl fmx-mt2">' + L('Теги (через запятую)') + '</span><input class="fmx-inp" id="fmx-tags" value="' + _esc(_ss._tags || '') + '" maxlength="60" placeholder="' + L('ниша, тема, аудитория') + '">';
    }
    function bindText() {
    ...
    function pickMedia(target) {
        ...
        inp.addEventListener('change', function () {
            ...
            if (target === 'avatar' && !isImg) { uiAlert(L('Для аватара подойдёт только фото или GIF.')); return; }
            if (!isImg && !isVid) { uiAlert(L('Можно загрузить только фото (JPG, PNG, WebP, GIF) или видео (MP4, MOV). Этот файл не подходит.')); return; }
            if (fl.size > MEDIA_MAX_BYTES) { uiAlert(L('Файл больше 64 МБ — сожми его или выбери другой.')); return; }
            ...
            if (kind === 'video') {
                ...
                v.onloadedmetadata = function () {
                    if (v.duration > 30.5) { uiAlert(L('Видео длиннее 30 секунд — сократи ролик до 30 сек.')); URL.revokeObjectURL(url); return; }
                    startCrop(target, url, kind, fl.name, 50, 50, 1, fl);
                };
                v.onerror = function () { uiAlert(L('Не удалось прочитать видео.')); URL.revokeObjectURL(url); };
                v.src = url;
    ...
    function startCrop(target, url, kind, name, x, y, s, file) {
        ...
        box.innerHTML = (kind === 'video' ? '<video src="' + url + '" autoplay muted loop playsinline></video>' : '<img src="' + url + '">') +
            (target === 'cover' ? '<div class="fmx-safeT"></div><div class="fmx-safeB"></div><div class="fmx-safeF"><span>' + L('Зона шапки — видна на 100%') + '</span></div>' : '') +
            (target === 'cardbg' ? '<div class="fmx-safeT"></div><div class="fmx-safeB"></div><div class="fmx-safeF"><span>' + L('Зона оффера — видна на 100%') + '</span></div>' : '') +
            (target === 'avatar' ? '<div class="fmx-safeR"></div>' : '');
        el('fmx-cropHint').textContent = target === 'avatar' ? L('Пунктирный контур — видимая зона аватара, углы срежутся скруглением.') : (target === 'cardbg' ? L('Пунктирная полоса — видимая часть тела оффера. Цифры затемняются подложкой автоматически.') : L('Пунктирная полоса — то, что видно в шапке оффера. Затемнённое сверху и снизу в шапку не попадает.'));
    ...
    function stkOverlay(s, W, animate, draggable, head) {
        ...
        var modeDots = '<div class="fmx-stkmodes">' + [['blend', L('Слияние')], ['bg', L('Задний фон')]].map(function (m) {
            return '<button class="fmx-stkmd' + (dm === m[0] ? ' on' : '') + '" data-stkmd="' + m[0] + '" data-stkmdn="' + m[1] + '" title="' + m[1] + '"><i></i></button>';
        }).join('') + '</div>';
        return core + '<div class="fmx-stkGrab' + selCls + '" id="fmx-stkGrab" style="' + boxSt + '" title="' + L('Перемещение, размер, поворот') + '"><i class="fmx-stkh rot" title="' + L('Крутить') + '"></i><i class="fmx-stkh rsz" title="' + L('Размер') + '"></i><i class="ti ti-x fmx-stkh del" title="' + L('Убрать с оффера') + '"></i>' + modeDots + '</div>';
    }
    var _lotLibs = null;
    function _script(u) {
    ...
    function loadPendingDeals() {
        ...
        apiGet('/api/v1/marketplace/deals/mine').then(function (r) {
            ...
            var who = function (d) { return d.buyer_username ? '@' + _esc(d.buyer_username) : L('Рекламодатель'); };
            var html = '<div class="fmx-pend">';
            if (pend.length) {
                html += '<div class="fmx-pend-t"><i class="ti ti-heart-handshake" style="color:#f59e0b;"></i> ' + L('Подтверждение сделок') + '</div>' +
                    pend.map(function (d) {
                        return '<div class="fmx-pend-r" data-did="' + d.deal_id + '"><span>' + who(d) + ' · ' + _ago(d.created_at) + '</span>' +
                            '<span style="display:flex;gap:6px;"><button class="fmx-btn" data-dacc="' + d.deal_id + '" style="padding:6px 11px;color:#5DCAA5;border-color:rgba(93,202,165,0.35);"><i class="ti ti-check"></i>' + L('Да') + '</button>' +
                            '<button class="fmx-btn" data-ddec="' + d.deal_id + '" style="padding:6px 11px;"><i class="ti ti-x"></i>' + L('Нет') + '</button></span></div>';
                    }).join('') +
                    '<div style="font-size:10px;color:#565b73;margin:6px 0;">' + L('Подтверждай только реальные сделки: счётчик — твоя репутация.') + '</div>';
            }
            if (conf.length) {
                html += '<div class="fmx-pend-t" style="margin-top:' + (pend.length ? '12px' : '0') + ';"><i class="ti ti-chart-line" style="color:#5ab0e6;"></i> ' + L('Размещение и охват') + '</div>' +
                    conf.map(function (d) {
                        if (!d.proof_status) {
                            return '<div class="fmx-plc"><div style="font-size:11.5px;color:#c9cbe0;">' + who(d) + ' ' + (window.t ? window.t('— отметь вышедший рекламный пост') : L('— отметь вышедший рекламный пост')) + '</div>' +
                                '<div style="display:flex;gap:6px;margin-top:6px;"><input class="fmx-inp fmx-plc-in" placeholder="' + L('https://t.me/канал/123') + '"><button class="fmx-btn fmx-plc-go" data-pdid="' + d.deal_id + '" style="padding:6px 11px;color:#5ab0e6;border-color:rgba(90,176,230,0.4);flex:0 0 auto;"><i class="ti ti-send"></i></button></div></div>';
                        }
                        var _lt = window.t || function (s) { return s; };
                        var rr = '';
                        if (d.reach_12h != null) rr += ' ' + _lt(L('· 12ч:')) + ' ' + _num(d.reach_12h);
                        if (d.reach_24h != null) rr += ' ' + _lt(L('· 24ч:')) + ' ' + _num(d.reach_24h);
                        if (d.reach_48h != null) rr += ' ' + _lt(L('· 48ч:')) + ' ' + _num(d.reach_48h);
                        if (d.proof_status === 'measured' && d.report_token) {
                            var ru = 'https://fmtr.click/p/' + d.report_token;
                            return '<div class="fmx-plc"><div style="font-size:11.5px;color:#8990a8;"><i class="ti ti-file-check" style="color:#5DCAA5;"></i> ' + who(d) + ' <span>' + _lt(L('— замеры завершены')) + '</span>' + rr +
                                (d.post_deleted ? ' <span style="color:#f87171;">' + _lt(L('· пост был удалён')) + '</span>' : '') + '</div>' +
                                '<div style="display:flex;gap:6px;margin-top:6px;flex-wrap:wrap;"><button class="fmx-btn" data-repopen="' + _esc(ru) + '" style="padding:6px 11px;color:#818cf8;border-color:rgba(129,140,248,0.4);"><i class="ti ti-report-analytics"></i> <span>' + _lt(L('Отчёт')) + '</span></button>' +
                                '<button class="fmx-btn" data-repcopy="' + _esc(ru) + '" style="padding:6px 11px;"><i class="ti ti-copy"></i> <span>' + _lt(L('Ссылка для рекламодателя')) + '</span></button></div></div>';
                        }
                        return '<div class="fmx-plc"><div style="font-size:11.5px;color:#8990a8;"><i class="ti ti-circle-check" style="color:#5DCAA5;"></i> ' + who(d) + ' ' + _lt(L('— замеряем охват')) + rr + '</div></div>';
                    }).join('') +
                    '<div style="font-size:10px;color:#565b73;margin-top:6px;">' + L('Пришли ссылку на пост — платформа сама замерит охват через 12, 24 и 48 часов и подготовит отчёт обеим сторонам.') + '</div>';
            }
            html += '</div>';
            box.innerHTML = html;
            function respond(id, acc) {
                apiPost('/api/v1/marketplace/deals/' + id + '/respond', { accept: acc }).then(function (r2) {
                    if (r2 && r2.ok === false) { uiAlert(r2.error || L('Не удалось')); return; }
                    _haptic('success');
                    toast(acc ? L('Сделка подтверждена — счётчик вырос') : L('Отклонено'));
            ...
            qsa(box, '.fmx-plc-go').forEach(function (b) {
                b.addEventListener('click', function () {
                    ...
                    if (!url) { uiAlert(L('Вставь ссылку на вышедший пост.')); return; }
                    b.disabled = true;
                    apiPost('/api/v1/marketplace/deals/' + b.getAttribute('data-pdid') + '/placement', { post_url: url }).then(function (r2) {
                        if (r2 && r2.ok === false) { b.disabled = false; _haptic('error'); uiAlert(r2.error || L('Не удалось')); return; }
                        _haptic('success');
                        toast(L('Размещение отмечено — замерим охват и подготовим отчёт обеим сторонам'));
                        loadPendingDeals();
                    }).catch(function () { b.disabled = false; uiAlert(L('Не удалось. Повтори попытку.')); });
                });
            });
            ...
            qsa(box, '[data-repcopy]').forEach(function (b) {
                b.addEventListener('click', function () {
                    _haptic('light');
                    try { navigator.clipboard.writeText(b.getAttribute('data-repcopy')); toast(L('Ссылка скопирована')); } catch (e) { uiAlert(b.getAttribute('data-repcopy')); }
                });
            });
        }).catch(function () {});
    }
    ...
    function renderStickerPane() {
        ...
        var html = '';
        if (!_stickers.length) {
            html = '<div style="font-size:11.5px;color:#8990a8;line-height:1.6;">' + L('Коллекция пуста. Отправь боту в личных сообщениях любой стикер или премиум-эмодзи — он появится здесь.') + '</div>' +
                '<button class="fmx-btn" id="fmx-stk-bot" style="margin-top:10px;"><i class="ti ti-brand-telegram"></i>' + L('Открыть бота') + '</button>';
        } else {
            html = '<div class="fmx-stkgrid">' + _stickers.map(function (st) {
                ...
                return '<div class="fmx-stkcell' + (sel ? ' on' : '') + '" data-sid="' + st.id + '">' + stkMedia(st, true) +
                    (st.kind === 'tgs' ? '<span class="fmx-stk-anim">' + L('аним.') + '</span>' : '') +
                    '<button class="fmx-stkdel" data-sdel="' + st.id + '" title="' + L('Удалить из коллекции') + '">&times;</button></div>';
            }).join('') + '</div>' +
                '<div style="font-size:10px;color:#565b73;margin-top:8px;">' + L('Пополнение — отправкой стикера боту в личных сообщениях.') + '<span> ' + _stickers.length + '/30</span></div>';
            if (s) {
                html += '<div class="fmx-fxw" style="margin-top:12px;">' +
                    '<button class="fmx-fx" data-sclear="1" style="margin-left:auto;color:#ef4444;">' + L('Убрать стикер') + '</button></div>' +
                    '<div style="font-size:10px;color:#565b73;margin-top:8px;line-height:1.6;"><i class="ti ti-hand-move"></i> ' + L('Всё управление — на оффере-превью: касание стикера — рамка; верхняя точка — поворот, угол — размер, крестик — удалить, три точки под рамкой — режим (слияние · задний фон).') + '</div>';
                if (s.kind !== 'webp') html += '<div style="font-size:10px;color:#f59e0b;margin-top:8px;"><i class="ti ti-lock"></i> ' + L('Анимация в публичной ленте — при продвижении. Без него покажем стоп-кадр.') + '</div>';
            }
        }
        box.innerHTML = html;
        ...
        qsa(box, '[data-sdel]').forEach(function (b) {
            onTap(b, function (e) {
                ...
                uiConfirm(L('Удалить стикер из коллекции?'), function () {
        ...
        var av = el('fmx-accv-sticker'); if (av) av.textContent = s ? L('Есть') : L('Нет');
        hydrateTgs(box);
    }
    function bindBadgeDrag(cardEl) {
        ...
        qsa(cardEl, '[data-bkey]').forEach(function (bd) {
            ...
            function begin(cx, cy) {
                ...
                cardEl.insertAdjacentHTML('beforeend', '<div class="fmx-bslot" style="left:' + zs.home.x1 + 'px;top:' + zs.home.y1 + 'px;width:' + (zs.home.x2 - zs.home.x1) + 'px;height:' + (zs.home.y2 - zs.home.y1) + 'px;"><i>' + L('вернуть в ряд') + '</i></div>');
            ...
            function finish(cx, cy) {
                ...
                if (p.bad) { toast(L('Сюда нельзя: имя, аватар и низ оффера — запретная зона')); return; }
            ...
            function onDown(e) {
                ...
                var up = function (ev) {
                    ...
                    else if (!vip) { toast(L('Свободное перемещение блоков — опция продвижения на 30 дней')); }
                };
    ...
    function _previewListing() {
        ...
        pl.title = ((_ss._title != null ? _ss._title : (c.title || pl.title)) || L('Твой канал'));
        ...
        if (c.activity) pl.activity = c.activity;
    ...
    function renderHero() {
        ...
        var pl = _previewListing();
        var prevH = hero.offsetHeight;
        if (prevH > 40) hero.style.minHeight = prevH + 'px';
        ...
        try {
            ...
            clearTimeout(hero.__fmMinH);
            hero.__fmMinH = setTimeout(function () { hero.style.minHeight = ''; }, 450);
        ...
        function bindCEdit(sel, kind) {
            qsa(card, sel).forEach(function (n) {
                ...
                n.addEventListener('click', function (e) {
                    ...
                    if (kind === 'cover') openColorStudio(coverSeedColor(), function (hex) { _ss.covType = 'grad'; _ss.coverGrad = gradFromHex(hex); _liveCover(_ss.coverGrad); _heroDebounced(); }, L('Шапка'));
                    else openColorStudio(_ss.color, function (hex) { setAccentColor(hex); }, L('Цвет кнопки'));
                });
            });
        }
        ...
        var hl = el('fmx-hlist');
        if (hl) {
            hl.innerHTML = '<div style="font-size:10px;font-weight:700;color:#565b73;letter-spacing:0.6px;margin:0 0 7px;">' + L('ВИД В СПИСКЕ') + '</div>' + zw(listItem(pl));
            scaleCards(hl);
        }
        hydrateTgs(hero);
    }
    ...
    function _psInjectStyle() {
        ...
        s.textContent = '.fmx-psFull{position:fixed;inset:0;z-index:100005;background:#0a0d18;display:flex;flex-direction:column;}' +
    ...
    function _posterPickFormat() {
        return new Promise(function (resolve) {
            ...
            m.innerHTML = '<div class="fmx-fmtcard">' +
                '<div class="fmx-fmttitle">' + L('Как прислать постер?') + '</div>' +
                '<button class="fmx-fmtrow" data-f="mp4"><span class="ic"><i class="ti ti-player-play"></i></span><span class="tx"><b>' + L('Живой постер (MP4)') + '</b><i>' + L('Анимация играет прямо в чате · пришлю через минуту') + '</i></span></button>' +
                '<button class="fmx-fmtrow" data-f="gif"><span class="ic"><i class="ti ti-gif"></i></span><span class="tx"><b>' + L('Живой постер (GIF)') + '</b><i>' + L('Анимация без звука · для площадок, где MP4 неудобен') + '</i></span></button>' +
                '<button class="fmx-fmtrow" data-f="png"><span class="ic"><i class="ti ti-photo"></i></span><span class="tx"><b>' + L('Картинка (PNG)') + '</b><i>' + L('Статичный постер · мгновенно') + '</i></span></button>' +
                '<button class="fmx-fmtcancel" data-f="">' + L('Отмена') + '</button></div>';
    ...
    function _fmxEnsureDockCss() {
        ...
        st.textContent =
            ...
            '#fmx-dkPrev{width:68px;height:85px;}' +
            '#fmx-dkFrame{transform:scale(0.126);}' +
            '.fmx-dkIn{gap:8px;}' +
            '.fmx-dkCol{max-height:85px;gap:4px;}' +
            '.fmx-dkChip{font-size:10px;padding:3px 8px;}' +
            '.fmx-dkHint{font-size:9px;}' +
            '}';
    ...
    function _fmxBuildCardDock(env) {
        ...
        dock.innerHTML = '<div class="fmx-dkIn">' +
            '<div id="fmx-cdPrev" class="fmx-cdTile" title="' + L('К карточке') + '"><div class="fmx-cdScale"></div></div>' +
        ...
        dkHint.textContent = env.tr(L('Зажми превью — развернётся на весь экран · быстрый тап — к карточке'));
    ...
    function _fmxBuildPosterDock(env) {
        ...
        var dock = document.createElement('div');
        dock.id = 'fmx-psDock';
        dock.innerHTML = '<div class="fmx-dkIn"><div id="fmx-dkPrev" title="' + L('К постеру') + '"></div><div class="fmx-dkCol"><div class="fmx-dkNav" id="fmx-dkNav"></div></div></div>';
        env.dockParent.insertBefore(dock, env.wrap);
        ...
        var dkHint = document.createElement('div');
        dkHint.className = 'fmx-dkHint';
        dkHint.textContent = env.tr(L('Удерживай превью — развернётся на весь экран · короткое нажатие — вернёт к постеру'));
        dock.querySelector('.fmx-dkCol').appendChild(dkHint);
        ...
        function onScroll() {
            try {
                ...
                var W = Math.round(fR.width) || Math.min(scR.width, 560);
                dock.style.top = scR.top.toFixed(1) + 'px';
                dock.style.left = (fR.width ? fR.left : scR.left + (scR.width - W) / 2).toFixed(1) + 'px';
                dock.style.width = W.toFixed(1) + 'px';
                dock.classList.toggle('dk-on', vis);
    ...
    function openPosterStudio() {
        var base = listingForChannel(_ss.channelId);
        if (!base || !base.id) { toast(L('Сначала сохрани оффер — постер строится по нему')); return; }
        ...
        bg.innerHTML =
            '<div class="fmx-psTop"><div class="t"><i class="ti ti-photo-star"></i> ' + L('Промо-постер') + '</div>' +
            '<button class="fmx-psX" id="fmx-ps-x" aria-label="' + L('Закрыть') + '"><i class="ti ti-x"></i></button></div>' +
            '<div class="fmx-psScroll"><div id="fmx-psLoad" style="display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 0;color:#8990a8;"><i class="ti ti-loader-2" style="font-size:26px;animation:fmxSpin 0.9s linear infinite;"></i><div style="font-size:12px;margin-top:10px;">' + L('Открываю редактор…') + '</div></div>' +
            ...
            '<div class="fmx-psBottom"><button class="fmx-save" id="fmx-ps-send" style="margin:0 auto;max-width:540px;"><i class="ti ti-send"></i> ' + L('Прислать постер в чат с ботом') + '</button></div>';
        document.body.appendChild(bg);
        ...
        function uploadPosterBg(file) {
            if (file && file.size > MEDIA_MAX_BYTES) {
                return Promise.reject(new Error(L('Файл ') + Math.round(file.size / 1048576) + L(' МБ — это больше 64 МБ')));
            }
        ...
        frame.addEventListener('load', function () {
            try {
                ...
                g.onerror = function () { toast(L('Не удалось загрузить редактор постера')); };
                idoc.head.appendChild(g);
                idoc.addEventListener('click', function () { setTimeout(fitFrame, 60); });
            } catch (e) { toast(L('Редактор недоступен')); }
        });
        ...
        var SEND_LABEL = '<i class="ti ti-send"></i> ' + L('Прислать постер в чат с ботом');
        ...
        function waitSend(sec) {
            ...
            (function tick() {
                ...
                b.innerHTML = '<i class="ti ti-clock"></i> ' + L('Можно через') + ' ' + sec + L(' с');
                sec--;
        ...
        function _startPosterProgress(job, fmt) {
            ...
            b.innerHTML = '<span class="fmx-ring"><svg viewBox="0 0 36 36">' +
                ...
                '</svg></span> ' + L('Готовлю живой постер…') + ' <b id="fmx-pct">0%</b>';
            function setPct(p) {
            ...
            function poll() {
                ...
                apiGet('/api/v1/marketplace/poster/status?job=' + job).then(function (r) {
                    ...
                    if (r && r.done) {
                        ...
                        var msg = r.sent ? '<i class="ti ti-circle-check"></i> ' + L('Готово — постер в чате') : '<i class="ti ti-photo"></i> ' + L('Прислал картинкой');
                        bg.__fmxProgDone = setTimeout(function () { var b2 = sendBtn(); if (b2) b2.innerHTML = msg; }, 650);
                        toast(r.sent ? L('Живой постер в чате с ботом, можно переслать') : L('Живой постер не удалось создать — отправлен изображением'));
        ...
        el('fmx-ps-send').addEventListener('click', function () {
            ...
            function send(fmt) {
                var state = (win && win.__fmxPosterState) ? win.__fmxPosterState() : null;
                if (!state) { restoreSend(); toast(L('Редактор ещё загружается — секунду')); return; }
                var live = (fmt === 'mp4' || fmt === 'gif');
                btn.disabled = true;
                btn.innerHTML = live ? '<i class="ti ti-loader-2"></i> ' + L('Отправляю…') : '<i class="ti ti-loader-2"></i> ' + L('Рисую постер… ~10 сек');
                apiPost('/api/v1/marketplace/poster', { listing_id: base.id, poster: state, format: fmt || 'png' }).then(function (r) {
                    if (r && r.ok) {
                        ...
                        if (r.queued && r.job) {
                            ...
                            btn.disabled = true; btn.innerHTML = '<i class="ti ti-clock"></i> ' + L('Идёт обработка…');
                        } else {
                            toast(L('Постер в чате с ботом, можно переслать')); restoreSend();
                        }
                        if (_myListings) for (var i = 0; i < _myListings.length; i++) if (_myListings[i].id === base.id) _myListings[i].poster_json = r.poster || state;
                    } else {
                        var msg = (r && r.error) || L('Не удалось');
                        var wait = /через\s+(\d+)\s*с/.exec(msg);
                        if (wait) waitSend(parseInt(wait[1], 10)); else restoreSend();
                        toast(msg, true);
                    }
                }).catch(function () { restoreSend(); toast(L('Сервер не ответил'), true); });
            }
            function proceed() {
                var state = (win && win.__fmxPosterState) ? win.__fmxPosterState() : null;
                if (!state) { restoreSend(); toast(L('Редактор ещё загружается — секунду')); return; }
                ...
                if (bgErr) {
                    ...
                    toast(big ? L('Фон слишком большой: до 64 МБ. Для видео нужен короткий ролик — в постер идёт первый отрезок 20 сек') : (L('Фон не загрузился: ') + bgErr), true);
                    return;
                }
            ...
            var pend = null;
            try { pend = (win && win.__fmxPosterBgPending) ? win.__fmxPosterBgPending() : null; } catch (e) {}
            if (pend && pend.then) { btn.disabled = true; btn.innerHTML = '<i class="ti ti-loader-2"></i> ' + L('Загружаю фон…'); pend.then(proceed, proceed); }
            else proceed();
        });
        ...
        ['cover', 'avatar', 'cardbg'].forEach(function (t) {
            chain = chain.then(function () {
                ...
                if (m.file.size > MEDIA_MAX_BYTES) {
                    throw new Error(L('Файл «') + t + '» ' + Math.round(m.file.size / 1048576) + L(' МБ — больше 64 МБ. Выбери файл меньше'));
                }
                var fd = new FormData();
    ...
    function saveStudio() {
        ...
        uploadPending().then(function () { _saveListing(btn); }).catch(function (e) {
            ...
            btn.innerHTML = '<i class="ti ti-rocket"></i> ' + (_ss.listingId ? L('Сохранить оффер') : L('Опубликовать на Площадке'));
            uiAlert(L('Не удалось загрузить файл: ') + (e && e.message ? e.message : L('ошибка')));
        });
    }
    function _saveListing(btn) {
        ...
        else { if (!savingCh) { btn.disabled = false; btn.innerHTML = '<i class="ti ti-rocket"></i> ' + L('Опубликовать на Площадке'); uiAlert(L('Сначала выбери канал.')); return; } body.channel_id = savingCh; p = apiPost('/api/v1/marketplace/listings', body); }
        p.then(function (r) {
            var sameCtx = !!(_ss && _ss.channelId === savingCh);
            if (r && r.ok === false) { _haptic('error'); btn.disabled = false; btn.innerHTML = '<i class="ti ti-rocket"></i> ' + (savingId ? L('Сохранить оффер') : L('Опубликовать на Площадке')); uiAlert(L('Не удалось сохранить: ') + (r.error || L('ошибка'))); return; }
            _haptic('success');
            var savedId = (r && r.listing_id) || savingId;
            if (r && r.listing_id) { if (sameCtx) _ss.listingId = r.listing_id; if (wasCreate) { var ch = channelById(savingCh); _myListings.push({ id: r.listing_id, username: ch ? ch.username : null, status: 'pending', status_human: L('На модерации') }); } loadMyListings(); }
            if (r && (r.resubmitted || r.needs_review)) {
                ...
                for (var ri = 0; ri < _myListings.length; ri++) if (_myListings[ri].id === savedId) {
                    ...
                    _myListings[ri].status_human = nm ? L('На проверке') : L('На модерации');
                    _myListings[ri].moderation_status = nm ? 'needs_review' : 'pending';
                    if (!nm) _myListings[ri].reject_reason = null;
                }
            }
            btn.innerHTML = '<i class="ti ti-check"></i> ' + L('Сохранено');
            toast(r && r.needs_review ? L('Оффер ушёл на ручную проверку — проверим и вернём') : (r && r.resubmitted ? L('Оффер отправлен на повторную проверку') : L('Оффер сохранён')));
            _feed = null; _feedState = 'idle';
            if (wasCreate && r && r.listing_id) _pollPublish(r.listing_id);
            setTimeout(function () {
                if (!(_ss && _ss.channelId === savingCh)) return;
                if (wasCreate) { paintCreate(); }
                else { btn.innerHTML = '<i class="ti ti-rocket"></i> ' + L('Сохранить оффер'); btn.disabled = false; }
            }, 1600);
        }).catch(function (e) { _haptic('error'); btn.disabled = false; uiAlert(L('Не удалось сохранить: ') + (e && e.message ? e.message : L('ошибка'))); });
    }

    function _bk(k, h) { return h.replace('<span', '<span data-bkey="' + k + '"'); }
    var _ACT = {
        high: ['p1', '#5DCAA5', L('Активный')],
        mid: ['p2', '#a9cb5c', L('Регулярный')],
        rare: ['p3', '#f5bf4f', L('Редкие посты')],
        low: ['p4', '#f08a3c', L('Единичные посты')],
        none: ['p5', '#ef4444', L('Не публикует')]
    };
    ...
    function _actBadge(l) {
        ...
        var MON_RD = [L('января'), L('февраля'), L('марта'), L('апреля'), L('мая'), L('июня'), L('июля'), L('августа'), L('сентября'), L('октября'), L('ноября'), L('декабря')];
    var MON_IM = [L('Январь'), L('Февраль'), L('Март'), L('Апрель'), L('Май'), L('Июнь'), L('Июль'), L('Август'), L('Сентябрь'), L('Октябрь'), L('Ноябрь'), L('Декабрь')];
    ...
    function rknPill(url, kind) {
        ...
        var lbl = String(url || '').indexOf('app:') === 0 ? L('Заявка в перечне РКН') : L('Зарегистрирован в РКН');
        if (kind === 'radar') {
    ...
    function badgeItems(l) {
        ...
        if (_nicheMatch(l)) items.push({ k: 'match', h: _bk('match', '<span class="fmx-bdg fmx-b-match"><i class="ti ti-target-arrow"></i>' + L('В нише') + '</span>') });
        if (l.hot_discount_pct) items.push({ k: 'hot', h: _bk('hot', '<span class="fmx-bdg" style="color:#f5bf4f;border-color:rgba(245,191,79,0.45);background:rgba(245,191,79,0.1);"><i class="ti ti-discount-2"></i>' + L('Горящие даты до −') + l.hot_discount_pct + '%</span>') });
        var _ab = _actBadge(l);
        if (_ab) items.push({ k: 'live', h: _bk('live', _ab) });
        if (l.badges && l.badges.length) {
            var m = { safe: ['fmx-b-safe', 'ti-shield-check', L('Безопасный')], big: ['fmx-b-big', 'ti-crown', L('Крупный')],
                risk: ['fmx-b-dead', 'ti-alert-triangle', L('Требует проверки')] };
            ...
            items.push({ k: 'big', h: _bk('big', '<span class="fmx-bdg fmx-b-big"><i class="ti ti-crown"></i>' + L('Крупный') + '</span>') });
        }
        return items;
    }
    function _nicheLine(l, fts) {
        if (!l.niche) return '';
        var m = _nicheMatch(l);
        return '<div class="fmr-nline"' + (fts ? ' style="' + fts + '"' : '') + '><i class="ti ti-tag"></i>' + _esc(l.niche) +
            (m ? '<span class="mt"><i class="ti ti-target-arrow"></i>' + L('в твоей нише') + '</span>' : '') + '</div>';
    }
    function _alertsRow(l, promoHtml) {
        ...
        return out.length ? '<div class="fmr-pulse">' + out.join('') + '</div>' : '';
    }
    function _trustRow(l) {
        var out = [];
        var h = _hlInfo(l);
        ...
        var bl = l.badges || [];
        if (bl.indexOf('big') >= 0 || (!bl.length && l.subscribers && l.subscribers >= 100000)) out.push('<span class="fmr-pill" style="color:#f5bf4f;"><i class="ti ti-crown"></i><span style="color:#c2c6d2;">' + L('Крупный канал') + '</span></span>');
        if (bl.indexOf('safe') >= 0) out.push('<span class="fmr-pill" style="color:#5DCAA5;"><i class="ti ti-circle-check"></i><span style="color:#c2c6d2;">' + L('Безопасный') + '</span></span>');
        var al = _audLabel(l);
        if (al) out.push('<span class="fmr-pill" style="color:' + al.color + ';"><i class="ti ' + al.icon + '"></i><span style="color:#c2c6d2;">' + al.text + '</span></span>');
        var dealN = l.deals_count || 0;
        if (l.show_deals !== false && dealN >= 1) out.push('<span class="fmr-pill" style="color:#f5bf4f;"><i class="ti ti-heart-handshake"></i><span style="color:#c2c6d2;">' + (l.rating_avg ? '★ ' + l.rating_avg + ' · ' : '') + dealN + ' ' + _plural(dealN, L('сделка'), L('сделки'), L('сделок')) + '</span></span>');
        return out.length ? '<div class="fmr-pills">' + out.join('') + '</div>' : '';
    }
    ...
    function _fmrBlocksBuy(l) {
        ...
        if (dead) {
            ...
            rrHtml = '<div class="fmr-line" style="margin-top:5px;display:flex;align-items:center;gap:6px;flex-wrap:wrap;">' + rrWarn + 'ERR <b style="color:' + rrCol + ';">' + rr + '%</b> <span style="font-size:11px;color:' + rrCol + ';font-weight:600;">' + _esc(rstat) + '</span>' + normTxt + '<span class="fmr-i push" data-fi="rr">?</span></div>' +
                '<div class="fmr-info" data-finfo="rr">' + L('ERR = охват ÷ подписчики — какой процент подписчиков видит пост. Норму смотрим по размеру канала (у больших она ниже — это нормально): микро до 5к 25–50%, малый 5–10к 18–35%, средний 10к–100к 7–22%, крупный 100к–1М 6–16%, миллионник 3–10%. Нормы выведены из реальной базы каналов. Слишком низко для своего размера — признак мёртвой базы; в разы выше нормы — повод проверить источник охвата.') + rrAnom + '</div>';
        }
        var erHtml = '';
        if (!dead) {
            var erBits = [];
            if (l.react_count) erBits.push('~' + _num(l.react_count) + ' ' + _plural(l.react_count, L('реакция'), L('реакции'), L('реакций')));
            if (l.forward_count) erBits.push(_num(l.forward_count) + ' ' + _plural(l.forward_count, L('репост'), L('репоста'), L('репостов')));
            if (l.comment_count) erBits.push(_num(l.comment_count) + ' ' + _plural(l.comment_count, L('комментарий'), L('комментария'), L('комментариев')));
            var erSub = erBits.length ? ' <span style="font-size:11px;color:#565b73;">' + L('— по') + ' ' + erBits.join(', ') + ' ' + L('на пост') + '</span>' : '';
            if (l.data_source === 'scrape') erSub += ' <span style="font-size:11px;color:#f59e0b;">' + L('— только реакции, репосты и комментарии недоступны') + '</span>';
            var _erv = l.engagement_percent;
            var _erNo = (_erv == null);
            var _erStat = _erNo ? L('не измеряется') : (_erv >= 3.5 ? L('высокая') : (_erv >= 1 ? L('норма') : L('низкая')));
        ...
        if (!dead && l.ad_er_posts != null) {
            ...
            if (_adv != null) {
                ...
                if (_adr != null && _adr >= 1.2) { _adCol = '#5DCAA5'; _adTag = L('выше обычного'); }
                else if (_adr != null && _adr >= 0.85) { _adCol = '#5DCAA5'; _adTag = L('на уровне обычных'); }
                else if (_adr != null && _adr >= 0.6) { _adCol = '#818cf8'; _adTag = L('немного ниже обычного'); }
                else if (_adr != null && _adr > 0) { _adCol = '#f87171'; _adTag = L('в ') + String(Math.round(10 / _adr) / 10).replace('.', ',') + L(' раза ниже обычного'); }
                else { _adCol = '#818cf8'; }
                _adSub = ' <span style="font-size:11px;color:#565b73;">' + L('— по') + ' ' + _adn + ' ' + _plural(_adn, L('рекламному посту'), L('рекламным постам'), L('рекламным постам')) + '</span>';
            } else if (_adn > 0) {
                _adTag = L('мало рекламных постов');
                _adSub = ' <span style="font-size:11px;color:#565b73;">' + L('— найдено') + ' ' + _adn + L(', нужно от 3') + '</span>';
            } else {
                _adTag = L('рекламных постов не найдено');
            }
        ...
        (function () {
            ...
            if (l.spike_ratio != null) {
                ...
                if (spct === 0) { st = L('Просмотры ровные — резких всплесков нет'); sc = '#5DCAA5'; }
                else if (sp < 0.2) { st = L('Отдельные вирусные посты (~') + spct + L('%) — обычная органика'); sc = '#818cf8'; }
                else { st = L('Кластер всплесков (~') + spct + L('% постов) — возможен закуп просмотров, проверь'); sc = '#f59e0b'; }
            ...
            if (l.ad_density != null && l.struct_posts) {
                ...
                sr.push('<div class="fmr-sub" style="color:' + acol + ';">' + apct + L('% рекламных · ') + l.struct_posts + ' ' + _plural(l.struct_posts, L('пост'), L('поста'), L('постов')) + (l.ad_density >= 0.35 ? L(' — лента подвыжжена, охват твоей рекламы ниже') : '') + '</div>');
            }
    ...
    function _shareBtn(l, style) {
        return '<button class="fmx-star fmx-shb" data-share="' + _esc(l.username || '') +
            '" data-slid="' + (l.id || '') + '" aria-label="' + L('Поделиться') + '"' +
    ...
    function _shortRange(lo, hi) {
        if (hi >= 1000000) {
            return (Math.round(lo / 100000) / 10 + '').replace('.', ',') + '–' + (Math.round(hi / 100000) / 10 + '').replace('.', ',') + L('М');
        }
        if (lo >= 1000 && hi >= 1000) {
            return Math.round(lo / 1000) + '–' + Math.round(hi / 1000) + L('К');
        }
    ...
    function _heroTiles(l, mode) {
        ...
        if (typeof g === 'number' && g !== 0) {
            subsSub = ((Math.abs(g) % 1000 === 0) ? '≈' : '') + (g > 0 ? '+' : '−') + _kmNum(Math.abs(g)) + L(' за ') + gDays + L(' дн');
        ...
        var rows =
            _kmRow(L('Подписчики'), _kmSub(subsSub, subsSubCol), _num(subs), '#e8e8ed') +
            _kmRow(L('Охват'),
                _kmSub(dead ? L('не публикует') : ((typeof l.ad_reach_24h === 'number' && l.ad_reach_24h > 0) ? L('замер рекламных постов') : L('медиана постов')), dead ? '#ef4444' : ''),
                dead ? '—' : (av ? '~' + _exact(av) : '—'), '#e8e8ed') +
            _kmRow(L('ERR'),
                dead ? _kmSub(L('нет свежих постов'), '') : _kmPill(rstat || L('уточняется'), rstat ? rrCol : '#8d93a8'),
    ...
    function fullCard(l) {
        ...
        var scoreHtml = (function () {
            ...
            return '<div class="fmr-score" style="margin-left:auto;">' + (noHead ? starFlow : '') +
                ...
                '<div class="fmr-scorelbl">' + L('индекс') + ' <span class="fmr-i" data-fi="health">?</span></div></div>';
        })();
        var tagInBody = noHead || ((l.effects_json || {}).topTagPos === 'body');
        var promoBdg = (realTop && topTag !== 'off') ? '<span class="fmx-bdg" data-promoproof="1" style="color:#f5bf4f;border-color:rgba(245,191,79,0.45);background:rgba(245,191,79,0.1);cursor:pointer;' + (topTag === 'ghost' ? 'opacity:0.62;' : '') + '"><i class="ti ti-speakerphone"></i>' + L('Продвигается') + '</span>' : '';
        var tagAsBadge = tagInBody && !!promoBdg;
        var headHtml;
        if (noHead) {
            ...
            headHtml = '<div class="fmr-head">' + _rAv +
                ...
                (l.username ? '<div class="fmr-user">@' + _esc(l.username) + ' · ' + _num(l.subscribers) + ' ' + L('подп.') + '</div>' : '') +
                _nicheLine(l, '') + '</div>' + scoreHtml + '</div>';
        } else {
            headHtml = '<div class="fmx-crow">' + avHtml +
                '<div style="min-width:0;"><div class="fmx-nm" style="' + fts + fontStyle(l.title_style) + '">' + _esc(t) + '</div><div class="fmx-meta" style="' + fts + '">@' + _esc(l.username) + ' · ' + _num(l.subscribers) + ' ' + L('подп.') + '</div>' + _nicheLine(l, fts) + '</div>' +
                scoreHtml + '</div>';
        }
        var alertsHtml = _alertsRow(l, tagAsBadge ? promoBdg : '');
        var _tagPos = tagInBody ? 'position:static;display:inline-flex;margin:2px 0 9px;' : '';
        var tagHtml = realTop
            ? (topTag === 'off' ? '' : '<span class="fmx-tag gold" data-promoproof="1" style="cursor:pointer;' + _tagPos + (topTag === 'ghost' ? 'background:rgba(10,13,24,0.22);color:#f5d78a;border:0.5px solid rgba(245,191,79,0.4);' : '') + '"><i class="ti ti-speakerphone"></i> ' + L('Продвигается') + '</span>')
            : '<span class="fmx-tag" style="' + _tagPos + '"><i class="ti ti-circle-check-filled"></i> ' + L('на продаже') + '</span>';
        return '<div class="fmx-cwrap' + (glowOn ? ' fmx-goldw' : '') + '"><div class="fmx-card' + (glowOn ? ' fmx-prem' : '') + (fullBg ? ' fmx-fullbg' : '') + (noHead ? ' fmx-nohead' : '') + '" data-u="' + _esc(l.username) + '">' + cbgHtml + stkHtml +
            ...
            (l.health_score != null ? '<div class="fmr-info" data-finfo="health">' + L('Индекс здоровья канала (0–100): насколько канал живой и качественный как площадка — вовлечённость, ERR, стабильность охватов, признаки накрутки. Считается из тех же метрик, что видны выше, поэтому не противоречит им. Зелёный — хорошо, жёлтый — средне, красный — с осторожностью.') + '</div>' : '') +
            alertsHtml +
            ...
            _moreBlock(l) +
            _trustRow(l) +
            '<div class="fmx-acts"><button class="fmx-btn" style="' + gs.s + '" data-act="analyze" data-u="' + _esc(l.username) + '"><span class="fmxan-mi">' + AN_ICO + '</span>' + L('Разбор') + ' ' + anFee(30) + '</button>' +
            '<button class="fmx-btn" style="' + gs.s + '" data-act="expand" data-u="' + _esc(l.username) + '" data-lid="' + (l.id || '') + '"><i class="ti ti-arrow-up-right"></i>' + L('Развернуть') + '</button>' +
            '<button class="fmx-btn fmx-btn-p" style="' + gs.p + '" data-act="write" data-u="' + _esc(l.username) + '" data-lid="' + (l.id || '') + '"><i class="ti ti-brand-telegram"></i>' + L('Открыть канал') + '</button></div>' +
            (!l.id ? '<div class="fmx-acts" style="margin-top:6px;"><button class="fmx-btn" style="' + gs.s + 'flex:1;color:#5ab0e6;border-color:rgba(90,176,230,0.35);" data-act="track" data-u="' + _esc(l.username) + '"><i class="ti ti-route"></i>' + L('Ссылка отслеживания в рекламный пост') + '</button></div>'
                : '<div class="fmx-acts" style="margin-top:6px;"><button class="fmx-btn" style="' + gs.s + 'flex:1;color:#5ab0e6;border-color:rgba(90,176,230,0.35);" data-act="deal" data-lid="' + l.id + '"><i class="ti ti-route"></i>' + L('Ссылка отслеживания в рекламный пост') + '</button></div>') +
            '</div></div></div>';
    }
    function _ageTile() {
        return '<div class="fmx-scard fmx-agel" data-agegate="1" style="cursor:pointer;text-align:center;padding:22px 14px;">' +
            ...
            '<div style="font-weight:650;margin-top:7px;">' + L('Канал 18+') + '</div>' +
            '<div style="font-size:11.5px;color:#8990a8;margin-top:3px;">' + L('Нажми, чтобы подтвердить возраст и открыть') + '</div></div>';
    }
    function _askAge() {
        uiConfirm(L('В этом разделе есть каналы с контентом 18+. Подтвердите, что вам исполнилось 18 лет.'), function () {
            apiPost('/api/v1/marketplace/confirm-age', {}).then(function () {
                _adultOk = true;
                if (_mainTab === 'catalog') renderCatalog(); else if (_subTab === 'buy') renderBuy();
            }).catch(function () { toast(L('Не удалось. Повтори попытку.')); });
        });
    }
    ...
    function _ctcLinesHtml(l) {
        ...
        return line(L('Реклама'), adc) + line(L('Сотрудничество'), coop);
    }
    function simpleCard(l) {
        ...
        var _promoB = (_rGold && _rTag !== 'off') ? '<span class="fmx-bdg" data-promoproof="1" style="color:#f5bf4f;border-color:rgba(245,191,79,0.45);background:rgba(245,191,79,0.1);cursor:pointer;' + (_rTag === 'ghost' ? 'opacity:0.62;' : '') + '"><i class="ti ti-speakerphone"></i>' + L('Продвигается') + '</span>' : '';
        var _t = l.title || l.username || L('Канал'), _acc = _accent(l);
        ...
        var scoreHtml = '<div class="fmr-score">' + _rIcons +
            (ring ? ring + '<div class="fmr-scorelbl">' + L('индекс') + ' <span class="fmr-i" data-fi="health">?</span></div>' : '') + '</div>';
        ...
        var actsHtml = l.id
            ? '<div class="fmx-acts"><button class="fmx-btn" data-act="analyze" data-u="' + _esc(l.username) + '"><span class="fmxan-mi">' + AN_ICO + '</span>' + L('Разбор') + ' ' + anFee(30) + '</button>' +
              '<button class="fmx-btn" data-act="expand" data-u="' + _esc(l.username) + '" data-lid="' + l.id + '"><i class="ti ti-arrow-up-right"></i>' + L('Развернуть') + '</button>' +
              '<button class="fmx-btn fmx-btn-p" style="background:linear-gradient(145deg,#818cf8,#6366f1);color:#0b0c16;" data-act="write" data-u="' + _esc(l.username) + '" data-lid="' + l.id + '"><i class="ti ti-brand-telegram"></i>' + L('Открыть канал') + '</button></div>' +
              '<div class="fmx-acts" style="margin-top:6px;"><button class="fmx-btn" style="flex:1;color:#5ab0e6;border-color:rgba(90,176,230,0.35);" data-act="track" data-u="' + _esc(l.username) + '"><i class="ti ti-route"></i>' + L('Ссылка отслеживания в рекламный пост') + '</button>' +
              '</div>'
            : '<div class="fmx-acts"><button class="fmx-btn" data-act="analyze" data-u="' + _esc(l.username) + '"><span class="fmxan-mi">' + AN_ICO + '</span>' + L('Разбор') + ' ' + anFee(30) + '</button>' +
              '<button class="fmx-btn fmx-btn-p" style="background:linear-gradient(145deg,#818cf8,#6366f1);color:#0b0c16;" data-act="write" data-u="' + _esc(l.username) + '" data-lid="' + (l.id || '') + '"><i class="ti ti-brand-telegram"></i>' + L('Открыть канал') + '</button>' +
              '</div>' +
              '<div class="fmx-acts" style="margin-top:6px;"><button class="fmx-btn" style="flex:1;color:#5ab0e6;border-color:rgba(90,176,230,0.35);" data-act="track" data-u="' + _esc(l.username) + '"><i class="ti ti-route"></i>' + L('Ссылка отслеживания в рекламный пост') + '</button></div>';
        return '<div class="fmx-scard' + (_rGlow ? ' fmx-prem' : '') + (_rCbg ? ' fmr-hasbg' : '') + '" data-u="' + _esc(l.username) + '">' + _rCbg + _rStkHtml +
            headHtml +
            (ring ? '<div class="fmr-info" data-finfo="health">' + L('Индекс здоровья канала (0–100): насколько канал живой и качественный как площадка — вовлечённость, ERR, стабильность охватов, признаки накрутки. Считается из тех же метрик, что видны выше, поэтому не противоречит им. Зелёный — хорошо, жёлтый — средне, красный — с осторожностью.') + '</div>' : '') +
            _heroTiles(l, 'radar') +
    ...
    var _COLLECT = ' <span style="color:#565b73;">· <span>' + L('данные копятся') + '</span></span>';
    function _audBlock(l) {
        var out = '';
        if (l.geo && _GEO_NAMES[l.geo]) {
            out += '<div class="fmr-agerow"><span>' + L('Страна аудитории') + '</span>: <b>' + _esc(_GEO_NAMES[l.geo]) + '</b>' +
                (l.lang_code && l.lang_code !== 'ru' ? ' <span style="color:#565b73;">' + L('· язык:') + ' ' + _esc(l.lang_code) + '</span>' : '') + '</div>';
        } else {
            out += '<div class="fmr-agerow"><span>' + L('Страна аудитории') + '</span>: ' + _DASH + '</div>';
        }
        ...
        if (male != null) {
            var src = (l.audience_source === 'commenters' && !approx)
                ? ('<span>' + L('по комментаторам') + '</span>' + (l.gender_sample ? ' · <span>' + L('выборка') + '</span> ' + l.gender_sample : ''))
                : '<span>' + L('оценка по нише') + '</span>';
            out += '<div class="fmr-gline"><span class="gl m">' + L('М') + ' ' + (approx ? '≈' : '') + male + '%</span>' +
                '<div class="fmr-gbar"><div class="gm" style="width:' + male + '%;"></div><div class="gf" style="width:' + female + '%;"></div></div>' +
                '<span class="gl f">' + L('Ж') + ' ' + (approx ? '≈' : '') + female + '%</span></div>' +
                '<div class="fmr-gsrc">' + src + '</div>';
        } else {
            out += '<div class="fmr-agerow"><span>' + L('Пол аудитории') + '</span>: ' + _DASH + _COLLECT + '</div>';
        }
        var gv = function (v) {
        ...
        out += '<div class="fmr-gtab">' +
            '<div class="r"><span class="l">' + L('Сегодня') + '</span>' + gv(l.subs_d1) + '</div>' +
            '<div class="r"><span class="l">' + L('Неделя') + '</span>' + gv(l.subs_d7) + '</div>' +
            '<div class="r"><span class="l">' + L('Месяц') + '</span>' + gv(l.subs_d30) + '</div></div>';
        if (l.channel_created_ts) {
            ...
            var age = yrs > 0 ? (yrs + L(' г') + (rm ? ' ' + rm + L(' мес') : '')) : (months >= 1 ? (months + L(' мес')) : L('меньше месяца'));
            var d = new Date(l.channel_created_ts * 1000);
            out += '<div class="fmr-agerow"><span>' + L('Возраст канала') + '</span>: <b>' + age + '</b> · <span>' + L('создан') + '</span> ' +
                ('0' + d.getDate()).slice(-2) + '.' + ('0' + (d.getMonth() + 1)).slice(-2) + '.' + d.getFullYear() + '</div>';
        } else {
            out += '<div class="fmr-agerow"><span>' + L('Возраст канала') + '</span>: ' + _DASH + '</div>';
        }
        var p24ok = false;
        if (l.reach_24h_median && l.subscribers) {
            ...
            if (p24 > 0 && p24 <= 100) {
                p24ok = true;
                out += '<div class="fmr-agerow"><span>' + L('Читают за сутки') + '</span>: <b>' + String(p24).replace('.', ',') +
                    '%</b> <span style="color:#565b73;">(' + _num(l.reach_24h_median) + L(' из ') + _num(l.subscribers) + ')</span></div>';
            }
        }
        if (!p24ok) {
            out += '<div class="fmr-agerow"><span>' + L('Читают за сутки') + '</span>: ' + _DASH + _COLLECT + '</div>';
        }
        out += _reachWinRows(l);
        return '<div class="fmr-sec num"><span class="kn"><i class="ti ti-users" style="font-size:11px;"></i></span>' + L('Аудитория и динамика') + '</div>' + out;
    }
    function _reachWinRows(l) {
        var w = [[L('12 часов'), l.reach_12h_median], [L('24 часа'), l.reach_24h_median], [L('48 часов'), l.reach_48h_median]];
        var have = w.filter(function (x) { return x[1]; });
        if (!have.length) {
            return '<div class="fmr-agerow" style="margin-top:8px;"><span>' + L('Сколько наберёт рекламная публикация') + '</span>: ' + _DASH + _COLLECT + '</div>';
        }
        return '<div class="fmr-agerow" style="margin-top:8px;"><span>' + L('Сколько наберёт рекламная публикация') + '</span></div>' +
    ...
    function _curveBlock(l) {
        var head = '<div class="fmr-sec num"><span class="kn"><i class="ti ti-chart-histogram" style="font-size:11px;"></i></span>' + L('Как набирается охват') + '</div>';
        ...
        if (pts.length < 4) {
            if (l && l.days_since_last_post != null && l.days_since_last_post > 2) {
                return head + '<div class="fmr-gsrc" style="margin-top:0;"><span>' + L('Кривая строится по свежим публикациям — появится после новых постов канала') + '</span></div>';
            }
            return head + '<div class="fmr-gsrc" style="margin-top:0;"><span>' + L('Данные копятся: замеров пока мало для графика') + '</span></div>';
        }
        var mx = Math.max(100, Math.max.apply(null, pts.map(function (m) { return c[m]; })));
        var bars = marks.map(function (m) {
            if (c[m] == null) {
                return '<div class="fmr-cvcol"><span class="fmr-cvlb">' + m + ' ' + L('ч') + '</span><span class="fmr-cvvl" style="color:#565b73;">—</span></div>';
            }
            ...
            return '<div class="fmr-cvcol"><div class="fmr-cvbar" style="height:' + h + '%;background:' + col + ';"></div>' +
                '<span class="fmr-cvlb">' + m + ' ' + L('ч') + '</span><span class="fmr-cvvl">' + Math.round(c[m]) + '%</span></div>';
        }).join('');
        var note = '';
        var noteTail = ' <span>' + L('Показатель пересчитывается автоматически по свежим публикациям.') + '</span>';
        if (l.curve_flag === 'step') {
            note = '<div class="fmr-cvwarn"><span>' + L('Просмотры прибавляются заметными ступенями на нескольких публикациях — динамика отличается от типичной для живой аудитории.') + '</span>' + noteTail + '</div>';
        } else if (l.curve_flag === 'night') {
            note = '<div class="fmr-cvwarn"><span>' + L('Просмотры прибавляются преимущественно ночью — динамика отличается от типичной для живой аудитории.') + '</span>' + noteTail + '</div>';
        } else if (l.curve_flag === 'late') {
            note = '<div class="fmr-cvwarn"><span>' + L('Публикации продолжают набирать просмотры спустя сутки после выхода — у живой аудитории охват к этому времени обычно выходит на плато.') + '</span>' + noteTail + '</div>';
        }
        var concl = '';
        var lead = null;
        ['6', '12'].some(function (m) { if (c[m] != null && c[m] >= 80) { lead = m; return true; } return false; });
        if (lead) {
            concl = '<div class="fmr-gsrc" style="margin-top:3px;"><span>' + L('Пост отрабатывает за первые') + '</span> ' + lead +
                ' <span>' + L('часов: к этой отметке набрано') + '</span> ' + Math.round(c[lead]) + '% <span>' + L('суточного охвата') + '</span></div>';
        } else if (c['24'] != null) {
            concl = '<div class="fmr-gsrc" style="margin-top:3px;"><span>' + L('Охват набирается равномерно в течение суток') + '</span></div>';
        }
        return head +
            '<div class="fmr-cvwrap">' + bars + '</div>' +
            '<div class="fmr-gsrc"><span>' + L('За 100% принят охват за первые сутки') + '</span>' +
            (c.posts ? ' · <span>' + L('публикаций') + '</span>: ' + c.posts : '') + '</div>' + concl + note;
    }
    function _subsChart(l) {
        var uname = (l && (l.username || l.channel_username) || '').replace('@', '');
        if (!uname) return '';
        return '<div class="fmr-sec num fmr-sbsec"><span class="kn"><i class="ti ti-chart-bar" style="font-size:11px;"></i></span>' + L('Прирост подписчиков') + '</div>' +
        ...
        (function (r) {
            ...
            if (g.length < 3) {
                if (pts.length >= 3 && !g.length) {
                    var emsg;
                    if (r.span) {
                        emsg = '<span>' + L('За месяц') + '</span>: ≈' + (r.span > 0 ? '+' : '−') + _num(Math.abs(r.span)) +
                            (r.noise ? ' · <span>' + L('колебания по дням меньше') + '</span> ±' + _num(r.noise) : '');
                    } else if (r.noise) {
                        emsg = '<span>' + L('Колебания за месяц меньше') + '</span> ±' + _num(r.noise);
                    } else {
                        emsg = '<span>' + L('За месяц число подписчиков не менялось') + '</span>';
                    }
                    box.innerHTML = '<div class="fmr-gsrc" style="margin-top:0;">' + emsg + '</div>';
                    return;
                }
                box.innerHTML = '<div class="fmr-gsrc" style="margin-top:0;">' +
                    '<span>' + L('Данные копятся: замеров пока мало для графика') + '</span></div>';
                return;
            }
            ...
            var tot = r.total;
            var cap = hasEv
                ? '<span>' + L('зелёное — подписались, красное — отписались') + '</span>' +
                  (r.joins != null ? ' · <b style="color:#5DCAA5;">+' + _num(r.joins) + '</b> / <b style="color:#ef4444;">−' + _num(r.leaves || 0) + '</b>' : '')
                : '<span>' + L('чистый прирост за месяц: подписки минус отписки') + '</span>' +
                  (tot != null ? ' · <span>' + L('итог') + '</span>: ' + (r.approx ? '≈ ' : '') + (tot > 0 ? '+' : '') + _num(tot) : '') +
                  (r.best != null && r.best > 0 ? ' · <span>' + L('лучший день') + '</span>: ' + (r.approx ? '≈ ' : '') + '+' + _num(r.best) : '') +
                  (r.approx ? ' · <span>' + L('мелкие колебания могут не отображаться') + '</span>' : '');
    ...
    function _topPostsBlock(l) {
        ...
        var rows = tp.slice(0, 5).map(function (p, i) {
            ...
            var txt = _tpClean(p.text) || L('Публикация без текста');
        ...
        return '<div class="fmr-sec num"><span class="kn"><i class="ti ti-flame" style="font-size:11px;"></i></span>' + L('Топ публикаций') + '</div>' +
            rows + '<div class="fmr-gsrc"><span>' + L('топ последних публикаций по просмотрам') + '</span> · <span>' + L('нажми, чтобы открыть пост') + '</span></div>';
    }
    function _moreBlock(l) {
        var inner = _blk(2, _audBlock(l)) + _blk(2, _subsChart(l)) + _blk(2, _curveBlock(l)) + _blk(2, _topPostsBlock(l));
        if (!inner) return '';
        return '<details class="fmr-more"><summary><i class="ti ti-chart-dots" style="color:#818cf8;"></i> <span>' + L('Подробная статистика') + '</span>' +
            '<i class="ti ti-chevron-down chev"></i></summary>' +
    ...
    function _spikeLine(l) {
        ...
        var when = sp.days <= 1.5 ? L('за сутки') : (L('за ') + Math.round(sp.days) + L(' дн'));
        var head = sp.level === 'ok' ? L('Резкий рост подписчиков') : L('Скачок подписчиков');
        var reach = (sp.reach_pct == null) ? '' :
            ' · <span style="color:#9aa0b8;">' + L('охват') + '</span> <b style="color:' + (sp.reach_pct >= 0 ? '#c2c6d2' : '#ef4444') + ';">' +
    ...
    function _liIcons(l) {
        ...
        var dealN = l.deals_count || 0;
        if (l.show_deals !== false && dealN >= 1) out.push(['ti-heart-handshake', '#f5bf4f', dealN + ' ' + _plural(dealN, L('сделка'), L('сделки'), L('сделок'))]);
        if (l.hot_discount_pct) out.push(['ti-discount-2', '#f5bf4f', L('Горящие даты до −') + l.hot_discount_pct + '%']);
    ...
    function listItem(l, fx, plain) {
        ...
        if (dead) {
            mets += '<s></s><span class="fmx-lm" style="color:#ef4444;"><i class="ti ti-eye-off"></i><span>' + L('не публикует') + '</span></span>';
        } else if (l.avg_views) {
    ...
    function _promoProof() {
        ...
        var d = document.createElement('div');
        d.id = 'fmx-promoProof';
        d.innerHTML = '<div class="fmx-ppcard"><div class="fmx-ppic"><i class="ti ti-shield-check"></i></div><div class="fmx-ppt">' + L('Продвижение подтверждено платформой') + '</div><div class="fmx-pps">' + L('Настоящий бейдж открывает эту проверку по нажатию — имитация в оформлении не открывает.') + '</div></div>';
    ...
    document.addEventListener('click', function (e) {
        ...
        if (rknB) {
            ...
            if (ru && ru.indexOf('app:') === 0) {
                toast(L('Заявка в перечне РКН № ') + ru.slice(4));
                return;
            }
        ...
        if (del) {
            ...
            if (_box && !_box.querySelector('.fmx-bmrow')) {
                _box.innerHTML = '<div class="fmx-empty"><i class="ti ti-star"></i><h3>' + L('Пусто') + '</h3><p>' + L('Отмечай ★ на офферах, чтобы сохранить канал.') + '</p></div>';
            }
            return;
        }
        var row = t.closest('#fmx-bmBody .fmx-bmrow');
        if (row && row.classList.contains('frz') && !t.closest('.fmx-lbox')) {
            toast(L('Оффер в заморозке — владелец приостановил продажу'));
        }
    });
    var _rsT = null;
    window.addEventListener('resize', function () {
    ...
    function bindCards(scope) {
        ...
        qsa(host, '[data-act="expand"]').forEach(function (b) { b.addEventListener('click', function () {
            trackListing(b.getAttribute('data-lid'), 'expand');
            var u = b.getAttribute('data-u');
            if (findListing(u)) return openListing(u);
            apiGet('/api/v1/marketplace/listings?q=' + encodeURIComponent(u) + '&limit=5').then(function (r2) {
                var found = null;
                ((r2 && r2.listings) || []).forEach(function (x) {
                    if (String(x.username || '').toLowerCase() === String(u).toLowerCase()) found = x;
                });
                openListing(u, found || null);
            }).catch(function () { openListing(u); });
        }); });
    ...
    function _nicheBtnHtml(short) {
        ...
        var pickLabel = pickActive
            ? ((short ? '' : L('Ниша: ')) + _esc(s.length > 14 ? s.slice(0, 13) + '…' : s))
            : (short ? L('Ниша') : L('Выбрать нишу'));
        return '<button class="fmx-nichebtn' + (pickActive ? ' on' : '') + '" data-sort="niche"' + (short ? ' title="' + L('Выбрать нишу') + '"' : '') + '><i class="ti ti-list-search"></i><span>' + pickLabel + '</span><i class="ti ti-chevron-right fmx-nichebtn-chev"></i></button>';
    }
    function _bellBtnHtml() {
        return '<button class="fmx-bellbtn" data-alerts="1" title="' + L('Умные уведомления') + '"><i class="ti ti-bell"></i></button>';
    }
    function _adpickBtnHtml() {
        return '<button class="fmx-adpickbtn" data-adpick="1" title="' + L('Подбор каналов для рекламы') + '"><i class="ti ti-target-arrow"></i></button>';
    }
    function sortBarHtml() {
        return '<div class="fmx-picks">' + _nicheBtnHtml() + _adpickBtnHtml() + _bellBtnHtml() + '</div>' +
            '<div class="fmx-sortbar">' +
            '<button class="fmx-seg' + (_sort === 'all' ? ' on' : '') + '" data-sort="all"><i class="ti ti-layout-grid"></i> ' + L('Все каналы') + '</button>' +
            '<button class="fmx-seg' + (_sort === 'match' ? ' on' : '') + '" data-sort="match"><i class="ti ti-target-arrow"></i> ' + L('Под мою нишу') + '</button>' +
            '<button class="fmx-seg' + (_rfCount() ? ' on' : '') + '" id="fmx-rfbtn"><i class="ti ti-adjustments-horizontal"></i> ' + L('Фильтры') + (_rfCount() ? ' · ' + _rfCount() : '') + '</button>' +
            _regionChipHtml() +
            '</div>';
    }
    ...
    function topRowHtml() {
        return '<div class="fmx-divrow"><span class="fmx-divlbl">' + L('Каналы, где можно купить рекламу') + '</span><span class="fmx-divline"></span>' + vtogHtml() + '</div>';
    }
    function emptyHtml(icon, title, sub) { return '<div class="fmx-empty"><i class="ti ' + icon + '"></i><h3>' + _esc(title) + '</h3><p>' + _esc(sub) + '</p></div>'; }
    function loadHtml() { return '<div class="fmx-load"><i class="ti ti-loader-2"></i><div style="font-size:12px;margin-top:10px;">' + L('Загружаю…') + '</div></div>'; }
    ...
    function openListingStats(lid) {
        lid = parseInt(lid, 10); if (!lid) { toast(L('Сначала сохрани оффер')); return; }
        ...
        bg.innerHTML = '<div class="fmx-cfm-box" style="max-width:440px;">' +
            ...
            '<div style="font-size:15px;font-weight:800;"><i class="ti ti-chart-bar" style="color:#5DCAA5;"></i> ' + L('Статистика за 7 дней') + '</div>' +
        ...
        apiGet('/api/v1/marketplace/my/' + lid + '/stats').then(function (r) {
            ...
            if (!r || !r.ok) { body.innerHTML = emptyHtml('ti-cloud-off', L('Не удалось загрузить'), L('Попробуй ещё раз позже.')); return; }
            ...
            body.innerHTML =
                ...
                '<div style="font-size:24px;font-weight:800;color:#f5bf4f;">' + (t.views || 0) + '</div><div style="font-size:10.5px;color:#a9aec0;margin-top:2px;">' + L('Показы в ленте') + '</div></div>' +
                ...
                '<div style="font-size:24px;font-weight:800;color:#5DCAA5;">' + t.expands + '</div><div style="font-size:10.5px;color:#a9aec0;margin-top:2px;">' + L('Развернули') + '</div></div>' +
                ...
                '<div style="font-size:24px;font-weight:800;color:#818cf8;">' + t.writes + '</div><div style="font-size:10.5px;color:#a9aec0;margin-top:2px;">' + L('Написали') + '</div></div></div>' +
                ...
                '<span><span style="display:inline-block;width:8px;height:8px;background:#5DCAA5;border-radius:2px;margin-right:4px;"></span>' + L('Развороты') + '</span>' +
                '<span><span style="display:inline-block;width:8px;height:8px;background:#818cf8;border-radius:2px;margin-right:4px;"></span>' + L('Написать') + '</span></div>' +
                (t.expands + t.writes === 0 ? '<div style="font-size:12px;color:#8990a8;text-align:center;margin-top:14px;">' + L('Пока данных нет. Как только оффер начнут смотреть на Площадке — здесь появятся цифры.') + '</div>' : '');
        }).catch(function () { var b = el('fmx-statsBody'); if (b) b.innerHTML = emptyHtml('ti-cloud-off', L('Ошибка'), L('Проверь связь.')); });
    }
    ...
    function toggleBm(u) {
        ...
        function _revert(prev) {
            ...
            updateBmCount();
            _bmPaint(u, prev);
            toast(L('Не удалось обновить закладку. Повтори попытку.'));
        }
    ...
    function _ensureFaqModal() {
        ...
        faq.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><h2><i class="ti ti-help-circle" style="color:#818cf8;"></i> ' + L('Справка') + '</h2><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-faqBody"></div></div>';
    ...
    function buildModals() {
        ...
        promo.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-rocket" style="color:#f5bf4f;"></i> ' + L('Продвинуть оффер') + '</h2><p>' + L('Поднимает оффер выше в умной сортировке — его видит больше рекламодателей. Топ смешанный: платные и обычные офферы чередуются.') + '</p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-promoBody"></div></div>';
        ...
        cal.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-calendar-check" style="color:#5DCAA5;"></i> ' + L('Календарь занятости') + '</h2><p id="fmx-calSub"></p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody"><div id="fmx-calBox"></div></div></div>';
        ...
        cmp.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-columns-3" style="color:#5DCAA5;"></i> ' + L('Сравнение каналов') + '</h2><p>' + L('Метрики бок о бок — лучшее в строке подсвечено') + '</p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-cmpBody"></div></div>';
        ...
        an.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><span class="fmxan-hi">' + AN_ICO + '</span> ' + L('AI-разбор канала') + '</h2><p id="fmx-anName"></p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-anBody"></div></div>';
        ...
        rv.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-star" style="color:#f59e0b;"></i> ' + L('Отзыв о сделке') + '</h2><p>' + L('Виден всем в развороте оффера') + '</p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-revBody"></div></div>';
        ...
        rp.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-flag" style="color:#ef4444;"></i> ' + L('Пожаловаться') + '</h2><p>' + L('Разберём вручную, автор жалобу не увидит') + '</p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-repBody"></div></div>';
        ...
        rq.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-speakerphone" style="color:#818cf8;"></i> ' + L('Заявка на покупку рекламы') + '</h2><p>' + L('Владельцы подходящих каналов напишут тебе сами') + '</p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-reqBody"></div></div>';
        ...
        cr.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><div style="flex:1;"><h2><i class="ti ti-crop" style="color:#818cf8;"></i> ' + L('Кадрирование') + '</h2><p id="fmx-cropHint"></p></div><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody"><div id="fmx-cropBox"></div><div class="fmx-zoomrow"><i class="ti ti-zoom-out" style="color:#8990a8;"></i><input type="range" id="fmx-cropZoom" min="1" max="3" step="0.01" value="1"><i class="ti ti-zoom-in" style="color:#8990a8;"></i></div><div class="fmx-acts" style="margin-top:14px;"><button class="fmx-btn" data-c>' + L('Отмена') + '</button><button class="fmx-btn fmx-btn-p" id="fmx-cropOk" style="background:#5DCAA5;color:#04342c;"><i class="ti ti-check"></i>' + L('Готово') + '</button></div></div></div>';
        ...
        bm.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><h2><i class="ti ti-star" style="color:#f59e0b;"></i> ' + L('Закладки') + '</h2><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div><div class="fmx-mbody" id="fmx-bmBody"></div></div>';
    ...
    function openBadgeGuide() {
        ...
        var body =
            ...
            card('<span class="fmx-bdg fmx-b-safe"><i class="ti ti-shield-check"></i>' + L('Безопасный') + '</span>', L('Безопасный'),
                L('Тематика канала — «белая»: без контента 18+, лицензируемых и серых ниш. Размещению не нужны возрастные ограничения и дополнительные проверки — подходит рекламодателям с жёсткими требованиями к окружению бренда.')) +
            card('<span class="fmx-bdg fmx-b-dead"><i class="ti ti-alert-triangle"></i>' + L('Требует проверки') + '</span>', L('Требует проверки'),
                L('Предупреждение, а не приговор: индекс здоровья красный либо охват аномален для размера канала — слишком низкий или выше числа подписчиков. Перед сделкой открой разворот, изучи график просмотров и запроси у продавца свежую статистику.')) +
            '<div class="fmx-bgd-card fmx-bgd-health">' +
            '<div class="fmx-bgd-title">' + L('Пульс канала · как часто выходят посты') + '</div>' +
            '<div class="fmx-bgd-desc">' + L('Считается по датам публикаций: когда был последний пост и сколько постов в неделю выходит в среднем.') + '</div>' +
            pulseRow('high', L('Активный'), L('публикует ежедневно — от 7 постов в неделю, последний не старше недели.')) +
            pulseRow('mid', L('Регулярный'), L('от 3 до 7 постов в неделю — несколько раз в неделю, без больших пауз.')) +
            pulseRow('rare', L('Редкие посты'), L('от 1 до 3 постов в неделю либо пауза дольше недели.')) +
            pulseRow('low', L('Единичные посты'), L('публикует реже раза в неделю либо пауза дольше двух недель. Канал живой, но выходит редко.')) +
            pulseRow('none', L('Не публикует'), L('последний пост вышел больше месяца назад — размещение здесь охвата не даст.')) +
            '<div class="fmx-bgd-desc" style="margin-top:9px;">' + L('Редкие посты — не приговор: у нишевых и авторских каналов такой ритм нормален. Но размещение в молчащем канале охвата почти не даст.') + '</div>' +
            '</div>' +
            card('<span class="fmx-bdg fmx-b-big"><i class="ti ti-crown"></i>' + L('Крупный') + '</span>', L('Крупный'),
                L('В канале от 100 000 подписчиков. Большой охват за размещение — подходит для масштабных запусков и широких проливов.')) +
            card('<span class="fmx-bdg fmx-b-match"><i class="ti ti-target-arrow"></i>' + L('В нише') + '</span>', L('В нише'),
                L('Ниша канала совпадает с нишей твоего канала. Аудитории близки — реклама попадёт точнее, конверсия выше. Показывается только тебе, под твой канал.')) +
            card('<span class="fmx-bdg fmx-b-deal"><i class="ti ti-heart-handshake"></i>' + L('★ 4,8 · 3 сделки') + '</span>', L('Сделки и рейтинг'),
                L('Число подтверждённых сделок через Площадку и средний рейтинг от рекламодателей. Обе стороны подтверждают сделку вручную — цифры не накручиваются. Прямой показатель репутации канала.')) +
            card('<span class="fmx-bdg" style="color:#f5bf4f;border-color:rgba(245,191,79,0.45);background:rgba(245,191,79,0.1);"><i class="ti ti-discount-2"></i>' + L('Горящие даты до −15%') + '</span>', L('Горящие даты'),
                L('Скидка продавца на близкие свободные даты — до 50% от прайса. Размер и дни продавец задаёт в календаре оффера; в развороте видно, на какие даты действует сниженная цена. Для закупщика это возможность взять размещение дешевле обычного.')) +
            card('<span class="fmx-aud" style="color:#5b9dff;border:0.5px solid #5b9dff55;background:#5b9dff1a;border-radius:99px;padding:3px 9px;font-size:10px;font-weight:700;"><i class="ti ti-gender-male"></i> ' + L('Мужская') + '</span>', L('Аудитория: мужская'),
                L('Больше половины читателей канала — мужчины. Подходит под офферы с мужской целевой аудиторией: трейдинг, авто, спорт, техника, беттинг.')) +
            card('<span class="fmx-aud" style="color:#ff6fae;border:0.5px solid #ff6fae55;background:#ff6fae1a;border-radius:99px;padding:3px 9px;font-size:10px;font-weight:700;"><i class="ti ti-gender-female"></i> ' + L('Женская') + '</span>', L('Аудитория: женская'),
                L('Больше половины читателей — женщины. Подходит под офферы с женской целевой аудиторией: красота, мода, дети, дом, маркетплейсы.')) +
            card('<span class="fmx-aud" style="color:#9aa0b5;border:0.5px solid #9aa0b555;background:#9aa0b51a;border-radius:99px;padding:3px 9px;font-size:10px;font-weight:700;"><i class="ti ti-users-group"></i> ' + L('Смешанная') + '</span>', L('Аудитория: смешанная'),
                L('Заметного перекоса по полу нет — канал читают и мужчины, и женщины. Универсальный вариант под широкие офферы: финансы, новости, развлечения.'));
        var bg = document.createElement('div'); bg.className = 'fmx-mbg'; bg.id = 'fmx-bgdBg';
        bg.innerHTML = '<div class="fmx-modal"><div class="fmx-mhead"><h2><i class="ti ti-rosette-discount-check" style="color:#818cf8;"></i> ' + L('Что значат бейджи') + '</h2><button class="fmx-mclose" data-c><i class="ti ti-x"></i></button></div>' +
            '<div class="fmx-mbody"><div style="font-size:12px;color:#8990a8;margin-bottom:6px;">' + L('Бейджи в оффере помогают быстро оценить канал ещё до разворота.') + '</div>' + body + '</div></div>';
        document.body.appendChild(bg);
    ...
    function openFaq() {
        ...
        else if (_faqTab === 'rules') body = '<div class="fmx-note" style="margin-bottom:6px;"><i class="ti ti-scale"></i> ' + L('Единые правила Площадки. За контент отвечает разместивший; дополнительно действуют законы страны, на аудиторию которой направлена реклама.') + '</div>' + RULES.map(function (t) { return '<div class="fmx-term"><h4>' + _esc(t[0]) + '</h4><p>' + _esc(t[1]) + '</p></div>'; }).join('');
        else body = '<div class="fmx-note" style="margin-bottom:6px;"><i class="ti ti-bulb"></i> ' + L('Практический разбор для обеих сторон: как закупать рекламу и как продавать размещения в своём канале.') + '</div>' + TIPS.map(function (t) { return '<div class="fmx-term"><h4><i class="ti ti-circle-check" style="color:#5DCAA5;margin-right:5px;"></i>' + _esc(t[0]) + '</h4><p>' + _esc(t[1]) + '</p></div>'; }).join('');
    ...
    var _PROMO_DESC = {
        burst24: L('Кратковременный подъём оффера в платной полосе ленты на сутки. Открывает стиль «Свечение» на время продвижения.'),
        burst48: L('Подъём в платной полосе на двое суток. Открывает стиль «Свечение» на время продвижения.'),
        week: L('Присутствие оффера в платной полосе на 7 дней. Открывает «Свечение», «Стекло» и анимированные стикеры.'),
    ...
    function openPromo(listingId) {
        ...
        body.innerHTML = '<div style="text-align:center;color:var(--fmx-dim,#8d92a8);padding:28px 0;">' + L('Загрузка…') + '</div>';
        ...
        }).catch(function () { body.innerHTML = '<div style="text-align:center;color:var(--fmx-dim,#8d92a8);padding:28px 0;">' + L('Не удалось загрузить.') + '</div>'; });
    }
    var _anBusy = false;
    var _AN_PRICE = 30;
    var AN_ICO = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">'
    ...
    var AN_BOLT = '<svg viewBox="0 0 24 24" fill="none">'
    ...
    function anFee(n) {
        return '<em class="fmxan-fee">' + AN_BOLT + n + '</em>';
    }
    ...
    function _anIntro(u) {
        ...
        if (!body) return;
        body.innerHTML =
            '<div class="fmx-note fmx-gr"><i class="ti ti-sparkles"></i> ' + L('Нейросеть изучит канал целиком: реальный охват и его динамику, вовлечённость, признаки накрутки и качество аудитории — и честно скажет, стоит ли покупать здесь рекламу.') + '</div>' +
            '<button class="fmxan-go" id="fmx-anGo"><span class="fmxan-mi">' + AN_ICO + '</span> ' + L('Разобрать канал') + ' <span class="fz">' + AN_BOLT + _AN_PRICE + '</span></button>' +
            '<div class="fmxan-hint">' + L('Готовый разбор хранится 7 дней — повторное открытие бесплатно.') + '</div>';
        var go = el('fmx-anGo');
    ...
    function _anStart(u) {
        ...
        body.innerHTML = '<div class="fmxan-scan"><div class="beam"></div>' +
            '<span class="fmxan-hi big">' + AN_ICO + '</span>' +
            '<div class="st" id="fmx-anStep">' + _AN_STEPS[0] + '</div>' +
            '<div class="sub">' + L('Глубокий разбор — обычно одна-две минуты. Окно можно не закрывать.') + '</div></div>';
        var i = 0;
        ...
        apiRequest('/api/v1/marketplace/analyze', {
            ...
            if (r && r.ok && r.analysis) { _haptic('light'); _anRender(u, r.analysis); }
                ...
                body.innerHTML = '<div class="fmx-empty" style="padding:24px 20px;"><i class="ti ti-database-off"></i><h3>' + L('Мало данных') + '</h3><p>' + L('По этому каналу ещё не накоплены замеры — разбор недоступен. Forge не списаны.') + '</p></div>';
            } else {
                body.innerHTML = '<div class="fmx-empty" style="padding:24px 20px;"><i class="ti ti-alert-triangle"></i><h3>' + L('Не получилось') + '</h3><p>' + L('Разбор не собрался — попробуй ещё раз. Forge за неудачную попытку возвращены.') + '</p></div>';
            }
        }).catch(function (err) {
            _anBusy = false;
            if (_anStepT) { clearInterval(_anStepT); _anStepT = null; }
            var msg = L('Разбор не собрался — попробуй ещё раз. Forge за неудачную попытку возвращены.');
            try {
            ...
            body.innerHTML = '<div class="fmx-empty" style="padding:24px 20px;"><i class="ti ti-alert-triangle"></i><h3>' + L('Не получилось') + '</h3><p>' + _esc(msg) + '</p></div>';
        });
    }
    ...
    function _anRender(u, a) {
        ...
        if (a._cached_at) {
            ...
            h += '<div class="fmxan-cache">' + L('Разбор от') + ' ' + dt.toLocaleDateString('ru-RU') +
                ' · <a id="fmx-anRe">' + L('обновить') + ' ' + anFee(_AN_PRICE) + '</a></div>';
        }
        h += '<div class="fmxan-verd"><div class="ring">' +
            ...
            '<div class="val"><b style="color:' + v[0] + ';">' + score + '</b><span>' + L('из 100') + '</span></div></div>' +
            '<div class="vt"><b style="color:' + v[0] + ';">' + _esc(a.verdict_title || '') + '</b>' +
            '<em>' + _esc(a.summary || '') + '</em>' +
            '<span class="conf" style="color:' + v[0] + ';border-color:' + v[0] + '4d;background:' + v[0] + '1a;"><i class="ti ' + v[1] + '"></i> ' + L('уверенность') + ' ' + (+a.confidence || 0) + '%</span></div></div>';

        if (a.reach_real) {
            h += '<div class="fmxan-lbl">' + L('Реальный охват рекламного поста') + '</div><div class="fmxan-card">' +
                '<div class="reach">' +
                (a.reach_claimed ? '<div class="was"><b>' + _num(+a.reach_claimed) + '</b><span>' + L('заявлено') + '</span></div><div class="arr">→</div>' : '') +
                '<div class="now"><b>' + _esc(String(a.reach_real)) + '</b><span>' + L('честный прогноз') + '</span></div></div>' +
                (a.reach_note ? '<div class="note">' + _esc(a.reach_note) + '</div>' : '') + '</div>';
        }
        if (a.audience && a.audience.length) {
            h += '<div class="fmxan-lbl">' + L('Качество аудитории') + '</div><div class="fmxan-grid">' +
        ...
        if (a.flags && a.flags.length) {
            h += '<div class="fmxan-lbl">' + L('Красные флаги ·') + ' ' + a.flags.length + '</div><div class="fmxan-card">' +
        ...
        if (a.checklist && a.checklist.length) {
            h += '<div class="fmxan-lbl">' + L('Проверь руками перед сделкой') + '</div><div class="fmxan-card">' +
    ...
    function _reachStructBlock(l) {
        ...
        if (sp != null) {
            ...
            if (pct === 0) { t = L('Просмотры ровные — резких всплесков нет'); c = '#5DCAA5'; ic = 'ti-wave-sine'; }
            else if (sp < 0.2) { t = L('Отдельные вирусные посты (~') + pct + L('%) — обычная органика'); c = '#818cf8'; ic = 'ti-chart-line'; }
            else { t = L('Кластер всплесков (~') + pct + L('% постов) — возможен закуп просмотров, проверь'); c = '#f59e0b'; ic = 'ti-alert-triangle'; }
            rows.push('<div class="fmx-tline" style="color:' + c + ';"><i class="ti ' + ic + '"></i>' + t + '</div>');
        }
        if (ad != null && l.struct_posts) {
            var apct = Math.round(ad * 100);
            rows.push('<div class="fmx-tline" style="color:' + (ad >= 0.35 ? '#f59e0b' : (ad < 0.05 ? '#5DCAA5' : '#c2c6d2')) + ';"><i class="ti ti-ad"></i>' + apct + L('% рекламных · ') + l.struct_posts + ' ' + _plural(l.struct_posts, L('пост'), L('поста'), L('постов')) + (ad >= 0.35 ? L(' — лента подвыжжена, охват твоей рекламы ниже') : '') + '</div>');
        }
    ...
    function _chmRow(name, note, right) {
        return '<div class="fmx-chmrow"><div class="fmx-chmn1"><b>' + name + '</b>' +
            ...
            '<div class="fmx-chmr">' + (right || '') + '</div></div>';
    }
    function _chmPill(txt, col) {
        if (!txt) return '';
        return '<span class="fmx-chmp" style="color:' + col + ';background:' + col + '1a;border-color:' + col + '4d;">' + txt + '</span>';
    }
    function _growPill(l) {
        if (typeof l.subs_growth_30d !== 'number') return '';
        var g = l.subs_growth_30d;
        if (!g) return _chmPill(L('без изменений'), '#8990a8');
        return _chmPill((g > 0 ? '+' : '−') + _num(Math.abs(g)) + L(' за 30 дн'), g > 0 ? '#5DCAA5' : '#f06978');
    }
    function _errPill(l) {
        if (l.er == null || !l.reach_status) return '';
        var c = (l.reach_status === 'норма') ? '#5DCAA5'
            : ((l.reach_status === 'очень низкий' || l.reach_status === 'аномальный') ? '#f06978' : '#E8B04B');
        return _chmPill(_esc(l.reach_status), c);
    }
    function _errNote(l) {
        if (l.er == null) return L(L('нет свежих постов'));
        return (l.reach_norm && l.reach_norm.length === 2)
            ? L('охват к подписчикам · норма для ') + _esc(l.reach_tier || '') + ' ' + l.reach_norm[0] + '–' + l.reach_norm[1] + '%'
            : L('охват к подписчикам');
    }
    function _erPill(l) {
        var v = l.engagement_percent;
        if (v == null) return _chmPill((l.react_count || l.comment_count) ? L('сигнала мало') : L('не измеряется'), '#8990a8');
        return _chmPill(v >= 3.5 ? L('высокая') : (v >= 1 ? L('норма') : L('низкая')),
                        v >= 3.5 ? '#5DCAA5' : (v >= 1 ? '#818cf8' : '#E8B04B'));
    }
    function _erNote(l) {
        var b = [];
        if (l.react_count) b.push('~' + _num(l.react_count) + ' ' + _plural(l.react_count, L('реакция'), L('реакции'), L('реакций')));
        if (l.comment_count) b.push(_num(l.comment_count) + ' ' + _plural(l.comment_count, L('комментарий'), L('комментария'), L('комментариев')));
        return b.length ? L('вовлечённость · по ') + b.join(', ') + L(' на пост') : L('вовлечённость на пост');
    }
    function _idxPill(l) {
        var c = l.health_class === 'green' ? '#5DCAA5' : (l.health_class === 'red' ? '#f06978' : '#E8B04B');
    ...
    function _audBar(l) {
        ...
        var f = Math.max(0, Math.min(100, l.female_pct)), m = 100 - f;
        return '<div class="fmx-chmaud"><div class="fmx-chmauh"><span class="fmx-chml">' + L('Аудитория') + '</span>' +
            '<b>' + _esc(a.short.replace(L('муж'), L('мужчины')).replace(L('жен'), L('женщины'))) + '</b></div>' +
            '<div class="fmx-chmbar"><i style="width:' + m.toFixed(0) + '%;background:#5b9dff;"></i>' +
            '<i style="width:' + f.toFixed(0) + '%;background:#ff6fae;"></i></div>' +
            '<div class="fmx-chmbl"><span>' + _esc(a.note) + '</span><span>' + L('женщины') + ' ' + f.toFixed(0) + '%</span></div></div>';
    }
    function _pwMetrics(l) {
        ...
        return '<div class="fmx-pwc">' +
            '<div class="fmx-chmduo">' +
            '<div class="fmx-chmbig"><div class="fmx-chml">' + L('Охват поста') + '</div>' +
            '<div class="fmx-chmv num" style="color:' + (dead ? '#f06978' : '#5DCAA5') + ';">' +
            ((!dead && l.avg_views != null) ? _num(l.avg_views) : '—') + '</div>' +
            ...
            _chmRow(L('Подписчики'), (l.subscribers != null ? _num(l.subscribers) : '—') +
                    (_chAge(l.channel_created_ts) ? L(' · на рынке ') + _chAge(l.channel_created_ts) : ''),
                    _growPill(l)) +
            (dead ? '' : _chmRow(L('ERR') + (l.er != null ? ' ' + (l.er > 100 ? _warnTri(12) + ' ' : '') + String(l.er).replace('.', ',') + '%' : ''),
                    _errNote(l), _errPill(l))) +
            (dead ? '' : _chmRow('ER' + (l.engagement_percent != null ? ' ' + String(l.engagement_percent).replace('.', ',') + '%' : ''),
                    _erNote(l), _erPill(l))) +
            (l.health_score != null ? _chmRow(L('Индекс канала ') + l.health_score, L('сводная оценка качества'), _idxPill(l)) : '') +
            (ad ? _chmRow(L('Рекламный охват'), L('замер за 24 часа после выхода'), '<b class="num" style="color:#cdd0de;">~' + _num(ad) + '</b>') : '') +
            '</div>' +
            _audBar(l) +
            (dead ? '<div class="fmx-chmdead">' + L('Охват не считается: канал не публикует больше месяца — рекламный пост охвата не получит, старые цифры просмотров непоказательны.') + '</div>' : '') +
            (l.er != null && l.er > 100 ?
                '<div class="fmx-anom"><span class="fmx-anom-i">' + _warnTri(17) + '</span>' +
                '<div><b>ERR ' + String(l.er).replace('.', ',') + '%</b> ' + L('— просмотров у постов больше, чем подписчиков в канале.') + ' ' +
                L('Разовый вирусный пост — не беда, но когда так почти всегда и без явной причины, цифру стоит перепроверить. ') +
                L('Обычно за этим стоят докрученные просмотры (канал изображает активность, чтобы дороже продавать рекламу) ') +
                L('либо закуп размещений в непрофильных каналах, куда стекается ботовый трафик. ') +
                '<span style="display:block;margin-top:6px;">' + _erCheckTxt(l) + '</span></div></div>' : '') +
            '</div>';
    }
    function _erCheckTxt(l) {
        if (l.engagement_percent != null) {
            return L(L('Проверить помогает вовлечённость: сейчас ER')) + ' <b>' + String(l.engagement_percent).replace('.', ',') + '%</b>. ' +
                L('Заметные реакции при таком охвате — знак, что просмотры живые; почти полное их отсутствие — что охват докручен ') +
                L('(боты просмотр открывают, а реакцию не ставят).');
        }
        if (l.react_count || l.comment_count) {
            return L('Вовлечённость здесь не измеряется: сигнал есть не на всех постах, поэтому честной цифры не получится. ') +
                L('Ориентируйся на число реакций в карточке и проверь источники охвата вручную.');
        }
        return L('Проверить это по вовлечённости не выйдет — реакций и комментариев у канала не видно. Настоящий ли охват, ') +
            L('здесь показывают только они: их нет — значит, нужна ручная проверка источников охвата.');
    }
    function _pwTrend(l) {
        ...
        apiGet('/api/v1/marketplace/listings/' + l.id + '/trend').then(function (r) {
            ...
            var endLabel = r.stale ? (r.last_date || dates[dates.length - 1] || '') : L('сегодня');
    ...
    function _trustRows(l) {
        ...
        rows.push({ i: 'ti-heart-handshake', c: '#f5bf4f',
            t: dealN ? L('Подтверждённых сделок:') + ' <b>' + dealN + '</b>' + (l.ad_reach_24h ? L(' · охват замерен') : '')
                     : L('Сделок пока нет. Отзывы появятся после первой подтверждённой сделки'),
            e: L('Обе стороны подтверждают сделку вручную. Ссылку на рекламный пост даёт продавец, дальше охват этого поста мы замеряем сами через 24 и 48 часов. Счётчик растёт только по сделкам, подтверждённым обеими сторонами через Площадку. Оплата идёт напрямую между вами: сервис не держит деньги и не выступает гарантом расчётов.') });
        rows.push({ i: 'ti-target-arrow', c: '#5DCAA5', id: 'fmx-tr-acc',
            t: L('Точность заявленного охвата:') + ' <b id="fmx-tr-accv">…</b>',
            e: L('Сравниваем заявленный охват оффера с фактическим охватом рекламных постов из подтверждённых сделок. Чем ближе к нулю — тем честнее заявка.') });
        rows.push({ i: 'ti-calendar-check', c: '#818cf8',
            t: L('Календарь обновлён:') + ' <b id="fmx-tr-cal">…</b>',
            e: L('Свежий календарь — признак живого канала: датам на оффере можно доверять.') });
        rows.push({ i: 'ti-activity', c: '#5ab0e6',
            t: L('Метрики обновляются автоматически'),
            e: L('Цифры оффера поддерживаются в актуальном состоянии без участия владельца.') });
    ...
    function openListing(u, known) {
        ...
        var dealN = l.deals_count || 0;
        _TRUST_EXPL = [
            L('Обе стороны подтверждают сделку вручную. Ссылку на рекламный пост даёт продавец, дальше охват этого поста мы замеряем сами через 24 и 48 часов. Счётчик растёт только по сделкам, подтверждённым обеими сторонами через Площадку. Оплата идёт напрямую между вами: сервис не держит деньги и не выступает гарантом расчётов.'),
            L('Сравниваем заявленный охват оффера с фактическим охватом рекламных постов из подтверждённых сделок. Чем ближе к нулю — тем честнее заявка.'),
            L('Свежий календарь — признак живого канала: датам на оффере можно доверять.'),
            L('Цифры оффера поддерживаются в актуальном состоянии без участия владельца.')
        ];
        var fmtsHtml = '';
        if (l.formats && l.formats.length) {
            var bestCpm = null, _rv = (l.activity === 'none') ? null : _reach(l);
            l.formats.forEach(function (f) { if (f.price && _rv) { var c = f.price / _rv * 1000; if (bestCpm == null || c < bestCpm) bestCpm = c; } });
            fmtsHtml = '<div class="fmx-lssect">' + L('Форматы и цены') + '</div>' +
                ...
                l.formats.map(function (f) {
                    ...
                    return '<div class="fmx-fmt' + ((f.label || f.format) === _lsSel.fmt ? ' on' : '') + '" data-fmt="' + lb + '" data-p="' + (f.price || '') + '">' +
                        ...
                        '<span class="pr">' + (f.price ? _num(f.price) + ' ₽' : L('по договорённости')) + '</span>' +
                        '<span class="cp">' + (c != null ? 'CPM ' + _num(c) + ' ₽' : '') + '</span></div>';
                }).join('') + '</div>' +
                '<div style="font-size:10px;color:#565b73;margin-top:5px;">' + L('Зелёная точка — лучший CPM.') + ' ' + (l.ad_reach_24h ? L('CPM по') + ' <b style="color:#5DCAA5;">' + L('охвату рекламного поста за первые 24 часа (ERR24)') + '</b> ' + L('— по фактическим замерам сделок.') : L('Тап по строке подставит формат в сообщение')) + '</div>' +
                _termsBlock(l);
        }
        ...
        el('fmx-listBody').innerHTML =
            '<div style="font-size:12px;color:#8990a8;margin-bottom:12px;">@' + _esc(u) + ' · ' + _num(l.subscribers) + L(' подп.') + (l.niche ? ' · ' + _esc(l.niche) : '') + '</div>' +
            ...
            (l.id ? '<div class="fmx-lssect">' + L('Доверие') + '</div>' + _trustRows(l) +
                '<div class="fmx-tplink" data-terms="b"><i class="ti ti-clipboard-text"></i> <span>' + L('Как проходит сделка') + '</span></div>' : '') +
            (l.custom_text ? '<div style="font-size:13px;color:#cdd0de;line-height:1.55;margin:14px 0 0;overflow-wrap:anywhere;word-break:break-word;">' + _esc(l.custom_text) + '</div>' : '') +
            fmtsHtml +
            (l.id ? '<div class="fmx-lssect">' + L('Свободные даты') + '</div><div id="fmx-slotsBox" style="background:rgba(255,255,255,0.03);border:0.5px solid rgba(255,255,255,0.08);border-radius:14px;padding:12px;"></div>' : '') +
            (l.id ? '<div id="fmx-lsRev"></div><div id="fmx-dealBox"></div>' : '') +
            (l.id ? '<div style="display:flex;gap:8px;margin-top:14px;">' +
                '<button class="fmx-btn" id="fmx-lsShare" style="flex:1;color:#5DCAA5;border-color:rgba(93,202,165,0.3);"><i class="ti ti-share"></i> ' + L('Поделиться оффером') + '</button>' +
                '<button class="fmx-btn" id="fmx-ls-rep" style="flex:1;color:#8990a8;"><i class="ti ti-flag"></i> ' + L('Пожаловаться') + '</button></div>' : '') +
            (!l.id ? '<button class="fmx-btn" id="fmx-lsTrack" style="width:100%;margin-top:14px;color:#5ab0e6;border-color:rgba(90,176,230,0.35);"><i class="ti ti-route"></i> ' + L('Ссылка отслеживания в рекламный пост') + '</button>' : '') +
            ...
            '<button class="fmx-btn fmx-btn-p go" id="fmx-lsGo" style="background:' + accent + ';color:#fff;"><i class="ti ti-brand-telegram"></i> ' + L('Написать') + '</button></div>';
        if (l.id && l.expand_content_json && l.expand_content_json.els && l.expand_content_json.els.length) {
            var tb = el('fmx-tabloBox');
            tb.innerHTML = '<div class="fmx-lssect">' + L('Витрина') + '</div><div id="fmx-tabloIn"></div>';
        ...
        el('fmx-lsBm').addEventListener('click', function () {
            ...
            toast(on ? L('Добавлено в закладки') : L('Убрано из закладок'));
        });
        ...
        if (l.id) {
            ...
            loadBuyerSlots(el('fmx-slotsBox'), l, function (r) {
                ...
                if (av) av.textContent = (r.accuracy_pct != null)
                    ...
                    : L('появится после первой сделки с замером');
                var cv = el('fmx-tr-cal');
                if (cv) cv.textContent = r.slots_updated_at ? _agoDay(r.slots_updated_at) : L('не заполнялся');
    ...
    function openBookmarks() {
        ...
        apiGet('/api/v1/marketplace/bookmarks/cards').then(function (r) {
            ...
            updateBmCount();
            if (!items.length) {
                box.innerHTML = '<div class="fmx-empty"><i class="ti ti-star"></i><h3>' + L('Пусто') + '</h3><p>' + L('Отмечай ★ на офферах, чтобы сохранить канал.') + '</p></div>';
                return;
            }
            box.innerHTML = items.map(function (it) {
                ...
                return '<div class="fmx-bmrow' + (it.frozen ? ' frz' : '') + '" data-open="' + _esc(u) + '" data-src="' + it.source + '" data-frz="' + (it.frozen ? 1 : 0) + '">' +
                    ...
                    (it.frozen ? '<span class="fmx-frzTag"><i class="ti ti-snowflake"></i> ' + L('Заморожена') + '</span>' : '') +
                    '<button class="fmx-bmdel" data-del="' + _esc(u) + '" title="' + L('Удалить из закладок (два нажатия)') + '"><i class="ti ti-trash"></i></button></div>';
            }).join('');
            bindList(box);
            scaleCards(box);
            hydrateTgs(box);
        }).catch(function () {
            box.innerHTML = '<div class="fmx-empty"><i class="ti ti-cloud-off"></i><h3>' + L('Не загрузилось') + '</h3><p>' + L('Попробуй открыть закладки ещё раз.') + '</p></div>';
        });
    }
    ...
    function openAdPick() {
        ...
        ov.innerHTML = '<div class="fmx-apk-in">' +
            ...
            '<b>' + L('Подбор каналов для рекламы') + '</b>' +
        ...
        if (_apkChId == null) {
            _apkBody().innerHTML = '<div class="fmx-apk-err"><i class="ti ti-plug" style="color:#f5bf4f;"></i><span><b style="color:#e8e8ed;">' + L('Сначала подключи канал.') + '</b> ' + L('Подбор строится под аудиторию твоего канала — добавь его на главном экране.') + '</span></div>';
            return;
        }
        _apkLoadState();
    }
    function _apkLoadState(showRunId) {
        apiGet('/api/v1/adpick/state?channel_id=' + _apkChId).then(function (st) {
            ...
            var b = _apkBody(); if (b) b.innerHTML = '<div class="fmx-apk-err"><i class="ti ti-cloud-off" style="color:#f06978;"></i><span>' + L('Не удалось загрузить. Проверь связь и открой экран ещё раз.') + '</span></div>';
        });
    }
    function _apkLimitLine() {
        var st = _apkState || {};
        if (st.tester) return L('Тестовый режим · списания не применяются');
        var balance = Number(st.balance || 0);
        var price = Number(st.price || 0);
        var fa = window.forgeAmount || function (n) { return _num(n); };
        if (st.can_run) return L('Запуск спишет ') + fa(price, 11) + L(' · на балансе ') + fa(balance, 11);
        return L('Недостаточно средств: нужно ') + fa(price, 11) + L(', на балансе ') + fa(balance, 11);
    }
    function _apkHistoryHtml() {
        ...
        var pills = runs.map(function (r) {
            ...
            return '<button class="fmx-apk-pill" data-apkrun="' + r.id + '">' + _apkDate(r.created_at) + ' · ' + n + ' ' + _plural(n, L('канал'), L('канала'), L('каналов')) + '</button>';
        }).join('');
        return '<div style="margin-top:14px;"><div style="font-size:11px;color:#6b7088;margin-bottom:8px;">' + L('История подборов') + '</div>' +
    ...
    function _apkRenderIntro() {
        ...
        b.innerHTML =
            ...
            '<div style="font-size:12px;color:#8d93a8;line-height:1.5;">' + L('Куда закупать рекламу') + (chName ? ' ' + L('каналу') + ' <b style="color:#c2c6d2;">' + _esc(chName) + '</b>' : L(' твоему каналу')) + L('. Система отбирает площадки, где реклама может сработать:') + '</div>' +
            ...
            '<button class="fmx-apk-go" id="fmx-apkGo"' + (st.can_run ? '' : ' disabled') + '><i class="ti ti-target-arrow"></i> ' + L('Подобрать каналы') + '</button>' +
    ...
    function _apkStart() {
        ...
        apiPost('/api/v1/adpick/start', { channel_id: _apkChId }).then(function (r) {
            if (!r || !r.ok) { toast(L('Не удалось запустить подбор')); if (go) go.disabled = false; return; }
            _apkRenderProgress('running');
            _apkPoll(r.run_id);
        }).catch(function (e) {
            var msg = L('Не удалось запустить подбор');
    ...
    function _apkRenderProgress(phase) {
        var b = _apkBody(); if (!b) return;
        var m = phase === 'analyzing' ? L('ИИ анализирует найденные каналы…') : L('Ищу подходящие каналы в базе…');
        var s = phase === 'analyzing' ? L('Кандидаты найдены — ранжирую и готовлю обоснования. Запуск списан.') : L('Ниша, выгорание ленты, охват, аномалии просмотров — без ИИ, запуск ещё не списан');
    ...
    function _apkBackBtn() {
        return '<button class="fmx-apk-pill" id="fmx-apkBack" style="margin-top:14px;"><i class="ti ti-arrow-left"></i> ' + L('К запуску подбора') + '</button>';
    }
    ...
    function _apkRenderEmpty() {
        var b = _apkBody(); if (!b) return;
        b.innerHTML = '<div class="fmx-apk-empty"><i>✓</i><span><b style="color:#e8e8ed;">' + L('Подходящих каналов в базе пока нет.') + '</b> ' + L('Запуск не списан. База пополняется — попробуй позже.') + '</span></div>' + _apkBackBtn();
        _apkBindBack();
    }
    function _apkRenderError(msg) {
        var b = _apkBody(); if (!b) return;
        b.innerHTML = '<div class="fmx-apk-err"><i class="ti ti-alert-triangle" style="color:#f06978;"></i><span>' + _esc(msg || L('Не удалось выполнить подбор. Попробуй ещё раз.')) + '</span></div>' + _apkBackBtn();
        _apkBindBack();
    }
    ...
    function _apkMetricLine(p) {
        var a = [];
        if (p.subscribers != null) a.push('<b>' + _num(p.subscribers) + '</b> ' + L('подписчиков'));
        if (p.avg_views != null) a.push(L('охват') + ' <b>' + _num(p.avg_views) + '</b>');
    ...
    function _apkRenderResult(run) {
        ...
        var cards = picks.map(function (p, idx) {
            ...
            return '<div class="fmx-apk-card">' +
                ...
                '<button class="fmx-apk-abtn" data-apkopen="' + _esc(p.username) + '"><i class="ti ti-brand-telegram"></i> ' + L('Открыть канал') + '</button>' +
                (p.on_market ? '<button class="fmx-apk-abtn" data-apkoffer="' + _esc(p.username) + '" style="color:#9fe3cc;border-color:rgba(93,202,165,0.3);"><i class="ti ti-file-description"></i> ' + L('Смотреть оффер') + '</button>' : '') +
                '</div></div>';
        }).join('');
        var n = picks.length;
        b.innerHTML =
            '<div style="font-size:12px;color:#8d93a8;line-height:1.5;margin-bottom:4px;">' + L('Готово:') + ' <b style="color:#e8e8ed;">' + n + ' ' + _plural(n, L('канал'), L('канала'), L('каналов')) + '</b> ' + L('под твою аудиторию') + (run.created_at ? ' · ' + _apkDate(run.created_at) : '') + L('. Отранжированы по шансу, что реклама сработает.') + '</div>' +
            cards +
            '<div style="display:flex;gap:7px;margin-top:14px;flex-wrap:wrap;">' +
            '<button class="fmx-apk-pill on" id="fmx-apkRerun"><i class="ti ti-refresh"></i> ' + L('Перезапустить подбор') + '</button>' +
            '<button class="fmx-apk-pill" id="fmx-apkBack"><i class="ti ti-arrow-left"></i> ' + L('К запуску') + '</button></div>';
        _apkBindBack();
        var rr = el('fmx-apkRerun');
        if (rr) rr.addEventListener('click', function () {
            _haptic('medium');
            if (_apkState && !_apkState.can_run) { toast(L('Лимит подборов исчерпан')); return; }
            _apkStart();
        });
