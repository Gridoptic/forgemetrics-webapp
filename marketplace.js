(function () {
    ...
    var _TERMS_B = [
        ...
        ['ti-heart-handshake', '#818cf8', 'Фиксация сделки — обеими сторонами', [
            'После договорённости отметьте сделку в развороте оффера. Она засчитывается, когда владелец подтвердит её со своей стороны. Счётчик сделок в карточке растёт только по подтверждённым.']],
    ...
    var _TERMS_S = [
        ...
        ['ti-heart-handshake', '#818cf8', 'Сделки и замеры', [
            'Сделку вы подтверждаете вручную. Ссылку на рекламный пост пришлите в течение 72 часов после выхода — охват замерится автоматически через 12, 24 и 48 часов и попадёт в карточку как «Рекламный охват».']],
        ['ti-activity', '#818cf8', 'Метрики — автоматические и честные', [
            'Цифры оффера поддерживаются без вашего участия. Признаки накрутки помечаются в карточке — честные метрики поднимают доверие и цену размещения.']],
