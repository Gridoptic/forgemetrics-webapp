(function () {
    ...
    var TEMPLATES = [
        ...
        { re: /^Начисление после оплаты, холд 30 дней\. Приглашённый получает −(\d+)% на первое пополнение и \+(\d+) Forge к стартовому запасу\.$/, k: 'Начисление после оплаты, холд 30 дней. Приглашённый получает −%1% на первое пополнение и +%2 Forge к стартовому запасу.' },
